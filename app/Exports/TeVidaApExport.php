...
class TeVidaApExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents {
    ...
    public function collection() {
        ...
        "emisión" as tipo_poliza, pt.name  as cartera, pc.ejecutivo_ss as ajecucomercial,c.canalnegodes as canal, CONCAT(b.first_name," ", b.last_name) as beneficiario,"1" as item, 
