...
class inspectionRequestR1UserEmail extends Mailable {
    ...
    public function build() {
        ...
        $carQuery='SELECT  vh.plate as "plate", vhb.name as "brand", vh.model as "model", vh.year as "year"  
                            ...
                            where ins.id ="' . $this->inspectionId . '"';
...
//        $sale = $this->saleId;
        ...
        return $this->view('emails.inspectionRequestR1User')
                    ->from($email_SS->value, $tag_SS->value)
                    ->subject('Solicitud de Inspección Cotización '.$this->saleId)
