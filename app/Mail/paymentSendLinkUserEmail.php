...
class paymentSendLinkUserEmail extends Mailable {
...
//        $sale = $this->saleId;
        ...
        $url = 'https://tupolizaenlineatest.segurossucre.fin.ec/sales/payments/create?document='.$document.'&sales='.$sale;
        ...
        $message = 'Para realizar el pago de su poliza ingrese al siguiente link: https://tupolizaenlineatest.segurossucre.fin.ec/su/'.$short.' Seguros Sucre Tu Lugar Seguro';
        smsEclipsoft($customer[0]->mobile, $message);
        
        return $this->view('emails.paymentSendLinkUser')
                    ->from($email_SS->value, $tag_SS->value)
                    ->subject('Estás a un paso de tu LUGAR SEGURO')
