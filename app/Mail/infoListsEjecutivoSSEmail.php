...
class infoListsEjecutivoSSEmail extends Mailable {
...
//        $sale = $this->saleId;
        ...
        return $this->view('emails.infoListsEjecutivoSS')
                    ->from($email_SS->value, $tag_SS->value)
                    ->subject('Notificación – Listas Informativas Cotización '.$this->saleId)
