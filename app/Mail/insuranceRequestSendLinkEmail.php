...
class insuranceRequestSendLinkEmail extends Mailable {
...
//        $sale = $this->saleId;
        ...
        $url = 'https://tupolizaenlineatest.segurossucre.fin.ec/sales/R2/insuranceApplication/'.$sale;
        ...
        $message = 'Completa tu solicitud de Aseguramiento en el siguiente link: https://tupolizaenlineatest.segurossucre.fin.ec/su/'.$short.' Seguros Sucre Tu Lugar Seguro';
        ...
        return $this->view('emails.insuranceRequestSendLink')
                    ->from($email_SS->value, $tag_SS->value)
                    ->subject('Estas en camino a tu LUGAR SEGURO')
