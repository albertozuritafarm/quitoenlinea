...
class infoRiskBlockadeUserEmail extends Mailable {
...
//        $sale = $this->saleId;
        ...
        return $this->view('emails.infoRiskBlockadeUser')
                    ->from($email_SS->value, $tag_SS->value)
                    ->subject('Notificación – Bloqueo Alerta de Riesgo Cotización ' .$this->saleId)
