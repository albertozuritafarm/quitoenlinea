...
class inspectionAceptedR1UserEmail extends Mailable {
    ...
    public function build() {
        ...
        $carQuery='SELECT  distinct(vh.plate) as "plate", vhb.name as "brand", vh.model as "model", vh.year as "year" , sta.name as "status"
                            ...
                            join status sta on sta.id = ins.status_id
...
//        $sale = $this->saleId;
        ...
        return $this->view('emails.inspectionAceptedR1User')
