...
class infoListsEjecutivoSSEmailMassivesVinculationLegalPerson extends Mailable {
    ...
    public function build() {
        ...
        $productName = \App\sales::selectRaw('products.name, products.productodes, products.price, cus.document')
                                    ...
                                    ->join('customers as cus','cus.id','=','sales.customer_legal_representative_id')
...
//        $sale = $this->saleId;
        ...
        return $this->view('emails.infoListsEjecutivoSSMassivesVinculation')
                    ->from($email_SS->value, $tag_SS->value)
                    ->subject('Notificación – Listas Informativas Vinculación '.$this->saleId)
