...
class MassivesVinculationForm extends Controller
{
...
//        dd($vinculation);
        if($vinculation){
            ...
            if($vinculation->picture_document_applicant == null) { $picture_document_applicant = ''; } else { if(pathinfo($vinculation->picture_document_applicant)['extension'] == 'pdf'){ $picture_document_applicant = '<a href="' . $vinculation->picture_document_applicant . '" target="_blank"><img src="/images/pdf.png" class="img-thumbnail" width="300" height="300" /></a>'; }else{ $picture_document_applicant = '<a href="' . $vinculation->picture_document_applicant . '" target="_blank"><img src="' . $vinculation->picture_document_applicant . '" class="img-thumbnail" width="300" height="300" /></a>'; } }
            if ($vinculation->picture_document_spouse == null) { $picture_document_spouse = ''; } else { if(pathinfo($vinculation->picture_document_spouse)['extension'] == 'pdf'){ $picture_document_spouse = '<a href="' . $vinculation->picture_document_spouse . '" target="_blank"><img src="/images/pdf.png" class="img-thumbnail" width="300" height="300" /></a>'; }else{ $picture_document_spouse = '<a href="' . $vinculation->picture_document_spouse . '" target="_blank"><img src="' . $vinculation->picture_document_spouse . '" class="img-thumbnail" width="300" height="300" /></a>'; } }
            if ($vinculation->picture_voting_ballot == null) { $picture_voting_ballot_applicant = ''; } else { if(pathinfo($vinculation->picture_voting_ballot)['extension'] == 'pdf'){ $picture_voting_ballot_applicant = '<a href="' . $vinculation->picture_voting_ballot . '" target="_blank"><img src="/images/pdf.png" class="img-thumbnail" width="300" height="300" /></a>'; }else{ $picture_voting_ballot_applicant = '<a href="' . $vinculation->picture_voting_ballot . '" target="_blank"><img src="' . $vinculation->picture_voting_ballot . '" class="img-thumbnail" width="300" height="300" /></a>'; } }
            if ($vinculation->picture_voting_ballot_spouse == null) { $picture_voting_ballot_spouse = ''; } else { if(pathinfo($vinculation->picture_voting_ballot_spouse)['extension'] == 'pdf'){ $picture_voting_ballot_spouse = '<a href="' . $vinculation->picture_voting_ballot_spouse . '" target="_blank"><img src="/images/pdf.png" class="img-thumbnail" width="300" height="300" /></a>'; }else{ $picture_voting_ballot_spouse = '<a href="' . $vinculation->picture_voting_ballot_spouse . '" target="_blank"><img src="' . $vinculation->picture_voting_ballot_spouse . '" class="img-thumbnail" width="300" height="300" /></a>'; } }
            if ($vinculation->picture_service == null) { $picture_service = ''; } else { if(pathinfo($vinculation->picture_service)['extension'] == 'pdf'){ $picture_service = '<a href="' . $vinculation->picture_service . '" target="_blank"><img src="/images/pdf.png" class="img-thumbnail" width="300" height="300" /></a>'; }else{ $picture_service = '<a href="' . $vinculation->picture_service . '" target="_blank"><img src="' . $vinculation->picture_service . '" class="img-thumbnail" width="300" height="300" /></a>'; } }
...
//        dd($country_id);
        ...
        if($vinFormVersion == 1){
            return view('vinculation.pn.v1',[
                'documents' => $documents, 'cities' => $cities, 'countries' => $countries, 'customer' => $customer[0], 'provinces' => $provinces,
    ...
    public function update(request $request){
        ...
        if(!$vinFormSearch->isEmpty()){
            if($vinFormSearch[0]->status_id ==1){
                ...
                $result=\App\Jobs\listaObservadosyCarteraMassivesVinculationJobs::dispatch($pbc->canal_plan_id, $saleSearch->customer_id, $request['saleId'], \Auth::user()->email);
