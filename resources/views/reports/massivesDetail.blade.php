...
<script src="{{ assets('js/reports/massivesDetail.js') }}"></script>
        ...
        <div class="col-md-10 col-md-offset-1 border" style="padding: 15px">
            <div class="row">
                <div class="col-xs-12 registerForm" style="margin:12px;">
                    <center>
                        <h4 style="font-weight:bold">Reporte Detallado Masivos</h4>
            ...
            <div class="col-md-12 border" style="margin-top:10px;margin-left:0;margin-right:15px;">
                <form method="POST" action="{{asset('/massivesDetailReports')}}">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="channelReport" name="channelReport" onchange=updateAgency(this.value)>
                                    ...
                                    <option value="{{$channel->channel_sponsor}}">{{$channel->channel_sponsor}}</option>
                                    @endforeach
                                </select>
                            </div> 
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="provinceReport" name="provinceReport" onchange='updateCity(this.value)'>
                                    ...
                                    @foreach($province as $p)
                                        <option value='{{$p->province_customer}}'>{{$p->province_customer}}</option>
                                    @endforeach
                                </select>
                            </div> 
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="advisor" name="advisor">
                                    ...
                                    @foreach($advisor as $a)
                                        <option value='{{$a->advisor_sponsor}}'>{{$a->advisor_sponsor}}</option>
                                    @endforeach
                                </select>
                            </div> 
                        </div>
