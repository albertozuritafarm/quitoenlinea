                       ...
                       <!-- <tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td colspan="3">Sociedad Anónima:<input type="checkbox" style="margin-top:5px;"  @if($vinculation->civil_state ==2) checked="checked" @endif ></td>
                            <td colspan="3">Cía. Limitada:<input type="checkbox" style="margin-top:5px;"  @if($vinculation->civil_state == 1) checked="checked" @endif ></td>
                            ...
                            <td colspan="2"> Pública: <input type="checkbox" style="margin-top:5px;" @if($vinculation->civil_state == 3) checked="checked" @endif ></td>
