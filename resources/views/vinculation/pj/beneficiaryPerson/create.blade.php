...
<script src="{{ assets('js/vinculation/pj/beneficiarios_juridica.js') }}"></script>
                     ...
                     <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="website" name="website" class="form-control registerForm" required tabindex="22" placeholder="Website" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}} maxlength="9">
                                    </div>
                                    <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="fax" name="fax" class="form-control registerForm" required tabindex="20" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}} maxlength="9">
                                    </div>
                    ...
                    <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                        ...
                                        <input type="text2" id="representante_fax" name="representante_fax" class="form-control registerForm" required tabindex="14" placeholder="fax" onchange="removeInputRedFocus(this.id)" value="{{$main_road}}" {{$disable_status}} maxlength="90">
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input id="is_beneficiary" name="is_beneficiary" class="is_beneficiaryCheckBox" type="checkbox" @if($beneficiaryName == null) checked="checked" @endif data-toggle="toggle" tabindex="35" data-on="No" data-off="Si" onchange="isBeneficiaryChange(this)" {{$disable_status}}>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6" style="margin: 5px 0;">
                        <form class="col-md-12 border" method="post" id="upload_formDocumentApplicant" name="upload_formDocumentApplicant" enctype="multipart/form-data" style="min-height:350px !important">
                            ...
                            <center>
                                ...
                                <a class="@if($picture_document_applicant == null) hidden @else visible @endif" id="deletePictureDocumentApplicant" href="#" onclick="deletePictureForm('DocumentApplicant','  ','{{$sales_id}}')">
                    ...
                    <div class="col-md-6" id="formDocumentSpouse" style="margin: 5px 0;">
                        <form class="col-md-12 border" method="post" id="upload_formDocumentSpouse" name="upload_formDocumentSpouse" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formDocumentSpouse'" style="min-height:350px !important">
                            ...
                            <center>
                                ...
                                <a class="@if($picture_document_spouse == null) hidden @else visible @endif" id="deletePictureDocumentSpouse" href="#" onclick="deletePictureForm('DocumentSpouse','  ','{{$sales_id}}')">
                                    @if($disable_status == null)
                                        <img src="{{asset('/images/menos.png')}}" style="width:20px;height:20px">
                                    @endif                                          </a>  
                            </center>
                    ...
                    <div class="col-md-6" style="margin: 5px 0;">
                        <form class="col-md-12 border" method="post" id="upload_formService" name="upload_formService" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formService'" style="min-height:350px !important">
                            ...
                            <center>
                                ...
                                <a class="@if($picture_service == null) hidden @else visible @endif" id="deletePictureService" href="#" onclick="deletePictureForm('Service','  ','{{$sales_id}}')">
                                    @if($disable_status == null)
                                        <img src="{{asset('/images/menos.png')}}" style="width:20px;height:20px">
                                    @endif                                        
                                </a>  
