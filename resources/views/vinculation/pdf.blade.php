                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td colspan="7" style="text-align:left;" class="underlineCell">{{$customer->first_name}} {{$customer->second_name}}</td>
                        ...
                        <tr>
                            <td colspan="3">Cédula Identidad:<input type="checkbox" style="margin-top:5px;margin-left:5px;" @if($customer->document_id == 1) checked="checked" @endif > </td>
                        ...
                        <tr>
                            ...
                            <td colspan="8" class="underlineCell" style="text-align:left;">{{$customer->email}}</td>
                        </tr>
                    </table>
                </div>
