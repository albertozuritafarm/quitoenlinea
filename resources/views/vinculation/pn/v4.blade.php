...
<script src="{{ assets('js/vinculation/pn/v4.js') }}"></script>
                        ...
                        <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" id="birth_date" name="birth_date" class="form-control registerForm" style="line-height: 15px !important" onchange="removeInputRedFocus(this.id)" value="{{$birth_date}}" @if($birth_date != null) readonly="readonly" @endif tabindex="9">
                                </div>
                                <div class="form-group col-md-6">
                    ...
                    <div id="spouseDiv" class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="spouseDocument" name="spouseDocument" class="form-control registerForm" required tabindex="21"  style="line-height: 15px !important;" value="{{$spouse_document}}" placeholder="Documento de Identidad Cónyuge" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <select id="spouse_document_id" name="spouse_document_id" class="form-control registerForm" required tabindex="22" onchange="removeInputRedFocus(this.id),validateDocumentSpouse()" {{$disable_status}}>
                                    <option selected="true" value="">--Escoja Una---</option>
                                    @foreach($documents as $doc)
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="spouseFirstName" name="spouseFirstName" class="form-control registerForm" required tabindex="23"  style="line-height: 15px !important" value="{{$spouse_name}}" placeholder="Nombre del Cónyuge" onchange="removeInputRedFocus(this.id)" {{$disable_status}} maxlength="60">
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="spouseLastName" name="spouseLastName" class="form-control registerForm" required tabindex="24"  style="line-height: 15px !important" value="{{$spouse_last_name}}" placeholder="Apellido(s) del Cónyuge" onchange="removeInputRedFocus(this.id)" value="{{$spouse_last_name}}" {{$disable_status}} maxlength="30">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text2" id="beneficiary_address" name="beneficiary_address" class="form-control registerForm" required tabindex="33"  style="line-height: 15px !important" value="{{$beneficiary_address}}" placeholder="Dirección de Domicilio" onchange="removeInputRedFocus(this.id)" {{$disable_status}} maxlength="200">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                        ...
                        <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="annual_income" name="annual_income" class="form-control registerForm" required tabindex="11" placeholder="Ingresos Anuales" onchange="removeInputRedFocus(this.id)" value="{{$annual_income}}" {{$disable_status}} maxlength="15">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="other_annual_income" name="other_annual_income" class="form-control registerForm" required tabindex="12" placeholder="Otros Ingresos Anuales" onchange="removeInputRedFocus(this.id)" value="{{$other_annual_income}}" {{$disable_status}} maxlength="15">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="total_annual_income" name="total_annual_income" class="form-control registerForm" required tabindex="13" placeholder="Total Ingresos" onchange="removeInputRedFocus(this.id)" value="{{$total_annual_income}}" readonly maxlength="15">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="description_other_income" name="description_other_income" class="form-control registerForm" required tabindex="14" placeholder="Descripción de otros Ingresos" maxlength="60" onchange="removeInputRedFocus(this.id)" value="{{$description_other_income}}" {{$disable_status}}>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="total_assets" name="total_assets" class="form-control registerForm" required tabindex="17" placeholder="Total Activos USD" onchange="removeInputRedFocus(this.id)" value="{{$total_assets}}" {{$disable_status}} maxlength="15">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="total_passives" name="total_passives" class="form-control registerForm" required tabindex="18" placeholder="Total de Pasivos USD" onchange="removeInputRedFocus(this.id)" value="{{$total_pasives}}" {{$disable_status}} maxlength="15">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="total_assets_pasives" name="total_assets_pasives" class="form-control registerForm" required tabindex="19" placeholder="Total Patrimonio (A-P)" onchange="removeInputRedFocus(this.id)" value="{{$total_assets_pasives}}" readonly maxlength="15">
                                </div>
                                <div class="form-group col-md-6">
                                </div>
                            </div>
                        ...
                        <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text2" id="personal_reference_name" name="personal_reference_name" class="form-control registerForm" required tabindex="20" placeholder="Nombre" onchange="removeInputRedFocus(this.id)" value="{{$personal_reference_name}}" {{$disable_status}}>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text2" id="personal_reference_relationship" name="personal_reference_relationship" class="form-control registerForm" required tabindex="21" placeholder="Parentesco" onchange="removeInputRedFocus(this.id)" value="{{$personal_reference_relationship}}" {{$disable_status}}>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text2" id="personal_reference_phone" name="personal_reference_phone" class="form-control registerForm" required tabindex="22" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" value="{{$personal_reference_phone}}" {{$disable_status}} maxlength="9">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text2" id="commercial_reference_name" name="commercial_reference_name" class="form-control registerForm" required tabindex="23" placeholder="Entidad" onchange="removeInputRedFocus(this.id)" value="{{$commercial_reference_name}}" {{$disable_status}}>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text2" id="commercial_reference_amount" name="commercial_reference_amount" class="form-control registerForm" required tabindex="24" placeholder="Monto" onchange="removeInputRedFocus(this.id), currencyFormat(this.id)" value="{{$commercial_reference_amount}}" {{$disable_status}} maxlength="15">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text2" id="commercial_reference_phone" name="commercial_reference_phone" class="form-control registerForm" required tabindex="25" placeholder="Teléfono"onkeyup="onlyNumber(this)" onchange="removeInputRedFocus(this.id)" value="{{$commercial_reference_phone}}" {{$disable_status}} maxlength="9">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="commercial_reference_bank_name" name="commercial_reference_bank_name" class="form-control registerForm" required tabindex="26" placeholder="Instirución Financiera" onchange="removeInputRedFocus(this.id)" value="{{$commercial_reference_bank_name}}" {{$disable_status}}>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="commercial_reference_product" name="commercial_reference_product" class="form-control registerForm" required tabindex="27" placeholder="Producto" onchange="removeInputRedFocus(this.id)" value="{{$commercial_reference_product}}" {{$disable_status}}>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input type="text2" id="work_name" name="work_name" class="form-control registerForm" required tabindex="28" placeholder="Nombre Empresa donde trabaja" onchange="removeInputRedFocus(this.id)" value="{{$work_name}}" {{$disable_status}} maxlength="60">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text2" id="work_phone" name="work_phone" class="form-control registerForm" required tabindex="29" placeholder="Teléfono Trabajo" onchange="removeInputRedFocus(this.id)" value="{{$work_phone}}" {{$disable_status}} maxlength="9">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text2" id="work_address" name="work_address" class="form-control registerForm" required tabindex="30" placeholder="Dirección Trabajo" onchange="removeInputRedFocus(this.id)" value="{{$work_address}}" {{$disable_status}} maxlength="225">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="picturesDiv" class="col-md-12" style="margin-top:15px;">
                    <div class="col-md-6" style="margin: 5px 0;">
                        <form class="col-md-12 border" method="post" id="upload_formDocumentApplicant" name="upload_formDocumentApplicant" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formDocumentApplicant'" style="min-height:350px !important">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="DocumentApplicantDate" name="DocumentApplicantDate" class="form-control" style="line-height:14px;" required="required" value="{{$document_applicant_date}}" {{$disable_status}}>
                            </div>
                            ...
                            <center>
                                ...
                                <div class="inputWrapper"><span id="uploaded_imageDocumentApplicant">{!! $picture_document_applicant !!}</span>
                                    ...
                                    <input class="fileInput" type="file" name="select_fileDocumentApplicant" onchange="fileNameFunction('DocumentApplicant')" id="select_fileDocumentApplicant" @if($disable_status != null) style="display:none" @endif>
                                </div>
                            </center>
                            <center>
                    ...
                    <div class="col-md-6" id="formDocumentSpouse" style="margin: 5px 0;">
                            <form class="col-md-12 border" method="post" id="upload_formDocumentSpouse" name="upload_formDocumentSpouse" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formDocumentSpouse'" style="min-height:350px !important">
                                ...
                                <div class="form-group">
                                    <span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span><label class="registerForm">Fecha de Caducidad</label>
                                    <input type="date" id="DocumentSpouseDate" name="DocumentSpouseDate" class="form-control" style="line-height:14px;" value="{{$document_spouse_date}}" {{$disable_status}}>
                                </div>    
                                <div class="form-group" style="text-align: center;">
                                ...
                                <center>
                                    ...
                                    <div class="inputWrapper"><span id="uploaded_imageDocumentSpouse">{!! $picture_document_spouse !!}</span>
                                        ...
                                        <input class="fileInput" type="file" name="select_fileDocumentSpouse" onchange="fileNameFunction('DocumentSpouse')" id="select_fileDocumentSpouse" @if($disable_status != null) style="display:none" @endif>
                                    </div>
                                </center>
                                <center>
                            ...
                            <form class="col-md-12 border" method="post" id="upload_formService" name="upload_formService" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formService'" style="min-height:350px !important">
                                ...
                                <center>
                                    <div class="inputWrapper"><span id="uploaded_imageService">{!! $picture_service !!}</span>
                                        ...
                                        <input class="fileInput" type="file" name="select_fileService" onchange="fileNameFunction('Service')" id="select_fileService" @if($disable_status != null) style="display:none" @endif>
                                    </div>
                                </center>
                                <center>
                        ...
                        <div class="col-md-6" style="margin: 5px 0;">
                            <form class="col-md-12 border" method="post" id="upload_formSri" name="upload_formSri" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formSri'" style="min-height:350px !important">
                                ...
                                <center>
                                    <div class="inputWrapper"><span id="uploaded_imageSri">{!! $picture_sri !!}</span>
                                        <center>
                                            <img src="{{asset('images/mas.png')}}" alt="Girl in a jacket" style="width:20px;height:20px;margin-bottom: -100px;">
                                        </center>
                                ...
                                <center>
                                    ...
                                    <a class="@if($picture_sri == null) hidden @else visible @endif" id="deletePictureSri" href="#" onclick="deletePictureForm('Sri','{{$customer->id}}','{{$sales_id}}')">
                                        @if($disable_status == null)
                                            <img src="{{asset('/images/menos.png')}}" style="width:20px;height:20px">
                                        @endif                                        
                                    </a>  
