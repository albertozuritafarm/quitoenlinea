...
<script src="{{ assets('js/vinculation/pn/v2.js') }}"></script>
...
<div class="container" style="margin-top:15px; font-size:14px !important">
    ...
    <div class="col-xs-12 col-md-10 col-md-offset-1 border" style="padding: 15px;">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-3 wizard_medio" style="padding-left:0px !important"><div id="secondStepWizard" class="wizard_inactivo registerForm">Actividad Ecónomica</div></div>
                        ...
                        <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="total_assets" name="total_assets" class="form-control registerForm" required tabindex="7" placeholder="Total Activos USD" onchange="removeInputRedFocus(this.id)" value="{{$total_assets}}" {{$disable_status}} maxlength="15">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="total_passives" name="total_passives" class="form-control registerForm" required tabindex="9" placeholder="Total de Pasivos USD" onchange="removeInputRedFocus(this.id)" value="{{$total_pasives}}" {{$disable_status}} maxlength="15">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="total_assets_pasives" name="total_assets_pasives" class="form-control registerForm" required tabindex="19" placeholder="Total Patrimonio (A-P)" onchange="removeInputRedFocus(this.id)" value="{{$total_assets_pasives}}" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                </div>
                            </div>
