                    ...
                    <div id="personalDiv" class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="documentForm" type="text" id="document" name="document" class="form-control registerForm" required tabindex="2" placeholder="Número de Identificación" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="{{$customer->document}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="phone" name="phone" class="form-control registerForm" required tabindex="2" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" value="{{$phone}}" {{$disable_status}}>
                            </div>
                        </div>
                    </div>
                </div>
