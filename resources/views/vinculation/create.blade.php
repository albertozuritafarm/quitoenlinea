...
<script src="{{ assets('js/vinculation/create.js') }}"></script>
                    ...
                    <div id="personalDiv" class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="first_name" name="first_name" class="form-control registerForm" required tabindex="1" placeholder="Nombre(s)" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="{{$customer->first_name}}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="second_name" name="second_name" class="form-control registerForm" required tabindex="3" placeholder="Nombre(s)" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="{{$customer->second_name}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="birth_city" name="birth_city" class="form-control registerForm" required onchange="removeInputRedFocus(this.id)" @if($birth_place != null) disabled="disabled" @endif tabindex="7">
                            ...
                            <div class="form-group">
                                ...
                                <select id="nationality" name="nationality" class="form-control registerForm" required onchange="removeInputRedFocus(this.id)" @if($nationality_id != null) disabled="disabled" @endif tabindex="9">
                                    <option value="">--Escoja Una---</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="string" id="main_road" name="main_road" class="form-control registerForm" required tabindex="11" placeholder="Calle Principal" maxlength="110" onchange="removeInputRedFocus(this.id)" value="{{$main_road}}" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="city" name="city" class="form-control registerForm" required tabindex="15" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                                    <option value="">--Escoja Una---</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="number" name="number" class="form-control registerForm" required tabindex="17" placeholder="N°" maxlength="10" onchange="removeInputRedFocus(this.id)" value="{{$address_number}}" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <select id="municipality" name="municipality" class="form-control registerForm" required tabindex="19" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="mobile_phone" name="mobile_phone" class="form-control registerForm" required tabindex="21" placeholder="Teléfono Celular" onchange="removeInputRedFocus(this.id)" value="{{$mobile_phone}}" {{$disable_status}}>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="last_name" name="last_name" class="form-control registerForm" required tabindex="2" placeholder="Apellido(s)" onchange="removeInputRedFocus(this.id)" @if($customer != false) disabled="disabled" value="{{$customer->last_name}}" @endif>
                            </div>
                            <div class="form-group">
                                <span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span><label class="registerForm" for="document_id"> Apellidos Completos</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                <input type="text" id="second_last_name" name="second_last_name" class="form-control registerForm" required tabindex="4" placeholder="Apellido(s)" onchange="removeInputRedFocus(this.id)" @if($customer != false) disabled="disabled" value="{{$customer->last_name}}" @endif>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="birth_date" name="birth_date" class="form-control registerForm" style="line-height: 15px !important" onchange="removeInputRedFocus(this.id)" value="{{$birth_date}}" @if($birth_date != null) readonly="readonly" @endif tabindex="8">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="secondary_road" name="secondary_road" class="form-control registerForm" required tabindex="12" placeholder="Calle Transversal"  maxlength="110" onchange="removeInputRedFocus(this.id)" value="{{$secondary_road}}" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <select id="province" name="province" class="form-control registerForm" required tabindex="14" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                                    <option selected="true" value="" disabled="disabled">--Escoja Una---</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="sector" name="sector" class="form-control registerForm" required tabindex="16" placeholder="Sector" maxlength="10" onchange="removeInputRedFocus(this.id)" value="{{$sector}}" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="phone" name="phone" class="form-control registerForm" required tabindex="18" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" value="{{$phone}}" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" class="form-control registerForm" required tabindex="20" placeholder="Correo" onchange="removeInputRedFocus(this.id)" value="{{$email}}" {{$disable_status}}>
                    ...
                    <div id="spouseDiv" class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select id="nationality_spouse" name="nationality_spouse" class="form-control registerForm" required tabindex="27" onchange="removeInputRedFocus(this.id)" @if($nationality_id != null) disabled="disabled" @endif>
                                    <option value="">--Escoja Una---</option>
                                    @foreach($countries as $cou)
                                    <option @if($cou->id == $nationality_id) selected="true" @endif value="{{$cou->id}}">{{$cou->name}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="company_name_spouse" name="company_name_spouse" class="form-control registerForm" required tabindex="31"  style="line-height: 15px !important" value="" placeholder="Nombre de la Empresa" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="phone_spouse" name="phone_spouse" class="form-control registerForm" required tabindex="33"  style="line-height: 15px !important" value="" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="email_spouse" name="email_spouse" class="form-control registerForm" required tabindex="35"  style="line-height: 15px !important" value="" placeholder="Email" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="spouseName" name="spouseName" class="form-control registerForm" required tabindex="28"  style="line-height: 15px !important" value="{{$spouse_name}}" placeholder="Nombre del Conyuge" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="date" id="birth_date_spouse" name="birth_date_spouse" class="form-control registerForm" style="line-height: 15px !important" tabindex="30" onchange="removeInputRedFocus(this.id)" value="" @if($birth_date != null) readonly="readonly" @endif>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="economic_activity_spouse" name="economic_activity_spouse" class="form-control registerForm" required tabindex="32"  style="line-height: 15px !important" value="" placeholder="Profesión o Actividad Económica" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="annual_income_spouse" name="annual_income_spouse" class="form-control registerForm" required tabindex="34"  style="line-height: 15px !important" value="" placeholder="Ingresos Anuales" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <span id="beneficiaryDataDiv" style="margin-top:-25px;">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text2" id="beneficiaryName" name="beneficiaryName" checked class="form-control registerForm" required tabindex="36"  style="line-height: 15px !important" value="" placeholder="Nombres Completos o Razón Social" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top:-25px">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text2" id="beneficiary_phone" name="beneficiary_phone" class="form-control registerForm" required tabindex="42"  style="line-height: 15px !important" value="" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top:-25px">
                                <div class="form-group">
                                    ...
                                    <input type="text2" id="beneficiary_document" name="beneficiary_document" class="form-control registerForm" required tabindex="39"  style="line-height: 15px !important" value="" placeholder="Documento" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text2" id="beneficiary_address" name="beneficiary_address" class="form-control registerForm" required tabindex="41"  style="line-height: 15px !important" value="" placeholder="Dirección de Domicilio" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text2" id="beneficiary_relationship" name="beneficiary_relationship" class="form-control registerForm" required tabindex="43"  style="line-height: 15px !important" value="" placeholder="Relación" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="economic_activity" name="economic_activity" class="form-control registerForm" required tabindex="1" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                                        <option value="">--Escoja Una---</option>
                                        @foreach($economicActivities as $eco)
                                        <option @if($economic_activity == $eco->id) selected="true" @endif value="{{$eco->id}}">{{$eco->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div id="otherEconomicActivityDiv" class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text2" id="other_economic_activity" name="other_economic_activity" class="form-control registerForm" required tabindex="2" placeholder="Especifique" onchange="removeInputRedFocus(this.id)" value="{{$other_economic_activity}}" {{$disable_status}}>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="occupation" name="occupation" class="form-control registerForm" required tabindex="3" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                                        <option value="">--Escoja Una---</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text2" id="position" name="position" class="form-control registerForm" required tabindex="5" placeholder="Cargo que desempeña" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text2" id="company_address" name="company_address" class="form-control registerForm" required tabindex="7" placeholder="Dirección del Trabajo" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select id="charge_address" name="charge_address" class="form-control registerForm" required tabindex="9" onchange="removeInputRedFocus(this.id)" {{$disable_status}}>
                                        <option value="">--Escoja Una---</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text2" id="company_name" name="company_name" class="form-control registerForm" required tabindex="4" placeholder="Nombre de la Empresa" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="email" id="company_email" name="company_email" class="form-control registerForm" required tabindex="6" placeholder="Correo Electrónico" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="email" id="company_phone" name="company_phone" class="form-control registerForm" required tabindex="8" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text2" id="other_economic_activity" name="other_economic_activity" class="form-control registerForm" required tabindex="10" placeholder="Otro" onchange="removeInputRedFocus(this.id)" value="{{$other_economic_activity}}" {{$disable_status}}>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="financingDiv" class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text2" id="annual_income" name="annual_income" class="form-control registerForm" required tabindex="11" placeholder="Otros Ingresos Anuales" onchange="removeInputRedFocus(this.id)" value="{{$monthly_income}}" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text2" id="total_annual_income" name="total_annual_income" class="form-control registerForm" required tabindex="13" placeholder="Total Ingresos" onchange="removeInputRedFocus(this.id)" value="{{$monthly_outcome}}" disabled>
                            </div>
                            <!--                            <div class="form-group">
                                                            ...
                                                            <input type="text2" id="total_pasives" name="total_pasives" class="form-control registerForm" required tabindex="2" placeholder="Total Pasivos" onchange="removeInputRedFocus(this.id)" value="{{$total_pasives}}" {{$disable_status}}>
                                                        </div>-->
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text2" id="other_annual_income" name="other_annual_income" class="form-control registerForm" required tabindex="12" placeholder="Otros Ingresos Anuales" onchange="removeInputRedFocus(this.id)" value="{{$total_actives}}" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text2" id="description_other_income" name="description_other_income" class="form-control registerForm" required tabindex="14" placeholder="Descripción de otros Ingresos" onchange="removeInputRedFocus(this.id)" value="{{$total_actives}}" {{$disable_status}}>
                            </div>
                            <!--                            <div class="form-group">
                                                            ...
                                                            <label class="radio-inline"><input type="radio" name="optradio2" value="yes" @if($other_monthly_income != null) checked @endif {{$disable_status}}>Si</label>
                                                            <label class="radio-inline"><input type="radio" name="optradio2" value="no"@if($other_monthly_income == null) checked @endif {{$disable_status}}>No</label>
                        ...
                        <div id="otherIncomeDiv" class="col-md-12" style="margin-top:-25px">
                            <div class="form-group" style="width:48%;float:left;">
                                ...
                                <input type="text2" id="other_monthly_income" name="other_monthly_income" class="form-control registerForm" required tabindex="15" placeholder="Ingresos diferentes de la actividad principal" onchange="removeInputRedFocus(this.id)" value="{{$other_monthly_income}}" {{$disable_status}}>
                            </div>
                            <div class="form-group"  style="width:48%;float:right;">
                                ...
                                <input type="text2" id="other_monthly_income_source" name="other_monthly_income_source" class="form-control registerForm" required tabindex="16" placeholder="Fuente de los otros Ingresos" onchange="removeInputRedFocus(this.id)" value="{{$other_monthly_income_source}}" {{$disable_status}}>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="financindSecondDiv" class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text2" id="total_assets" name="total_assets" class="form-control registerForm" required tabindex="17" placeholder="Total Activos USD" onchange="removeInputRedFocus(this.id)" value="{{$monthly_income}}" {{$disable_status}}>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text2" id="total_assets_pasives" name="total_assets_pasives" class="form-control registerForm" required tabindex="19" placeholder="Total Patrimonio (A-P)" onchange="removeInputRedFocus(this.id)" value="{{$monthly_income}}" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text2" id="total_passives" name="total_passives" class="form-control registerForm" required tabindex="18" placeholder="Total de Pasivos USD" onchange="removeInputRedFocus(this.id)" value="{{$total_actives}}" {{$disable_status}}>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="financindThirdDiv" class="col-md-12">
                        ...
                        <div class="col-md-4" style="margin-top:-25px;">
                            <div class="form-group">
                                ...
                                <input type="text2" id="personal_reference_name" name="personal_reference_name" class="form-control registerForm" required tabindex="20" placeholder="Nombre" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                            </div>
                        </div>
                        <div class="col-md-4" style="margin-top:-25px;">
                            <div class="form-group">
                                ...
                                <input type="text2" id="personal_reference_relationship" name="personal_reference_relationship" class="form-control registerForm" required tabindex="21" placeholder="Parentesco" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                            </div>
                        </div>
                        <div class="col-md-4" style="margin-top:-25px;">
                            <div class="form-group">
                                ...
                                <input type="text2" id="personal_reference_phone" name="personal_reference_phone" class="form-control registerForm" required tabindex="22" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                            </div>
                        </div>
                        <div class="col-md-12" style="margin-top:-25px;">
                            <div class="form-group">
                        ...
                        <div class="col-md-4" style="margin-top:-25px;">
                            <div class="form-group">
                                ...
                                <input type="text2" id="commercial_reference_name" name="commercial_reference_name" class="form-control registerForm" required tabindex="23" placeholder="Entidad" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                            </div>
                        </div>
                        <div class="col-md-4" style="margin-top:-25px;">
                            <div class="form-group">
                                ...
                                <input type="text2" id="commercial_reference_relationship" name="commercial_reference_relationship" class="form-control registerForm" required tabindex="24" placeholder="Monto" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                            </div>
                        </div>
                        <div class="col-md-4" style="margin-top:-25px;">
                            <div class="form-group">
                                ...
                                <input type="text2" id="commercial_reference_phone" name="commercial_reference_phone" class="form-control registerForm" required tabindex="25" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                            </div>
                        </div>
                        <div class="col-md-12" style="margin-top:-25px;">
                            <div class="form-group">
                        ...
                        <div class="col-md-6" style="margin-top:-25px;">
                            <div class="form-group">
                                ...
                                <input type="text2" id="commercial_reference_bank_name" name="commercial_reference_bank_name" class="form-control registerForm" required tabindex="26" placeholder="Instirución Financiera" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                            </div>
                        </div>
                        <div class="col-md-6" style="margin-top:-25px;">
                            <div class="form-group">
                                ...
                                <input type="text2" id="commercial_reference_product" name="commercial_reference_product" class="form-control registerForm" required tabindex="27" placeholder="Producto" onchange="removeInputRedFocus(this.id)" value="" {{$disable_status}}>
                            </div>
                        </div>
                    </div>
                </div>
