...
<script src="{{ assets('js/account/create.js') }}"></script>
    ...
    <div class="col-md-8 col-md-offset-2 border">
        ...
        <div id="firstStep">
                        ...
                        <div id="personalDiv" class="col-md-12">
                            ...
                            <div class="col-md-6" style="margin-top:-15px">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control registerForm" name="mobile_phone" id="mobile_phone" placeholder="Celular" value="{{ old('mobile_phone') }}" required tabindex="14" onchange="removeInputRedFocus(this.id)">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6" style="margin-top:-15px">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control registerForm" name="phone" id="phone" placeholder="Teléfono" value="{{ old('phone') }}" required tabindex="15" onchange="removeInputRedFocus(this.id)">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control registerForm" name="email" id="email" placeholder="Correo" value="{{old('email')}}" required tabindex="19" onchange="removeInputRedFocus(this.id)">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control registerForm" name="first_name_representative" id="first_name_representative" placeholder="Nombre" value="{{ old('first_name') }}" required="required" tabindex="24" disabled="disabled" onchange="removeInputRedFocus(this.id)">
                                    </div>
                                    <div class="form-group">
                                        <span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span><label class="registerForm" style="list-style-type:disc;" for="first_name"> Fecha de Nacimiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="relationship_representative" name="relationship_representative" class="form-control registerForm" value="{{old('document_id')}}" required tabindex="28" onchange="removeInputRedFocus(this.id)" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span><label class="registerForm" for="document_id"> Tipo Documento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                        <select id="document_id_representative" name="document_id_representative" class="form-control registerForm" value="{{old('document_id')}}" required tabindex="23" disabled="disabled" onchange="removeInputRedFocus(this.id)">
                                            <option selected="true" value="">--Escoja Una---</option>
                                            @foreach($documents as $document)
                                            <option value="{{$document->id}}">{{$document->name}}</option>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control registerForm" name="last_name_representative" id="last_name_representative" placeholder="Apellido" value="{{ old('last_name') }}" required tabindex="25" disabled="disabled" onchange="removeInputRedFocus(this.id)">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="relationship_representative" name="relationship_representative" class="form-control registerForm" required tabindex="28" onchange="removeInputRedFocus(this.id)" >
                                            <option selected="true" value="">--Escoja Una---</option>
                                            @foreach($economicActivity as $eco)
            ...
            <div class="col-md-12" style="margin-top:5px;padding-top:15px;padding-bottom:15px">
                <a class="btn btn-default registerForm" align="left" href="{{ asset('/account') }}" style="margin-left:-15px" tabindex="30"> Cancelar </a>
