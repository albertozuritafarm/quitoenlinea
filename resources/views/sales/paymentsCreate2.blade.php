    ...
    <div class="col-md-8 col-md-offset-2 border" style="margin-top:10px">
        ...
        <div class="col-md-10 col-md-offset-1" style="margin-top:5px;padding-top:15px;">
            ...
            <div class="row" style="float:right">
                <a href="{{asset('/sales/payments/create?document='.\encrypt($customer->document).'&sales='.\encrypt($sale->id))}}" class="btn btn-back registerForm"><span class="glyphicon glyphicon-step-backward"></span> Anterior </a>
                ...
                <table id="saleResumeTable" class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">{{date('d-m-Y',strtotime($sale->emission_date))}}</td>
                            <td align="center">{{date('d-m-Y',strtotime($sale->begin_date))}}</td>
                            <td align="center">{{date('d-m-Y',strtotime($sale->end_date))}}</td>
        ...
        <div class="col-xs-10 col-md-10 col-md-offset-1 border" style="padding-left:0px !important;margin-top:25px;">
            ...
            <div style="margin-top:15px;">
                <form action="{{asset('/sales/payments/pay/result')}}" class="paymentWidgets" data-brands="VISA MASTER AMEX DINERS DISCOVER"></form>
        ...
        <form class="hidden" id="paymentForm" action="{{asset('/sales/payments/create')}}" method="POST">
            {{ csrf_field() }}
            <input type="hidden" id="chargeId" name="chargeId" value="{{$sale->id}}">
