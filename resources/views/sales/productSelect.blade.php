...
<!--<script src="{{ assets('js/sales/productSelect.js') }}"></script>-->
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="avatar">
                            ...
                            <!--<img src="{{assets('fonts/solid/car.svg')}}" style="font-size:60px;width:50%;color:white;">-->
                        </div>
                        <div class="cardTitle">
                            <h3>Vehículos</h3>
                        ...
                        <div class="content">
                            <p>Nuestro seguro de vehículo protege tu vida y ampara a tu familia en caso de siniestro.</p>
                            <p style="align-content: center"><a href="{{asset('sales/create')}}" class="btn btn-default registerForm">Cotizar</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card">
                        ...
                        <div class="content">
                            ...
                            <br>
                            <p style="align-content: center"><a href="{{asset('sales/R2/create')}}" class="btn btn-default registerForm">Cotizar</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card">
                        ...
                        <div class="content">
                            ...
                            <br>
                            <p style="align-content: center"><a href="{{asset('sales/R4/create')}}" class="btn btn-default registerForm">Cotizar</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card">
                        ...
                        <div class="content">
                            ...
                            <p style="align-content: center;"><a href="{{asset('sales/R3/create')}}" class="btn btn-default registerForm">Cotizar</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<img class="src-image"  src="{{assets('images/car.jpeg')}}"/>
