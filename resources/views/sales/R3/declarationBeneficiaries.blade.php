...
<script src="{{ assets('js/sales/R3/declarationBeneficiaries.js') }}"></script>
                ...
                <div id="firstStep" class="col-md-12">
                    <div class="col-md-12" style="margin-top:5px;padding-top:15px;">
                        ...
                        <div class="row" style="float:right">
                            <a id="firstStepBtnNext1" class="btn btn-info registerForm @if($disabled == '') @else hidden @endif" align="right" href="#" style="padding: 5px"  @if($disabled == '') onclick="firstStepBtnNext()" @else {{$disabled}} @endif> Guardar <span class="glyphicon glyphicon-step-forward"></span></a>
                        </div>
                    </div>
                   @if (session('R3Success'))
                       <div class="alert alert-success">
                           {{ session('R3Success') }}
                       </div>
                   @endif
                    <div class="col-xs-12 col-md-12 border @if($disabled == '') @else  @endif" style="padding-left:0px !important;">
                               ...
                               <input type="hidden" id="salId" name="salId" value="{{$sale->id}}">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6 col-md-offset-6">
                                        <a @if($disabled == '') onclick="addBeneficiary()" @else {{$disabled}} @endif id="btnBeneficiary"  class="btn btn-success registerForm" align="right" href="#" style="float:right;margin-right: 0px;padding: 5px;width:100px" required tabindex="7"><span class="glyphicon glyphicon-plus"></span>Agregar </a>
                                    </div>
                                </div>
                                <div class="form-row">
                    ...
                    <div class="col-md-12" style="padding-bottom:15px">
                        ...
                        <div class="row" style="float:right">
                            <a id="firstStepBtnNext2" class="btn btn-info registerForm @if($disabled == '') @else hidden @endif" align="right" href="#" style="padding: 5px" @if($disabled == '') onclick="firstStepBtnNext()" @else {{$disabled}} @endif> Guardar <span class="glyphicon glyphicon-step-forward"></span></a>
                        </div>
                    </div>
                </div>
            </form>
