                    ...
                    <div id="beneficiaryForm" class="col-md-12" style="padding-top: 25px;padding-bottom: 25px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="document_id" name="document_id" class="form-control registerForm" value="{{old('document_id')}}" required tabindex="2" disabled="disabled" onchange="documentIdChange(this.value)">
