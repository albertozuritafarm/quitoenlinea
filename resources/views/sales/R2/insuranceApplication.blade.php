                            ...
                            <form>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control registerForm" name="document" id="document" value="{{$customer->document}}"  placeholder="Cédula" required="required" tabindex="4" disabled="disabled">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="phone" id="phone" placeholder="Teléfono" value="{{$customer->phone}}" required tabindex="12" disabled="disabled">
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="address" id="address" placeholder="Dirección" required tabindex="13" value="{{$customer->address}}" disabled="disabled">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                            ...
                                            <td span="3" colspan="3">
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text2" class="form-control registerForm" name="diagnosis1" id="diagnosis1" placeholder="Diagnóstico y tratamiento" @if($insuranceApp != null) value="{{$insuranceApp->diagnosis1}}" @endif required tabindex="6" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text2" class="form-control registerForm" name="duration1" id="duration1" placeholder="Duración" @if($insuranceApp != null) value="{{$insuranceApp->duration1}}" @endif required tabindex="8" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text2" class="form-control registerForm" name="hospital1" id="hospital1" placeholder="Nombre del Médico  - Clínica – Hospital" @if($insuranceApp != null) value="{{$insuranceApp->hospital1}}" @endif required tabindex="9" maxlength="100">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr style="background-color: transparent;" id="textArea_mH2" @if($insuranceApp == null) hidden="true" @else @if($insuranceApp->medicalHistory2 == 'no' || $insuranceApp->medicalHistory2 == null) hidden="true" @endif @endif>
                                            <td span="3" colspan="3">
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Diagnóstico y tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="diagnosis2" id="diagnosis2" placeholder="Diagnóstico y tratamiento" @if($insuranceApp != null) value="{{$insuranceApp->diagnosis2}}" @endif required tabindex="12" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="treatmentDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Duración</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="duration2" id="duration2" placeholder="Duración" @if($insuranceApp != null) value="{{$insuranceApp->duration2}}" @endif required tabindex="14" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombre del Médico  - Clínica – Hospital</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="hospital2" id="hospital2" placeholder="Nombre del Médico  - Clínica – Hospital" @if($insuranceApp != null) value="{{$insuranceApp->hospital2}}" @endif required tabindex="15" maxlength="100">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr style="background-color: transparent;" id="textArea_mH3" @if($insuranceApp == null) hidden="true" @else @if($insuranceApp->medicalHistory3 == 'no' || $insuranceApp->medicalHistory3 == null) hidden="true" @endif @endif>
                                            <td span="3" colspan="3">
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Diagnóstico y tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="diagnosis3" id="diagnosis3" placeholder="Diagnóstico y tratamiento" @if($insuranceApp != null) value="{{$insuranceApp->diagnosis3}}" @endif required tabindex="18" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="treatmentDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Duración</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="duration3" id="duration3" placeholder="Duración" @if($insuranceApp != null) value="{{$insuranceApp->duration3}}" @endif required tabindex="20" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombre del Médico  - Clínica – Hospital</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="hospital3" id="hospital3" placeholder="Nombre del Médico  - Clínica – Hospital" @if($insuranceApp != null) value="{{$insuranceApp->hospital3}}" @endif required tabindex="21" maxlength="100">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr style="background-color: transparent;" id="textArea_mH4" @if($insuranceApp == null) hidden="true" @else @if($insuranceApp->medicalHistory4 == 'no' || $insuranceApp->medicalHistory4 == null) hidden="true" @endif @endif>
                                            <td span="3" colspan="3">
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Diagnóstico y tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="diagnosis4" id="diagnosis4" placeholder="Diagnóstico y tratamiento" @if($insuranceApp != null) value="{{$insuranceApp->diagnosis4}}" @endif required tabindex="24" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="treatmentDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Duración</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="duration4" id="duration4" placeholder="Duración" @if($insuranceApp != null) value="{{$insuranceApp->duration4}}" @endif required tabindex="26" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombre del Médico  - Clínica – Hospital</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="hospital4" id="hospital4" placeholder="Nombre del Médico  - Clínica – Hospital" @if($insuranceApp != null) value="{{$insuranceApp->hospital4}}" @endif required tabindex="27" maxlength="100">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr style="background-color: transparent;" id="textArea_mH5" @if($insuranceApp == null) hidden="true" @else @if($insuranceApp->medicalHistory5 == 'no' || $insuranceApp->medicalHistory5 == null) hidden="true" @endif @endif>
                                            <td span="3" colspan="3">
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Diagnóstico y tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="diagnosis5" id="diagnosis5" placeholder="Diagnóstico y tratamiento" @if($insuranceApp != null) value="{{$insuranceApp->diagnosis5}}" @endif required tabindex="30" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="treatmentDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Duración</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="duration5" id="duration5" placeholder="Duración" @if($insuranceApp != null) value="{{$insuranceApp->duration5}}" @endif required tabindex="32" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombre del Médico  - Clínica – Hospital</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="hospital5" id="hospital5" placeholder="Nombre del Médico  - Clínica – Hospital" @if($insuranceApp != null) value="{{$insuranceApp->hospital5}}" @endif required tabindex="33" maxlength="100">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr style="background-color: transparent;" id="textArea_mH6" @if($insuranceApp == null) hidden="true" @else @if($insuranceApp->medicalHistory6 == 'no' || $insuranceApp->medicalHistory6 == null) hidden="true" @endif @endif>
                                            <td span="3" colspan="3">
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Diagnóstico y tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="diagnosis6" id="diagnosis6" placeholder="Diagnóstico y tratamiento" @if($insuranceApp != null) value="{{$insuranceApp->diagnosis6}}" @endif required tabindex="36" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="treatmentDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Duración</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="duration6" id="duration6" placeholder="Duración" @if($insuranceApp != null) value="{{$insuranceApp->duration6}}" @endif required tabindex="38" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombre del Médico  - Clínica – Hospital</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="hospital6" id="hospital6" placeholder="Nombre del Médico  - Clínica – Hospital" @if($insuranceApp != null) value="{{$insuranceApp->hospital6}}" @endif required tabindex="39" maxlength="100">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                       ...
                                       <tr style="background-color: transparent;" id="textArea_mH7" @if($insuranceApp == null) hidden="true" @else @if($insuranceApp->medicalHistory7 == 'no' || $insuranceApp->medicalHistory7 == null) hidden="true" @endif @endif>
                                           <td span="3" colspan="3">
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Diagnóstico y tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="diagnosis7" id="diagnosis7" placeholder="Diagnóstico y tratamiento" @if($insuranceApp != null) value="{{$insuranceApp->diagnosis7}}" @endif required tabindex="42" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="treatmentDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Duración</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="duration7" id="duration7" placeholder="Duración" @if($insuranceApp != null) value="{{$insuranceApp->duration7}}" @endif required tabindex="44" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombre del Médico  - Clínica – Hospital</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="hospital7" id="hospital7" placeholder="Nombre del Médico  - Clínica – Hospital" @if($insuranceApp != null) value="{{$insuranceApp->hospital7}}" @endif required tabindex="45" maxlength="100">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr style="background-color: transparent;" id="textArea_mH8" @if($insuranceApp == null) hidden="true" @else @if($insuranceApp->medicalHistory8 == 'no' || $insuranceApp->medicalHistory8 == null) hidden="true" @endif @endif>
                                            <td span="3" colspan="3">
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Diagnóstico y tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="diagnosis8" id="diagnosis8" placeholder="Diagnóstico y tratamiento" @if($insuranceApp != null) value="{{$insuranceApp->diagnosis8}}" @endif required tabindex="48" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="treatmentDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de tratamiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Duración</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="duration8" id="duration8" placeholder="Duración" @if($insuranceApp != null) value="{{$insuranceApp->duration8}}" @endif required tabindex="50" maxlength="100">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="registerForm" for="doctor_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombre del Médico  - Clínica – Hospital</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                                        <input type="text2" class="form-control registerForm" name="hospital8" id="hospital8" placeholder="Nombre del Médico  - Clínica – Hospital" @if($insuranceApp != null) value="{{$insuranceApp->hospital8}}" @endif required tabindex="51" maxlength="100">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
