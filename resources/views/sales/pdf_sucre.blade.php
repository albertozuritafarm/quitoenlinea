    ...
    <body>
        ...
        <main>
            <div class="col-md-10">
                ...
                <br><hr>
                <span>
                    El  Contratante  y/o  Asegurado  podrá  solicitar  a  la  Superintendencia  de  Compañías,  Valores  y  Seguros  laverificación de este texto. <br>Lugar y fecha: Quito, {{$date}}
                </span>
                <br><hr><hr>
                <center>
