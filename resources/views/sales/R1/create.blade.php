        ...
        <div class="col-md-12">
            <form name="salesForm" method="POST" action="/user" id="salesForm">
                        ...
                        <form action="" style="margin-top: 25px;">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="newVehicle" class="form-control registerForm" id="newVehicle" tabindex="21" required {{$disabled}} onchange="newVehicleChange(this.value)">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-inline">
                                        <input type="text" class="form-control registerForm" name="plateForm" id="plateForm" tabindex="23" placeholder="Placa/RAMV" value="{{ old('plate') }}" maxlength="11" required style="width:89%" onclick="clearVehicleForm();" onkeydown="clearVehicleForm();">
                                        <button type="button" class="btn btn-info" id="plateBtn" @if($disabled != null) disabled="disabled" @else @endif style="width:10%" tabindex="24"><span class="glyphicon glyphicon-search"></span></button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <form action="" style="margin-top: 25px;">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control registerForm" name="ramv" id="ramv" tabindex="25" placeholder="RAMV" value="{{ old('plate') }}" maxlength="11" required disabled="disabled">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control registerForm" name="plate" id="plate" tabindex="26" placeholder="Placa" value="{{ old('plate') }}" maxlength="7" required disabled="disabled">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" class="form-control registerForm" name="model" id="model" tabindex="27" placeholder="Modelo" value="{{ old('model') }}" required disabled="disabled" maxlength="50">
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control registerForm yearVehicle" name="year" id="year" tabindex="29" placeholder="Año" value="{{ old('year') }}" min="1" required disabled="disabled" maxlength="4">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="vehiType" class="form-control registerForm" id="vehiType" tabindex="30" required>
                                        ...
                                        <option id="typeSelect" value="{{$type->name}}">{{$type->full_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <form action="" style="margin-top: 25px;">    
                            ...
                            <div class="col-md-6 col-md-offset-6">
                                <div class="form-group">
                                    <a  id="btnVehicles" @if($disabled != null) disabled="disabled" @else @endif class="btn btn-success registerForm" align="right" href="#" style="float:right;margin-right: 0px;padding: 5px;width:100px" tabindex="36" ><span class="glyphicon glyphicon-plus"></span>Agregar </a>
                                </div>
                            </div>
                ...
                <div id="thirdStep" class="col-md-12 hidden">
                    <div class="col-md-12" style="margin-top:5px;padding-top:15px;">
                        <div class="row" style="float:left">
                            <a class="btn btn-default registerForm" align="right" href="{{asset('/sales')}}" tabindex="41" > Cancelar </a>
                        </div>
                        <div class="row" style="float:right">
                        ...
                        <form action="" style="margin-top:25px;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control registerForm" name="description" id="description" tabindex="42" placeholder="Descripción" value="{{ old('model') }}" required maxlength="100">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                    ...
                    <div class="col-md-12" style="padding-bottom:15px">
                        <div class="row" style="float:left">
                            <a class="btn btn-default registerForm" align="right" href="{{asset('/sales')}}" tabindex="47" > Cancelar </a>
                        </div>
                        <div class="row" style="float:right">
                ...
                <div id="fourthStep" class="col-md-12 hidden">
                    <div class="col-md-12" style="margin-top:5px;padding-top:15px;">
                        <div class="row" style="float:left">
                            <a class="btn btn-default registerForm" align="right" href="{{asset('/sales')}}" tabindex="49"> Cancelar </a>
                        </div>
                        <div class="row" style="float:right">
                    ...
                    <div class="col-md-12" style="padding-bottom:15px">
                        <div class="row" style="float:left">
                            <a class="btn btn-default registerForm" align="right" href="{{asset('/sales')}}" tabindex="51"> Cancelar </a>
                        </div>
                        <div class="row" style="float:right">
                ...
                <div id="fifthStep" class="col-md-12 hidden">
                    ...
                    <div class="col-md-12" style="padding-bottom:15px">
                        <div class="row" style="float:left">
                            <a class="btn btn-default registerForm" align="right" href="{{asset('/sales')}}" tabindex="58"> Cancelar </a>
                        </div>
                        <div class="row" style="float:right">
