<script src="{{ assets('js/sales/R1/emitVehicleNew.js') }}"></script>
                    ...
                    <form>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" min="{{$minDate}}" max="{{$maxDate}}" name="beginDate" id="beginDate"  onkeydown="return false"  placeholder="Correo" @if($newVehicle == 'false') value='{{$beginDate}}' @else value='' @endif style="line-height:14px" onchange="removeInputRedFocus('beginDate'), changeEndDate(this.value)" {{$disabled}}>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-inline">
                                            <input autocomplete="off" type="text" class="form-control registerForm" name="document" id="document" value="" @if($disabled) disabled="disabled" @else @endif placeholder="Cédula" required="required"tabindex="1" style="width:89%" onclick="clearFormEndoso()" onchange="clearFormEndoso()">
