        ...
        <main>
            ...
            <div class="" style="width:100%;">
                <div style="padding-left: 10px;">
                    ...
                    @foreach($car as $car)
                        <tr>
                            <td style="text-align: center;">{{$car->plate}}</td>
                            <td style="text-align: center;">{{$car->brand}}</td>
                            <td style="text-align: center;">{{$car->model}}</td>
                            <td style="text-align: center;">{{$car->year}}</td>
                            <td style="text-align: center;">{{$car->refValue}}</td>
                            <td style="text-align: center;">{{asCurrency($car->ins_value)}}</td>
                            <td style="text-align: center;">{{asCurrency($car->acc_value)}}</td>
                        </tr>
                    @endforeach
