<script src="{{ assets('js/sales/R4/emit.js') }}"></script>
                    ...
                    <form>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" name="beginDate" id="beginDate" placeholder="Correo" value='{{$beginDate}}' style="line-height:14px" onchange="removeInputRedFocus('beginDate'), changeEndDate(this.value)" disabled="disabled">
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" name="endDate" id="endDate" placeholder="Correo" value='{{$endDate}}' style="line-height:14px" onchange="removeInputRedFocus('endDate')" disabled="disabled">
                            </div>
                        </div>
                    </form>
                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-inline">
                                            <input autocomplete="off" type="text" class="form-control registerForm" name="document" id="document" value="" @if($disabled) disabled="disabled" @else @endif placeholder="RUC" required="required"tabindex="1" style="width:89%" onclick="clearFormEndoso()" onchange="clearFormEndoso()">
