...
<script src="{{ assets('js/scheduling/index.js') }}"></script>
...
<div class="container" style="width: 100%">
    <div>
        <div class="col-md-12 hidden border" id="filter" style="margin-top:10px;margin-left:0;margin-right:15px;">
            <form method="POST" action="{{asset('/scheduling')}}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            <label style="list-style-type:disc;" for="plate">Placa</label>
                            <input type="text" class="form-control" name="plate" id="plate" placeholder="Placa" style="line-height:14px" value="{{session('schedulingPlate')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="beginDate" id="beginDate" placeholder="fecha" style="line-height:14px" value="{{session('schedulingBeginDate')}}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label style="list-style-type:disc;" for="endDate">Fecha Fin</label>
                            <input type="date" class="form-control" name="endDate" id="endDate" placeholder="fecha" style="line-height:14px" onchange="endDateChange()" value="{{session('schedulingEndDate')}}">
                        </div>
                    </div><div class="col-md-2">
                        <div class="form-group">
                            <label style="list-style-type:disc;" for="first_name">Nombre</label>
                            <input type="text" class="form-control" name="first_name" id="first_name" placeholder="Nombre" style="line-height:14px" value="{{session('schedulingFirstName')}}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label style="list-style-type:disc;" for="last_name">Apellido</label>
                            <input type="text" class="form-control" name="last_name" id="last_name" placeholder="Apellido" style="line-height:14px" value="{{session('schedulingLastName')}}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label style="list-style-type:disc;" for="document">Documento</label>
                            <input type="text" class="form-control" name="document" id="document" placeholder="Documento" style="line-height:14px" value="{{session('schedulingDocument')}}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status">
                                ...
                                @foreach($status as $sta)
                                    @if($sta->id == session('schedulingStatus'))
        ...
        <div class="col-md-12" style="margin-left: -15px">
            ...
            <div class="alert alert-success" style="margin-right:-20px">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <center>
                    <span class="glyphicon glyphicon-ok" id="annulmentMsgSuccess"  style="font-weight: bold;">{{ session('storeMessage') }}</span>
                </center>
            </div>
            @endif
            @if (Session::has('rescheduleSuccess'))
            <div class="alert alert-success" style="margin-right:-20px">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <center>
                    <span class="glyphicon glyphicon-ok" id="annulmentMsgSuccess"  style="font-weight: bold;"> {{ session('rescheduleSuccess') }}</span>
                </center>
            </div>
            @endif
            ...
            <div class="alert alert-success" style="margin-right:-20px">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <center>
                    <span class="glyphicon glyphicon-ok" style="font-weight: bold;"> {{ session('confirmSuccess') }}</span>
                </center>
            </div>
            @endif
            ...
            @if($create)
            <a type="button" class="border btnTable" href="{{asset('/scheduling/create')}}" data-toggle="tooltip" title="Nuevo"><img src="{{asset('images/mas.png')}}" width="24" height="24" alt=""></a>
            @else
            @endif
            @include('pagination.items')
        </div>
        <div id="tableData">
            @include('pagination.scheduling')
        </div>
    </div>
</div>
<!-- RESUME MODAL-->
...
//        window.location = "{{ $newSchedules->url(1) }}&items=" + this.value;
