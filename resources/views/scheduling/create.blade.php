        ...
        <form method="POST" action="#">
            <div id="firstStep">
                ...
                <div class="col-md-10 col-md-offset-1" style="margin-top:5px;padding-top:15px;padding-bottom:15px">
                    <div class="col-md-1">
                        <a class="btn btn-default registerForm" align="right" href="{{asset('/scheduling')}}" style="margin-left: -30px;"> Cancelar </a>
                    </div>
...
<script src="{{ assets('js/scheduling/create.js') }}"></script>
