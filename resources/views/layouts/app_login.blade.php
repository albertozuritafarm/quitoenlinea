...
<html lang="es">
    <head>
        ...
        <link href="{{ assets('scripts/jquery-ui-1.11.4.custom/jquery-ui.min.css')}}" rel="stylesheet" type="text/css"/>
    ...
    <body class="fondo_login">
        ...
        <footer class="modal-footer">
            <a target="_blank" href="#" style="border:none; color:#FFF; font-size:12px">Magnus | {{date('Y')}} </a>
        </footer>
