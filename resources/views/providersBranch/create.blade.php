...
<script src="{{ assets('js/providersBranch/create.js') }}"></script>
...
<div class="container" style="width: 100%">
    <div>
        ...
        <div id="tableData">
            @include('pagination.providers_branch')
        </div>
    </div>
</div>
<form method="post" action="{{asset('/branch/create')}}">
    ...
    <input type="hidden" id="providersId" name="providersId" value="{{$providersId}}">
