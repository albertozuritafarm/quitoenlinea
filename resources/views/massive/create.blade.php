...
<script src="{{ assets('js/massive/create.js') }}"></script>
...
<div class="container" style="margin-top:15px; font-size:14px !important">
    ...
    <div class="col-md-8 col-md-offset-2 border" style="padding: 15px">
        ...
        <form action="{{ route('massive/store') }}" method="POST" enctype="multipart/form-data" id="uploadForm"  onsubmit="validateUploadExcel()">
            {{ csrf_field() }}
            ...
            <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        Click
                        <a href="{{asset('/massive/download/upload/format')}}" target="blank" title="Descargar Archivo Cargado"> 
                            AQUÍ
                        </a>
