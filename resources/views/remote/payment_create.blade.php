    ...
    <center>
        <div class="row">
            <div class="col-sm-8 col-sm-offset-4 border" style="margin-top:10px">
                ...
                <form action="{{ route('remotePaymentStore') }}" method="POST">
                    <div class="row">
                    ...
                    <div id="cashDiv" class="row" style="padding-left:5px !important;padding-right: 5px">
                        ...
                        <input type="hidden" name="chargeId" id="chargeId" value="{{$charge->id}}">
                        <div class="col-md-10 col-md-offset-1" style="margin-top:5px;padding-top:15px;padding-bottom:15px">
                            <a class="btn btn-default registerForm" align="left" href="{{ route('remote') }}" style="float:left"> Cancelar </a>
