...
<script src="{{ assets('js/massivesVinculation/create.js') }}"></script>
        ...
        <div class="col-md-12">
            <form name="salesForm" method="POST" action="/user" id="salesForm">
                            ...
                            <form class="row g-3 needs-validation" novalidate >
                                <div class="form-row">
                                   <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input autocomplete="off" type="text" class="form-control registerForm" name="document" id="document" value="{{$customer->document}}" @if($disabled) disabled="disabled" @else @endif placeholder="Cedula" required="required"tabindex="1" style="width:99%">
                                            <span class="input-group-btn">
                                                <button type="button" class="btn btn-info" onclick="documentBtn()" @if($disabled) disabled="disabled" @else @endif ><span class="glyphicon glyphicon-search"></span></button>
                                            </span>
                                        </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="first_name" id="first_name" placeholder="Primer Nombre" value="{{ $customer->first_name }}" required="required" required tabindex="3" disabled="disabled" maxlength="30">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="second_name" id="second_name" placeholder="Segundo Nombre" value="{{ $customer->second_name }}" required="required" required tabindex="4" disabled="disabled" maxlength="30"> 
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="mobile_phone" id="mobile_phone" placeholder="Celular" value="{{ $customer->mobile_phone }}" required tabindex="7"  maxlength="10">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" class="form-control registerForm" name="email" id="email" placeholder="Correo" value="{{ $customer->email }}" required tabindex="8" maxlength="100">
                ...
                <div class="col-md-12" style="padding-bottom:15px">
                                    <div class="row" style="float:left">
                                         <a class="btn btn-default registerForm" align="right" href="{{asset('/massivesVinculation')}}" tabindex="16"> Cancelar </a>
                                    </div>
                                    <div class="row" style="float:right">
