...
<script src="{{ assets('js/massivesVinculation/legalPerson/create.js') }}"></script>
        ...
        <div class="col-md-12">
            <form name="salesForm" method="POST" action="/user" id="salesForm">
                               ...
                               <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                 <button type="button" class="btn btn-info" onclick="documentCompanyBtn()" @if($disabled) disabled="disabled" @else @endif tabindex="2" ><span class="glyphicon glyphicon-search"></span></button>
                                            </span>
                                        </div>
                                ...
                                <div class="form-row">
                                   <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control registerForm" name="document" id="document" value="{{$customer->document}}" @if($disabled) disabled="disabled" @else @endif placeholder="Cédula del Representate Legal" required="required"tabindex="5" style="width:99%">                                           
                                            <span class="input-group-btn">
                                                <button id="documentBtnSearch" type="button" class="btn btn-info" onclick="documentBtn()" @if($disabled) disabled="disabled" @else @endif tabindex="5"><span class="glyphicon glyphicon-search" ></span></button>
                                             </span>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="document_id" name="document_id" class="form-control registerForm" value="{{old('document_id')}}" required tabindex="6" disabled="disabled">
                                            <option selected="true" value="0">--Escoja Una---</option>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="first_name" id="first_name" placeholder="Primer Nombre del Representate Legal" value="{{ $customer->first_name }}" required="required" required tabindex="7" disabled="disabled" maxlength="30">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="second_name" id="second_name" placeholder="Segundo Nombre del Representate Legal" value="{{ $customer->second_name }}" required="required" required tabindex="8" disabled="disabled" maxlength="30"> 
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="last_name" id="last_name" placeholder="Primer Apellido del Representante Legal" value="{{ $customer->last_name }}" required tabindex="9" disabled="disabled" maxlength="30">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="second_last_name" id="second_last_name" placeholder="Segundo Apellido del Representante Legal" value="{{ $customer->second_last_name }}" required tabindex="10" disabled="disabled" maxlength="30">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6" >
                                        ...
                                        <input type="email" class="form-control registerForm" name="email" id="email" placeholder="Correo" value="{{ $customer->email }}" required tabindex="12" maxlength="100">
                                ...
                                <div class="form-row" style="border-top:0 none;">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="branch" id="branch" class="form-control registerForm" required tabindex="13">
                                            <option selected="true" value="0">--Escoja Una---</option>
                                            @foreach($branch as $c)
                                                <option value="{{$c->ramodes}}">{{$c->ramodes}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="emissionType" id="emissionType" class="form-control registerForm" required tabindex="14">
                                            ...
                                            <option value="{{$emissionType->id}}">{{$emissionType->name}}</option>
                                            @endforeach
                                        </select>
                ...
                <div class="col-md-12" style="padding-bottom:15px">
                                    <div class="row" style="float:left">
                                         <a class="btn btn-default registerForm" align="right" href="{{asset('/massivesVinculation')}}" tabindex="17"> Cancelar </a>
                                    </div>
                                    <div class="row" style="float:right">
