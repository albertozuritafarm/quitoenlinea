                    ...
                    <div id="clientDiv" class="col-md-12" style="padding-top: 25px;">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="business_name" id="business_name" placeholder="Razón Social" required="required" tabindex="3" disabled="disabled" value="{{$company->business_name}}">
                            </div>
                            <div class="form-group">
                    ...
                    <div id="clientDiv" class="col-md-12" style="padding-top: 25px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control registerForm" name="document" id="document" placeholder="Cédula" required="required"tabindex="1" readonly="readonly" value="{{$legalRepresentative->document}}">                                    
                            </div>
                            <div class="form-group">
