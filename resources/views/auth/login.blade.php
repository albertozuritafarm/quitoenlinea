...
<form method="POST" action="{{ route('login') }}">
    ...
    <div align="center" style="margin-bottom:60px">
        <img src="{{asset('images/logo_seguros_sucre_2.png')}}" class="img-responsive" width="70%">
    </div>
    <div class="content">
        <div>
                     @if (session('errorMsg'))
            ...
            <div class="form-group" align="left">
                ...
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('errorMsg') }}</strong>
                </span>
                @endif
            </div>
...
<!--            <div class="form-group" align="left">
                ...
                <input id="company" type="company" class="form-control{{ $errors->has('company') ? ' is-invalid' : '' }}" name="company" placeholder="Ingrese la empresa" required>
    ...
    <div>
        <div class="legend" style="margin-top:20px">
            ...
            <a href="{{ asset('/login/recover') }}">¿Olvido su Contraseña?</a><br><br>
