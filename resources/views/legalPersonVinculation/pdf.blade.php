<html>
    ...
    <body>
        ...
        <header>
            <img src="{{public_path('images/logo_seguros_sucre_2.png')}}" alt="" style="width:16%;height:42%; margin-left: 35%;"/>
        ...
        <main>
            ...
            <div class="col-md-12" style="padding-top: -10px;">
                ...
                <h3 class="title" style="float:right; font-size:10px;">FECHA: {{$viamaticaDate}}</h3>
            </div>
            <br>
            <br>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td colspan="7" style="text-align:left;" class="underlineCell">{{$company->business_name}}</td>
                            <td colspan="2" style="text-align:right;">RUC:</td>
                            <td colspan="8" style="text-align:left;" class="underlineCell">{{$company->document}}</td>
                        </tr>
                        <tr>
                            <td colspan="2">Actividad económica:</td>                            
                            <td colspan="7" class="underlineCell" style="text-align:left;">{{$ecoActivity->name}}</td>
                            <td colspan="2" style="text-align:right;">Fecha de Constitución:</td>
                            <td colspan="8" class="underlineCell" style="text-align:left;">{{$company->constitution_date}}</td>
                        </tr>
                        <tr>
                            <td colspan="2">Dirección/ Calle Principal:</td>
                            <td colspan="18" class="underlineCell" style="text-align:left;">{{$vinculation->main_road}} </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="underlineCell" style="text-align:left;">{{$company->parroquia}}</td>
                        ...
                        <tr>
                            ...
                            <td colspan="4"  class="underlineCell" style="text-align:left;">{{$company->phone}}</td>
                            <td colspan="1" style="text-align:right;">Celular:</td>
                            <td colspan="3" class="underlineCell" style="text-align:left;">{{$company->mobile_phone}}</td>
                            <td colspan="1" style="text-align:right;">Email:</td>
                            <td colspan="8" class="underlineCell" style="text-align:left;">{{$company->email}}</td>
                        </tr>
                    </table>
                </div>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td colspan="7" style="text-align:left;" class="underlineCell">{{$legalRepresentative->first_name}} {{$legalRepresentative->second_name}}</td>
                            <td colspan="2" style="text-align:right;">Apellidos Completos:</td>
                            <td colspan="8" style="text-align:left;" class="underlineCell">{{$legalRepresentative->last_name}} {{$legalRepresentative->second_last_name}}</td>
                        </tr>
                        <tr>
                            <td colspan="3">Cédula Identidad:<input type="checkbox" style="margin-top:5px;margin-left:5px;" @if($legalRepresentative->document_id == 1) checked="checked" @endif > </td>
                            <td colspan="2"> Pasaporte:<input type="checkbox" style="margin-top:5px;" @if($legalRepresentative->document_id == 2) checked="checked" @endif ></td>
                            <td colspan="2"> Ruc:<input type="checkbox"  style="margin-top:5px;"> </td>
                            <td colspan="1" style="text-align:right;">Nro:</td>
                            <td colspan="2" class="underlineCell" style="text-align:left;">{{$legalRepresentative->document}}</td>
                            <td colspan="1" style="text-align:right;">Nacionalidad:</td>
                            <td colspan="8" class="underlineCell" style="text-align:left;">{{$birthCountry->name}}</td>
                        </tr>
                        <tr>
                            <td colspan="2">Lugar y fecha de <br>nacimiento:</td>
                            <td colspan="17" class="underlineCell" style="text-align:left;">{{$birthCity->name}} {{$vinculation->birth_date}}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3">Unión de Hecho  <input type="checkbox" style="margin-top:5px;" @if($vinculation->civil_state == 5) checked="checked" @endif ></td>
                        ...
                        <tr>
                            <td colspan="2">Dirección/ Calle Principal:</td>
                            <td colspan="18" class="underlineCell" style="text-align:left;">{{$legalRepresentative->address}} </td>
                        </tr>
                        <tr>
                            <td colspan="2">País:</td>
                            <td colspan="2" class="underlineCell" style="text-align:left;"><span > {{$legalRepresentativeCountry->name}}</span> </td>
                            <td colspan="2" style="text-align:right;">Provincia: </td>
                            <td colspan="2" class="underlineCell" style="text-align:left;">{{$legalRepresentativeProvince->name}}</td>
                            <td colspan="1" style="text-align:right;">Cantón: </td>
                            <td colspan="2" class="underlineCell" style="text-align:left;">{{$legalRepresentativeCity->name}}</td>
                            <td colspan="1" style="text-align:right;">Parroquia: </td>
                            <td colspan="2" class="underlineCell" style="text-align:left;">{{$legalRepresentative->parroquia}}</td>
                            <td colspan="1" style="text-align:right;">Sector: </td>
                            <td colspan="4" class="underlineCell" style="text-align:left;">{{$legalRepresentative->sector}}</td>
                        </tr>
                        <tr>
                            <td colspan="2">Teléfono:</td>
                            <td colspan="4"  class="underlineCell" style="text-align:left;">{{$legalRepresentative->phone}}</td>
                            <td colspan="1" style="text-align:right;">Celular:</td>
                            <td colspan="3" class="underlineCell" style="text-align:left;">{{$legalRepresentative->mobile_phone}}</td>
                            <td colspan="1" style="text-align:right;">Email:</td>
                            <td colspan="8" class="underlineCell" style="text-align:left;">{{$legalRepresentative->email}}</td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="divData" style="width:100%;">
                <div>
                    <table>
                        ...
                        <tr>
                            <td colspan="2">Cédula de Identidad: <input type="checkbox" style="margin-top:5px;" @if($vinculation->spouse_document_id == 1) checked="checked" @endif> </td>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td style="width:75%"colspan="3" class="underlineCell" style="text-align:left;">{{$vinculation->annual_income}}</td>
                        </tr>
                    </table>
                </div>
            </div>
           ...
           <div class="divData" style="width:100%;">
                <div>
                    <table>
                        ...
                        <tr>
                            <td style="width:50%">Cédula Identidad:<input type="checkbox" style="margin-top:5px" @if($vinculation->benefitiary_document_id == 1) checked="checked" @endif> Pasaporte:<input type="checkbox" style="margin-top:5px" @if($vinculation->benefitiary_document_id == 3) checked="checked" @endif> Ruc:<input type="checkbox" style="margin-top:5px" @if($vinculation->benefitiary_document_id == 2) checked="checked" @endif> Nro: <span class="underline">{{$vinculation->benefitiary_document}}</span></td>
                            
                            <td style="width:50%">Nacionalidad: <span class="underline">N/A</span></td>
                        </tr>
                        <tr>
                            <td style="width:50%">Dirección de domicilio: <span class="underline">{{$vinculation->benefitiary_address}}</span></td>
                            <td style="width:50%">Teléfono: <span class="underline">{{$vinculation->benefitiary_phone}}</span></td>
                        </tr>
                        <tr>
                            <td colspan="2">Relación: <span class="underline">{{$vinculation->benefitiary_relationship}}</span></td>
                        </tr>
                        <tr>
            ...
            <div class="divData" style="width:100%;text-align:justify !important">
                <div>
                    ...
                    <br>
                    <span style="text-align:justify !important">
                        Declaración sobre la condición de Persona Expuesta Políticamente PEP (Persona que desempeña o ha desempeñado funciones públicas en el país o en el exterior). Informo que he leído la Lista Mínima de Cargos Públicos a ser considerados "Personas Expuestas Políticamente" y declaro bajo juramento que SI</span>@if($vinculation->person_exposed =='yes') __<span class="underline">X</span>__ @else _____ @endif <span text-align="justifty"> NO </span>@if($vinculation->person_exposed !='yes') __<span class="underline">X</span>__ @else _____ @endif <span text-align="justifty"> me encuentro ejerciendo uno de los cargos incluidos en la lista o lo ejercí hace un año atrás. En el caso de que la respuesta sea positiva, indicar: Cargo/Función/Jerarquía:
                    </span>
           ...
           <div class="divData" style="width:100%;text-align:justify !important">
                <div>
                    ...
                    <br>
                    <span style="margin-left: 40%">
                        C.I: {{$legalRepresentative->document}}
                    </span>
                </div>
            </div>
            ...
            <br><br><br><br>
            <div class="divData" style="width:100%;text-align:justify !important">
             @if($broker->channelId!=19)
                <div>
                    <span style="text-align:justify">
                        Comunico que mi Corredor o Bróker es ________________________<span class="underline">{{$broker->agentedes}}</span>_______________________________________ para el manejo y administración de las pólizas adquiridas en Seguros Sucre S.A., emitidas a nombre de mí representada.
                    </span>
                    <br>
                    <br>
                    <span style="text-decoration: underline; font-style: italic; margin-left: 40%">
            ...
            <div class="divData" style="width:100%;text-align:justify !important">
              @if($broker->channelId!=19)
                <div>
                    <span style="text-align:justify">
                        Nombres Completos o razón social: ______________________________<span class="underline">{{$broker->agentedes}}</span>_________________________________________________
                        Nombres Completos y cargo del ejecutivo encargado: ____________<span class="underline">{{$broker->ejecutivo_ss}} - {{$broker->puntodeventades}}</span>____________
            ...
            <div class="divData" style="width:100%;text-align:justify !important">
                <div>
                    <span style="text-align:justify">
                        ...
                        Nueva __<span class="underline">X</span>__    Renovación ____ Ramo: _____<span class="underline">{{$broker->ramodes}}</span>_____________ Suma Asegurada: _______<span class="underline">{{$broker->insured_value}}</span>________ Canal de Vinculación: ____<span class="underline">{{$broker->canal}}</span>_______ 
                    </span>
                    <br>
                    <span class="title">
                    ...
                    <br>
                    <span>
                        Nombres Completos: ________________<span class="underline">@if($broker->channelId!=19){{$broker->ejecutivo}}@else{{$broker->ejecutivo_ss}}@endif</span>__________________________________ Confirmo que he revisado la razonabilidad de la información proporcionada por el cliente o contratante y declaro que he verificado la documentación e información solicitada de acuerdo a lo establecido en la política "Conozca su Cliente" y he analizado la información respecto a la actividad económica e ingresos, los cuales concuerdan con los productos solicitados.
                    </span>
                    <br>
                    <br>
                    <br>
