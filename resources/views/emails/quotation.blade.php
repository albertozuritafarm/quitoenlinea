                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="component title-component" i18n="MODULES-TXT_HEAD_TITLE" id="4" style="width:100%">
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 5px 0px 5px 14px; margin:60px 0px 20px 0px; font-size: 1.5em; font-weight: bold; display: inherit; color: rgb(96, 96, 96); text-align: center;"> <img src="{{$message->embed(public_path('images/Email/email_header.png'))}}" width="100%" alt="Girl in a jacket"> </td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                ...
                <tr>
                    <td class="container-column ui-droppable" style="width:100%;max-width:600px;vertical-align:top">
                        <table border="0" cellpadding="0" cellspacing="0" class="component text-component" i18n="MODULES-TXT_BEGIN_AND_CUSTUMIZE" id="7" style="width:100%">
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 5px 0px 5px 14px; margin:60px 0px 20px 0px; font-size: 1.5em; font-weight: bold; display: inherit; color: rgb(96, 96, 96); text-align: left;"> <img src=" {{$message->embed(public_path('images/Email/logo_vehiculo.png'))}}" width="20%" alt="Girl in a jacket"> </td>
                                    ...
                                    <td style="padding: 5px 10px 80px 14px; display: inherit; color: rgb(96, 96, 96); text-align: left;">
                                        <p style="margin: 0px;">Estimado <span style="font-weight: bold">{{$customer[0]->Cliente}}</span></p>
                                        
                                        <p style="margin: 0px;">En el siguiente correo ponemos en tu conocimiento la cotización para tu póliza de <span style="font-weight: bold">{{$customer[0]->ramo}}</span> generada el día <span style="font-weight: bold">{{$customer[0]->date}}</span> con Seguros Sucre</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
