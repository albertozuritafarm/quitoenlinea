                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="component title-component" i18n="MODULES-TXT_HEAD_TITLE" id="4" style="width:100%">
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 5px 0px 5px 14px; margin:60px 0px 0px 0px; font-size: 1.5em; font-weight: bold; display: inherit; color: rgb(96, 96, 96); text-align: center;"> <img src="{{$message->embed(public_path('images/Email/Mail_Inspeccion.png'))}}" width="100%" alt="Inspección"> </td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                            ...
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
									<td style="padding: 30px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: justify;">
                                        ...
                                        <p style="margin: 10px 0 0 0;"><span style="font-weight: bold">{{$customer[0]->channel_name}} </span>ha solicitado que se realice el proceso de inspección número <span style="font-weight: bold"> {{$inspectionId}} </span>para el cliente  <span style="font-weight: bold"> {{$customer[0]->Cliente}} </span>con número de identificación <span style="font-weight: bold">{{$customer[0]->cusDocument}}</span>, con los siguientes datos: </p>
                                    </td>
                                </tr>
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 30px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: justify;">
                                        <ul>
                                            <li><span style="font-weight: bold">Dirección del Bien: </span>{{$propertie[0]->adress}}</li>
                                            <li><span style="font-weight: bold">Teléfono Celular: </span>{{$customer[0]->mobile}}</li>
                                            <li><span style="font-weight: bold">Teléfono Fijo: </span>{{$customer[0]->phone}}</li>
                                        </ul>
                                    </td>
                                </tr>
                            </tbody>
