...
$(document).ready(function() {
    ...
    document.getElementById("representante_apellidos").disabled = false;
    document.getElementById("representante_nombres").disabled = false;
    document.getElementById("economic_activity").disabled = false;
    ...
    $("#document_id").change(function() { var document_id = document.getElementById("document_id"); var documentForm = document.getElementById("documentForm");
        documentForm.value = '';
        removeInputRedFocus("documentForm"); if (document_id.value == 3) { $('#documentForm').prop('disabled', true);
            fadeIn('passportFullDiv'); } else { $('#documentForm').prop('disabled', false);
            fadeOut('passportFullDiv'); } });
    ...
    $("#birth_city").change(function() { var birth_city = document.getElementById("birth_city"); var birth_place = document.getElementById("birth_place");
        birth_place.value = birth_city.value; });
...
function validateFirstStep() {
    ...
    if (fecha_constitucion.value === '') { $(fecha_constitucion).addClass('inputRedFocus');
        errorFound = true; }
    ...
    if (ruc.value === '') { $(ruc).addClass('inputRedFocus');
        errorFound = true; }
    ...
    var actividad_economica = document.getElementById("economic_activity");
    if (economic_activity.value === '') { $(economic_activity).addClass('inputRedFocus');
        errorFound = true; }
    ...
    if (country.value === '') { $(country).addClass('inputRedFocus');
        errorFound = true; }
    var canton = document.getElementById("canton");
    if (canton.value === '') { $(canton).addClass('inputRedFocus');
        errorFound = true; }
    var parroquia = document.getElementById("parroquia");
    if (parroquia.value === '') { $(parroquia).addClass('inputRedFocus');
        errorFound = true; }
    var phones = document.getElementById("phones");
    if (phones.value === '') { $(phones).addClass('inputRedFocus');
        errorFound = true; }
    var email = document.getElementById("email");
    if (email.value === '') { $(email).addClass('inputRedFocus');
        errorFound = true; }
    //var birth_date = document.getElementById("birth_date"); if (birth_date.value === '') { $(birth_date).addClass('inputRedFocus'); errorFound = true; }
    //var birth_city = document.getElementById("birth_city"); if (birth_city.value === '') { $(birth_city).addClass('inputRedFocus'); errorFound = true; }
    var numero_calle = document.getElementById("numero_calle");
    if (numero_calle.value === '') { $(numero_calle).addClass('inputRedFocus');
        errorFound = true; }
    var sector = document.getElementById("sector");
    if (sector.value === '') { $(sector).addClass('inputRedFocus');
        errorFound = true; }
    var calle_principal = document.getElementById("calle_principal");
    if (calle_principal.value === '') { $(calle_principal).addClass('inputRedFocus');
        errorFound = true; }
    var calle_transversal = document.getElementById("calle_transversal");
    if (calle_transversal.value === '') { $(calle_transversal).addClass('inputRedFocus');
        errorFound = true; }

    var province = document.getElementById("province");
    if (province.value === '') { $(province).addClass('inputRedFocus');
        errorFound = true; }
    ...
    if (celular.value === '') { $(celular).addClass('inputRedFocus');
        errorFound = true; }
    //var fax = document.getElementById("fax"); if (fax.value === '') { $(fax).addClass('inputRedFocus');  errorFound = true;  }

    // Representante Legal
    var representante_apellidos = document.getElementById("representante_apellidos");
    if (representante_apellidos.value === '') { $(representante_apellidos).addClass('inputRedFocus');
        errorFound = true; }
    var representante_nombres = document.getElementById("representante_nombres");
    if (representante_nombres.value === '') { $(representante_nombres).addClass('inputRedFocus');
        errorFound = true; }
    var representante_fecha_nacimiento = document.getElementById("representante_fecha_nacimiento");
    if (representante_fecha_nacimiento.value === '') { $(representante_fecha_nacimiento).addClass('inputRedFocus');
        errorFound = true; }
    var representante_lugar_nacimiento = document.getElementById("representante_lugar_nacimiento");
    if (representante_lugar_nacimiento.value === '') { $(representante_lugar_nacimiento).addClass('inputRedFocus');
        errorFound = true; }
    var representante_cedula_pasaporte = document.getElementById("representante_cedula_pasaporte");
    if (representante_cedula_pasaporte.value === '') { $(representante_cedula_pasaporte).addClass('inputRedFocus');
        errorFound = true; }
    var representante_nacionalidad = document.getElementById("representante_nacionalidad");
    if (representante_nacionalidad.value === '') { $(representante_nacionalidad).addClass('inputRedFocus');
        errorFound = true; }
    ...
    var representante_pais = document.getElementById("representante_pais");
    if (representante_pais.value === '') { $(representante_pais).addClass('inputRedFocus');
        errorFound = true; }
    var representante_provincia = document.getElementById("representante_provincia");
    if (representante_provincia.value === '') { $(representante_provincia).addClass('inputRedFocus');
        errorFound = true; }
    var representante_parroquia = document.getElementById("representante_parroquia");
    if (representante_parroquia.value === '') { $(representante_parroquia).addClass('inputRedFocus');
        errorFound = true; }
    var representante_canton = document.getElementById("representante_canton");
    if (representante_canton.value === '') { $(representante_canton).addClass('inputRedFocus');
        errorFound = true; }
    var representante_calle_principal = document.getElementById("representante_calle_principal");
    if (representante_calle_principal.value === '') { $(representante_calle_principal).addClass('inputRedFocus');
        errorFound = true; }
    var representante_numero_calle = document.getElementById("representante_numero_calle");
    if (representante_numero_calle.value === '') { $(representante_numero_calle).addClass('inputRedFocus');
        errorFound = true; }
    ...
    var representante_sector = document.getElementById("representante_sector");
    if (representante_sector.value === '') { $(representante_sector).addClass('inputRedFocus');
        errorFound = true; }
    ...
    var representante_email = document.getElementById("representante_email");
    if (representante_email.value === '') { $(representante_email).addClass('inputRedFocus');
        errorFound = true; }
    var representante_telefono = document.getElementById("representante_telefono");
    if (representante_telefono.value === '') { $(representante_telefono).addClass('inputRedFocus');
        errorFound = true; }
    var representante_celular = document.getElementById("representante_celular");
    if (representante_celular.value === '') { $(representante_celular).addClass('inputRedFocus');
        errorFound = true; }
    ...
    */
    ...
    if (errorFound === false) {
        ...
        var url = ROUTE + "/vinculation/pj/tercerosPerson/store";
...
function validateSecondStep() {
    ...
    // var ingresos_brutos_terceros = document.getElementById("ingresos_brutos_terceros"); if (ingresos_brutos_terceros.value === '') { $(ingresos_brutos_terceros).addClass('inputRedFocus');  errorFound = true;  }
...
function validateThirdStep() {
    ...
    var errorFound = false;
    var optRadio3 = null;
    //var firma_representante = document.getElementById("firma_representante"); if (firma_representante.value === '') { $(firma_representante).addClass('inputRedFocus');  errorFound = true;  }

    var radios = document.getElementsByName('optradio3');
    for (var i = 0, length = radios.length; i < length; i++) { if (radios[i].checked) { var optRadio3 = radios[i].value; break; } }
    var pep_client = document.getElementById("pep_client");
    if (optRadio3 == 'yes') { if (pep_client.value == '') { $(pep_client).addClass('inputRedFocus');
            errorFound = true; } }

    if (errorFound == false) {

        alert('no errors');
        var fourth_step = document.getElementById("fourthStep");
        $(fourth_step).removeClass('hidden');
        var third_step = document.getElementById("thirdStep");
        $(third_step).addClass('hidden');
        var active_wizard = document.getElementById('thirdStepWizard');
        $(active_wizard).removeClass('wizard_activo registerForm');
        $(active_wizard).addClass('wizard_inactivo registerForm');
        active_wizard = document.getElementById('fourthStepWizard');
        $(active_wizard).removeClass('wizard_inactivo registerForm');
        $(active_wizard).addClass('wizard_activo registerForm');
        //Store Data
...
function validateFourthStep() {
    ...
    if (uploadedFileDocumentSpouse.value == '' && (civilState.value == 2 || civilState.value == 5)) {
        ...
        $(messageDocumentSpouse).addClass('alert alert-danger');
        var errorFound = true;
    }
...
function uploadPictureForm(id) {
    event.preventDefault();
    var fi = document.getElementById('select_file' + id);
    if (fi.files.length > 0) { for (var i = 0; i <= fi.files.length - 1; i++) { var fsize = fi.files.item(i).size; var file = Math.round((fsize / 1024)); if (file >= 2096) { alert("El archivo debe pesar menos de 2mb."); return false; } } }
...
function validateCheckBox() {
    if (!document.firstStepForm.divorciado.checked) { alert('You must select divorciado.'); }

    if (!document.firstStepForm.casado.checked) { alert('You must select casado.'); }
