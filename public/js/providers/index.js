...
$(document).ready(function () {
    ...
    function fetch_data(page)
    {
        ...
        $.ajax({
            ...
            url: ROUTE + "/providers/fetch_data?page=" + page,
            beforeSend: function () {
                // Show Loader
...
function providersResume(id) {
    var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
    $.ajax({
        type: "POST",
        data: {_token: CSRF_TOKEN, id: id},
        url: ROUTE + "/providers/resume",
        success: function (data)
        {
...
function addBranchIndividual(id){
    console.log(id);
    document.getElementById("providersId").value = id;
    document.getElementById("branchBtn").click();
}