<script src="<?php echo e(assets('js/sales/R2/insured.js')); ?>"></script>
<style>
    .form-group{
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-inline">
                                ...
                                <div class="form-inline">
                                    <input autocomplete="off" type="text" class="form-control registerForm" name="document_insured" id="document_insured" value="<?php echo e($customer->document); ?>" placeholder="Cédula" required="required"tabindex="1" style="width:89%">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="first_name_insured" id="first_name_insured" placeholder="Nombre" value="<?php echo e($customer->first_name); ?>" required="required" tabindex="3" disabled="disabled">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="mobile_phone_insured" id="mobile_phone_insured" placeholder="Nombre" value="<?php echo e($customer->mobile_phone); ?>" required tabindex="5">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="address_insured" id="address_insured" placeholder="Nombre" required tabindex="7" value="<?php echo e($customer->address); ?>">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="country_insured" id="country_insured" class="form-control registerForm" required tabindex="9">
                                    ...
                                    <option <?php if($cou->id == $cusCountry->id): ?> selected="true" <?php else: ?> <?php endif; ?> value="<?php echo e($cou->id); ?>"><?php echo e($cou->name); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="city_insured" class="form-control registerForm" id="city_insured" required tabindex="11">
                                    <option selected="true" value="<?php echo e($cusCity->id); ?>"><?php echo e($cusCity->name); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="document_id_insured" name="document_id_insured" class="form-control registerForm" value="<?php echo e(old('document_id')); ?>" required tabindex="2" disabled="disabled">
                                    <option selected="true" value="">--Escoja Una---</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="last_name_insured" id="last_name_insured" placeholder="Apellido" value="<?php echo e($customer->last_name); ?>" required tabindex="4" disabled="disabled">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="phone_insured" id="phone_insured" placeholder="Cédula" value="<?php echo e($customer->phone); ?>" required tabindex="6">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control registerForm" name="email_insured" id="email_insured" placeholder="Correo" value="<?php echo e($customer->email); ?>" required tabindex="8">
                            ...
                            <div class="form-group">
                                ...
                                <select name="province_insured" class="form-control registerForm" id="province_insured" required tabindex="10">
                                    <option selected="true" value="<?php echo e($cusProvince->id); ?>"><?php echo e($cusProvince->name); ?></option>
                                </select>
                            </div>
                        </div>
                    </form>
...
<!-- Previous Step Form -->
<form action="<?php echo e(asset('/sales/create/life')); ?>" method="post" class="hidden">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="customerId" value="<?php echo e($customerId); ?>">
    <input type="hidden" name="insuredId" value="<?php echo e($insuredId); ?>">
    <input type="submit" value="Submit" id="previousStepBtn">
</form> <?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\R2\insured.blade.php ENDPATH**/ ?>