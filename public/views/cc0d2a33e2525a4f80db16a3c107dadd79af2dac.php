<html>
    ...
    <body>
        ...
        <header>
            ...
            <center><strong class="bold" style="color:#183c6b;font-size: 14px;">N° COT-<?php echo e($customer[0]->ramo); ?>-<?php echo e($customer[0]->year); ?>-<?php echo e($id); ?></strong></center>
        </header>
        ...
        <main>
                ...
                <div style="padding-left: 10px;">
                    <table>
                        <tr>
                            ...
                            <td style="width:25%" class="divData"><?php echo e($customer[0]->date); ?></td>
                        </tr>
                        <tr>
                            <th colspan="4" style="width:50%;background-color:#003B71; text-align:left; border-top: 0px; border-bottom: 0px; border-left: 2px solid #CF3339; color:white; padding:0 0 0 5px"><span class="bold title">DATOS DEL ASEGURADO</span></th>
                        </tr>
                        <tr class="divData borderLeftRight">
                            <th style="width:20%; border-left: 1px solid #2D2A26; padding-left: 5px">Tipo de Documento</th>
                            <td style="width:30%"><?php echo e($customer[0]->typeDocDes); ?></td>
                            <th style="width:25%">Numero Doc</th>
                            <td style="width:25%; border-right: 1px solid #2D2A26"><?php echo e($customer[0]->cusDocument); ?></td>
                        </tr>
                        <tr class='borderLeftRight'>
                            <th style="width:20%; border-left: 1px solid #2D2A26; padding-left: 5px">Nombres</th>
                            <td style="width:30%"><?php echo e($customer[0]->names); ?></td>
                            <th style="width:25%">Apellidos</th>
                            <td style="width:25%; border-right: 1px solid #2D2A26"><?php echo e($customer[0]->lastNames); ?></td>
                        </tr>
                        <tr class="divData borderLeftRight">
                            <th style="width:20%; border-left: 1px solid #2D2A26; padding-left: 5px">Fch. Nacimiento</th>
                            <td style="width:30%"><?php echo e($customer[0]->cusBirthdate); ?></td>
                            <th style="width:25%">Ciudad</th>
                            <td style="width:25%; border-right: 1px solid #2D2A26"><?php echo e($customer[0]->city); ?></td>
                        </tr>
                        <tr class='borderLeftRight'>
                            <th style="width:20%; border-left: 1px solid #2D2A26; padding-left: 5px">Tlf. Convencional</th>
                            <td style="width:30%"><?php echo e($customer[0]->phone); ?></td>
                            <th style="width:25%">Tlf. Celular</th>
                            <td style="width:25%; border-right: 1px solid #2D2A26"><?php echo e($customer[0]->mobile); ?></td>
                        </tr>
                        <tr class="divData borderLeftRight">
                            <th style="width:20%; border-left: 1px solid #2D2A26; padding-left: 5px">Correo Electronico</th>
                            <td style="width:30%"><?php echo e($customer[0]->email); ?></td>
                            <td style="width:25%"></td>
            ...
            <div class="" style="width:100%;">
                <div style="padding-left: 10px;">
                    <table class="vehiTable" style="border: 1px solid #2D2A26">
                        <tr>
                            <th colspan="7" style="width:50%;background-color:#003B71; text-align:left; border-top: 0px; border-bottom: 0px; border-left: 2px solid #CF3339; color:white; padding:0 0 0 5px"><span class="bold title">DATOS DE LOS VEHÍCULOS</span></th>
                        </tr>
                    <!--</table>-->
                    <!--<table style="width:100%; border: 1px solid #2D2A26;margin-top:-1px">-->
                    <tr>
                        <th style="background-color: #183c6b; color: white; text-align: center;  border-radius: 5px 0 0 0;">Placa</th>
                        <th style="background-color: #183c6b; color: white; text-align: center;">Marca</th>
                        <th style="background-color: #183c6b; color: white; text-align: center;">Modelo</th>
                        <th style="background-color: #183c6b; color: white; text-align: center;">Año</th>
                        <th style="background-color: #183c6b; color: white; text-align: center;">Suma Aseg. Ref.</th>
                        <th style="background-color: #183c6b; color: white; text-align: center;">Suma Aseg.</th>
                        <th style="background-color: #183c6b; color: white; text-align: center; border-radius: 0 5px 0 0;">Valor de Extras</th>
                    </tr>
                    <?php $__currentLoopData = $car; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td style="text-align: center;"><?php echo e($car->plate); ?></td>
                            <td style="text-align: center;"><?php echo e($car->brand); ?></td>
                            <td style="text-align: center;"><?php echo e($car->model); ?></td>
                            <td style="text-align: center;"><?php echo e($car->year); ?></td>
                            <td style="text-align: center;"><?php echo e($car->refValue); ?></td>
                            <td style="text-align: center;"><?php echo e(asCurrency($car->ins_value)); ?></td>
                            <td style="text-align: center;"><?php echo e(asCurrency($car->acc_value)); ?></td>
                        </tr>
            ...
            <div class="" style="width:100%;">
                <div style="padding-left: 10px;">
                    <table style="border: 1px solid #2D2A26">
                         <tr>
                            <th colspan="4" style="width:50%;background-color:#003B71; text-align:left; border-top: 0px; border-bottom: 0px; border-left: 2px solid #CF3339; color:white; padding:0 0 0 5px"><span class="bold title">VALOR DE LA PRIMA</span></th>
                        </tr>
                        <tr class="divData">
                            <th style="width:25%; padding-left: 5px">Prima Neta</th>
                            <td style="width:25%"><?php echo e($sales->prima_total); ?></td>
                            <th style="width:25%">Contribucion SCVS</th>
                            <td style="width:25%"><?php echo e($sales->super_bancos); ?></td>
                        </tr>
                        <tr>
                            <th style="width:25%; padding-left: 5px">Seguro Campesino</th>
                            <td style="width:25%"><?php echo e($sales->seguro_campesino); ?></td>
                            <th style="width:25%">Derecho de Emision</th>
                            <td style="width:25%"><?php echo e($sales->derecho_emision); ?></td>
                        </tr>
                        <tr class="divData">
                            <th style="width:25%; padding-left: 5px">Iva 12%</th>
                            <td style="width:25%"><?php echo e($sales->tax); ?></td>
                            <th style="width:25%">Prima Total</th>
                            <td style="width:25%"><?php echo e($sales->total); ?></td>
                        </tr>
                    </table>
                    <hr>
                </div>
            ...
            <div>
                <hr>
                    <div style="width:100%;background-color: white;color:#183c6b;font-size:14px;font-weight: bold;line-height: 20px; height:25px;">
                        <span><center><h1><?php echo e($customer[0]->proName); ?></h1></center></span>
                    </div>
                <hr>
            </div>
            <!-- COBERTURAS -->
            <div>
                    <!--<div style="padding-left: 10px;">-->
                            ...
                            <?php echo getCoverageDetails(1, $customer[0]->idProduct); ?>
...
<?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\R1\pdf_quotation.blade.php ENDPATH**/ ?>