...
<script src="<?php echo e(assets('js/vinculation/pn/v2.js')); ?>"></script>
                        ...
                        <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="mobile_phone" name="mobile_phone" class="form-control registerForm" required tabindex="19" placeholder="Teléfono Celular" onchange="removeInputRedFocus(this.id)" value="<?php echo e($mobile_phone); ?>" <?php echo e($disable_status); ?>>
                                </div>
                                <div class="form-group col-md-6">
                        ...
                        <div class="">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label class="registerForm" for="is_beneficiary"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> ¿Es usted el beneficiario de la póliza?</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span><br>
                        ...
                        <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="total_assets" name="total_assets" class="form-control registerForm" required tabindex="7" placeholder="Total Activos USD" onchange="removeInputRedFocus(this.id)" value="<?php echo e($total_assets); ?>" <?php echo e($disable_status); ?> maxlength="15">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="total_passives" name="total_passives" class="form-control registerForm" required tabindex="9" placeholder="Total de Pasivos USD" onchange="removeInputRedFocus(this.id)" value="<?php echo e($total_pasives); ?>" <?php echo e($disable_status); ?> maxlength="15">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text2" id="total_assets_pasives" name="total_assets_pasives" class="form-control registerForm" required tabindex="19" placeholder="Total Patrimonio (A-P)" onchange="removeInputRedFocus(this.id)" value="<?php echo e($total_assets_pasives); ?>" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                </div>
                            </div>
                ...
                <div id="picturesDiv" class="col-md-12" style="margin-top:15px;">
                    <div class="col-md-6" style="margin: 5px 0;">
                        <form class="col-md-12 border" method="post" id="upload_formDocumentApplicant" name="upload_formDocumentApplicant" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formDocumentApplicant'" style="min-height:350px !important">
                            ...
                            <div class="form-group">
                                <label class="registerForm"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de Caducidad</label>
                            ...
                            <center>
                                <div style="padding: 0" class="inside" id="fileNameDocumentApplicant"></div>
                    ...
                    <div class="col-md-6" id="formDocumentSpouse" style="margin: 5px 0;">
                        <form class="col-md-12 border" method="post" id="upload_formDocumentSpouse" name="upload_formDocumentSpouse" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formDocumentSpouse'" style="min-height:350px !important">
                            ...
                            <center>
                                <div style="padding: 0" class="inside" id="fileNameDocumentSpouse"></div>
                            ...
                            <div style="text-align: center; magin-bottom: 5px;">
                    ...
                    <div class="col-md-6" style="margin: 5px 0;">
                        <form class="col-md-12 border" method="post" id="upload_formService" name="upload_formService" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formService'" style="min-height:350px !important">
                            ...
                            <div class="form-group" style="padding-top:85px;text-align: center;">
                                ...
                                <div style="padding: 0" class="inside" id="fileNameService"></div>
                    ...
                    <div class="col-md-6" style="margin: 5px 0;">
                        <form class="col-md-12 border" method="post" id="upload_formSri" name="upload_formSri" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formSri'" style="min-height:350px !important">
                            ...
                            <input type="hidden" id="uploadedFileSri" name="uploadedFileSri" value="<?php echo e($picture_sri); ?>">
                                ...
                                <div style="padding: 0" class="inside" id="fileNameSri"></div>
...
<?php echo $__env->make('layouts.remote_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\vinculation\pn\v2.blade.php ENDPATH**/ ?>