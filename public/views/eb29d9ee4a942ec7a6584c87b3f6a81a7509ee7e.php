                            ...
                            <form class="row g-3 needs-validation" novalidate >
                                <div class="form-row">
                                   <div class="form-group col-md-6">
                                        <span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span><label class="registerForm" for="document"> Cedula</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                        ...
                                        <div class="form-inline">
                                            <input autocomplete="off" type="text" class="form-control registerForm" name="document" id="document" value="<?php echo e($customer->document); ?>" <?php if($disabled): ?> disabled="disabled" <?php else: ?> <?php endif; ?> placeholder="Cedula" required="required"tabindex="1" style="width:89%">
                                            ...
                                            <lavel id="document_validation" class="hidden"style="color:#F31212;font-size: 12px;">Debe ingresar la Cedula</lavel>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <lavel id="document_id_validation" class="hidden"style="color:#F31212;font-size: 12px;">Debe ingresar un tipo de documento</lavel>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <lavel id="first_name_validation" class="hidden"style="color:#F31212;font-size: 12px;">Debe ingresar el Primer Nombre</lavel>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <lavel id="second_name_validation" class="hidden"style="color:#FFFFFF;font-size: 12px;">Segundo Nombre</lavel>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <lavel id="last_name_validation" class="hidden"style="color:#F31212;font-size: 12px;">Debe ingresar el Primer Apellido</lavel>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <lavel id="second_last_name_validation" class="hidden"style="color:#F31212;font-size: 12px;">Debe ingresar el Segundo Apellido</lavel>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="mobile_phone" id="mobile_phone" placeholder="Celular" value="<?php echo e($customer->mobile_phone); ?>" required tabindex="7" onchange="removeIsInvalid(this.id)" onkeyup="onlyNumber(this)">
                                        <lavel id="mobile_phone_validation" class="hidden" style="color:#F31212;font-size: 12px;">Debe ingresar el Celular</lavel>
                                        <lavel id="mobile_phone_validation_length" class="hidden" style="color:#F31212;font-size: 12px;">El número de celular debe tener 10 dígitos</lavel>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <lavel id="email_validation" class="hidden" style="color:#F31212;font-size: 12px;">Debe ingresar el Correo</lavel>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <lavel id="branch_validation" class="hidden"style="color:#F31212;font-size: 12px;">Debe seleccionar un Ramo</lavel>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <lavel id="emissionType_validation" class="hidden"style="color:#F31212;font-size: 12px;">Debe seleccionar un Tipo de Emisión </lavel>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <lavel id="insuredValue_validation" class="hidden"style="color:#F31212;font-size: 12px;">Debe ingresar el Valor Asegurado</lavel>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <lavel id="netPremium_validation" class="hidden"style="color:#F31212;font-size: 12px;">Debe ingresar el valor Prima Neta</lavel>
                                    </div>
                                </div>
                            </form>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\massivesVinculation\create.blade.php ENDPATH**/ ?>