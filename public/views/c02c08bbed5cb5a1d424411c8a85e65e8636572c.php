<html>
    ...
    <body>
        ...
        <header>
            <img src="<?php echo e($message->embed(public_path('images/logo_seguros_sucre.jpg'))); ?>" alt="" style="width: 100%;height:190px;float:left;"/>
                <strong class="bold" style="float:right;margin-top:-5px">COD: <?php echo e($id); ?> - <?php echo e($year); ?></strong><br>
        </header>
        ...
        <main>
            <div class="col-md-8" style="margin-left: 30px;margin-bottom: 70px">
                <strong class="bold">Estimado/a <?php echo e($customer); ?>,</strong><br>
                <hr>
...
<?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\pdf_2.blade.php ENDPATH**/ ?>