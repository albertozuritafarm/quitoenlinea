                    ...
                    <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="first_name" id="first_name" placeholder="Primer Nombre" value="<?php echo e($customer->first_name); ?>" required="required" tabindex="3" disabled="disabled">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="second_name" id="second_name" placeholder="Segundo Nombre" value="<?php echo e($customer->second_name); ?>" required="required" tabindex="5" disabled="disabled">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control registerForm" name="birthdate" id="birthdate" placeholder="Fecha de Nacimiento" value="<?php echo e($customer->birthdate); ?>" required tabindex="14" style="line-height: 14px;" disabled="disabled">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="mobile_phone" id="mobile_phone" placeholder="Celular" value="<?php echo e($customer->mobile_phone); ?>" required tabindex="7">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control registerForm" name="email" id="email" placeholder="Correo" value="<?php echo e($customer->email); ?>" required tabindex="10">
    ...
    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="last_name" id="last_name" placeholder="Primer Apellido" value="<?php echo e($customer->last_name); ?>" required tabindex="4" disabled="disabled">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="second_last_name" id="second_last_name" placeholder="Segundo Apellido" value="<?php echo e($customer->second_last_name); ?>" required tabindex="6" disabled="disabled">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="phone" id="phone" placeholder="Teléfono" value="<?php echo e($customer->phone); ?>" required tabindex="8">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="address" id="address" placeholder="Dirección" required tabindex="9" value="<?php echo e($customer->address); ?>">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-md-12" style="padding-bottom:15px">
                        ...
                        <div class="row" style="float:right">
                            <a class="btn btn-back registerForm" align="right" <?php if($disabled == null): ?> href="<?php echo e(asset('/sales/product/select')); ?>" <?php else: ?> href="#" disabled="disabled" <?php endif; ?> ><span class="glyphicon glyphicon-step-backward"></span> Anterior </a>
                ...
                <div id="secondStep" class="col-md-12 hidden">
                    ...
                    <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="newVehicle" class="form-control registerForm" id="newVehicle" tabindex="1" required <?php echo e($disabled); ?> onchange="newVehicleChange(this.value)">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-inline">
                                    <input type="text" class="form-control registerForm" name="plateForm" id="plateForm" tabindex="2" placeholder="Placa/RAMV" value="<?php echo e(old('plate')); ?>" maxlength="7" required style="width:89%" onclick="clearVehicleForm();" onkeydown="clearVehicleForm();">
                                    <button type="button" class="btn btn-info" id="plateBtn" <?php if($disabled != null): ?> disabled="disabled" <?php else: ?> <?php endif; ?> style="width:10%"><span class="glyphicon glyphicon-search"></span></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;margin-top:15px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="ramv" id="ramv" tabindex="3" placeholder="RAMV" value="<?php echo e(old('plate')); ?>" maxlength="7" required disabled="disabled">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="model" id="model" tabindex="5" placeholder="Modelo" value="<?php echo e(old('model')); ?>" required disabled="disabled">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="color" id="color" tabindex="7" placeholder="Color" value="<?php echo e(old('color')); ?>" required disabled="disabled">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="vehiType" class="form-control registerForm" id="vehiType" tabindex="11" required disabled="disabled">
                                    ...
                                    <option id="typeSelect" value="<?php echo e($type->name); ?>"><?php echo e($type->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="plate" id="plate" tabindex="4" placeholder="Placa" value="<?php echo e(old('plate')); ?>" maxlength="7" required disabled="disabled">                                
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm yearVehicle" name="year" id="year" tabindex="8" placeholder="Año" value="<?php echo e(old('year')); ?>" max="2020" min="1" required disabled="disabled">
                    ...
                    <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;margin-top:15px;">
                        ...
                        <div class="col-md-6 col-md-offset-6">
                            <div class="form-group">
                                <a  id="btnVehicles" <?php if($disabled != null): ?> disabled="disabled" <?php else: ?> <?php endif; ?> class="btn btn-success registerForm" align="right" href="#" style="float:right;margin-right: 0px;padding: 5px;width:100px"><span class="glyphicon glyphicon-plus"></span>Agregar </a>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control registerForm" name="description" id="description" tabindex=3 placeholder="Descripción" value="<?php echo e(old('model')); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\create_old.blade.php ENDPATH**/ ?>