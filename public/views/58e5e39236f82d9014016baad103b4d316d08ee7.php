                            ...
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
									<td style="padding: 30px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: justify;">
                                        ...
                                        <p style="margin: 10px 0 0 0;">Seguros Sucre te informa que la suscripción medica del cliente <span style="font-weight: bold"> <?php echo e($customer[0]->Cliente); ?> </span> correspondiente a la cotización número <span style="font-weight: bold"> <?php echo e($saleId); ?> </span>, ha sido rechazada, para información adicional por favor contactar a tu ejecutivo comercial. </p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\emails\inspectionRejectedR2User.blade.php ENDPATH**/ ?>