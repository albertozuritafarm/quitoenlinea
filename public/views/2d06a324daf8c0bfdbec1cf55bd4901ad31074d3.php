...
<html lang="es">
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo e(assets('images/favicons/favicon.ico')); ?>">
    ...
    <body style="font-size: 11px">
        ...
        <div id="" class="toggled">
            <div id="page-content-wrapper" style="background-color:#FFFFFF; border:solid 1px #E5E5E5; height: 100px;">
                <img class="img-responsive" id="headerImgLeft" src="<?php echo e(assets('images/Web_header1.png')); ?>" width="auto" height="auto" style="float:left;margin-top: -45px; font-weight: bold;margin-left: 15px;max-width: 50%;"/>
                <img class="img-responsive" id="headerImgRight" src="<?php echo e(assets('images/Web_header2.png')); ?>" width="auto" height="auto" style="float:right;margin-top: -45px;margin-right: 15px;max-width: 40%;"/>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\magnussucre\resources\views/layouts/remote_app.blade.php ENDPATH**/ ?>