<html>
    ...
    <body>
        ...
        <header>
            <img src="<?php echo e(public_path('images/aseguramiento.png')); ?>" alt="" style="width: 100%;height:100%;"/>
        ...
        <main>
            ...
            <div style="width:100%;">
                ...
                <div style="width:100%;background-color: white;color:#183c6b;font-size:12px;font-weight: bold;line-height: 20px; height:25px;">
                    <strong class="bold" style="color:#183c6b;font-size: 12px;">SOLICITANTE</strong> <?php echo e($customer->first_name); ?> <?php echo e($customer->second_name); ?> <?php echo e($customer->last_name); ?> <?php echo e($customer->second_last_name); ?>

                </div>
                    <table class="divData" >
                        <tr>
                             <th style="width:15%"><span class="bold">Nombre:</span></th>
                             <td colspan="3"> <?php echo e($customer->first_name); ?> <?php echo e($customer->second_name); ?> <?php echo e($customer->last_name); ?> <?php echo e($customer->second_last_name); ?></td>
                        </tr>
                        <tr>
                            <th style="width:15%"><span class="bold">C.I./R.U.C.</span></th>
                             <td colspan="3"><?php echo e($customer->document); ?></td>
                        </tr>
                        <tr>
                ...
                <div class="divData">
                    <table>
                        <tr>
                            ...
                            <td style="width:35%"><?php echo e(date('d-m-Y', strtotime($sale->begin_date))); ?></td>
                            <th style="width:15%"><span>Hasta:</span></th>
                            <td style="width:35%"><?php echo e(date('d-m-Y', strtotime($sale->end_date))); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <div class="divData">
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="width:45%;"><?php echo e($muerte); ?></td>
                        </tr>
                            <td style="width:50%;" class="bold">Enfermedades Graves</td>
                            <td style="width:5%;">USD</td>
                            <td style="width:45%;"><?php echo e($enfer); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div style="width:100%;">
                ...
                <div class="divData" >
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $beneficiarys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bene): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="text-align: center">
                                    <td style="text-align: center"><?php echo e($bene->cusName); ?></td>
                                    <td style="text-align: center"><?php echo e($bene->benPor); ?></td>
                                    <td style="text-align: center"><?php echo e($bene->benRela); ?></td>
                                </tr>
                    ...
                    <table class="divData" style="border-style: none;">
                        <tbody>
                            ...
                            <tr style="border: 1px solid black;">
                                ...
                                <td style="width:10%;"><?php if($answers->insuranceRecord1 == 'yes'): ?> X <?php endif; ?></td>
                                <td style="width:10%;"><?php if($answers->insuranceRecord1 == 'no'): ?> X <?php endif; ?></td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:10%;"><?php if($answers->insuranceRecord2 == 'yes'): ?> X <?php endif; ?></td>
                                <td style="width:10%;"><?php if($answers->insuranceRecord2 == 'no'): ?> X <?php endif; ?></td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:10%;"><?php if($answers->insuranceRecord3 == 'yes'): ?> X <?php endif; ?></td>
                                <td style="width:10%;"><?php if($answers->insuranceRecord3 == 'no'): ?> X <?php endif; ?></td>
                            </tr>
                            <tr>
                                <td style="width:80%;">4.	¿Consume bebidas alcohólicas? En caso afirmativo indique cantidad y frecuencia</td>
                                <td style="width:10%;"><?php if($answers->insuranceRecord4 == 'yes'): ?> X <?php endif; ?></td>
                                <td style="width:10%;"><?php if($answers->insuranceRecord4 == 'no'): ?> X <?php endif; ?></td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:10%;"><?php if($answers->insuranceRecord5 == 'yes'): ?> X <?php endif; ?></td>
                                <td style="width:10%;"><?php if($answers->insuranceRecord5 == 'no'): ?> X <?php endif; ?></td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:10%;"><?php if($answers->insuranceRecord6 == 'yes'): ?> X <?php endif; ?></td>
                                <td style="width:10%;"><?php if($answers->insuranceRecord6 == 'no'): ?> X <?php endif; ?></td>
                            </tr>
                            <tr>
                                <td style="width:80%;">7.	¿Alguna vez ha recibido beneficios por incapacidad?</td>
                                <td style="width:10%;"><?php if($answers->insuranceRecord7 == 'yes'): ?> X <?php endif; ?></td>
                                <td style="width:10%;"><?php if($answers->insuranceRecord7 == 'no'): ?> X <?php endif; ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div style="width:100%;">
                ...
                <div style="width:100%;background-color: white;color:#183c6b;font-size:12px;font-weight: bold;line-height: 20px; height:25px;">
                    ...
                    <table class="divData">
                        ...
                        <?php if($answers->insuranceRecord1 == 'yes'): ?>
                            <tr>
                                <td style="width:10%;">1</td>
                                <td style="width:90%;"><?php echo e($answers->insuranceRecord1_detail); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->insuranceRecord2 == 'yes'): ?>
                            <tr>
                                <td style="width:10%;">2</td>
                                <td style="width:90%;"><?php echo e($answers->insuranceRecord2_detail); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->insuranceRecord3 == 'yes'): ?>
                            <tr>
                                <td style="width:10%;">3</td>
                                <td style="width:90%;"><?php echo e($answers->insuranceRecord3_detail); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->insuranceRecord4 == 'yes'): ?>
                            <tr>
                                <td style="width:10%;">4</td>
                                <td style="width:90%;"><?php echo e($answers->insuranceRecord4_detail); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->insuranceRecord5 == 'yes'): ?>
                            <tr>
                                <td style="width:10%;">5</td>
                                <td style="width:90%;"><?php echo e($answers->insuranceRecord5_detail); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->insuranceRecord6 == 'yes'): ?>
                            <tr>
                                <td style="width:10%;">6</td>
                                <td style="width:90%;"><?php echo e($answers->insuranceRecord6_detail); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->insuranceRecord7 == 'yes'): ?>
                            <tr>
                                <td style="width:10%;">7</td>
                                <td style="width:90%;"><?php echo e($answers->insuranceRecord7_detail); ?></td>
                            </tr>
                        <?php endif; ?>
                    </table>
                </div>
                ...
                <div>
                    ...
                    <table class="divData" style="border-style: none;">
                        ...
                        <tr style="border: 1px solid black;">
                            ...
                            <td style="width:10%;"><?php if($answers->medicalHistory1 == 'yes'): ?> X <?php endif; ?></td>
                            <td style="width:10%;"><?php if($answers->medicalHistory1 == 'no'): ?> X <?php endif; ?></td>
                        </tr>
                        <tr>
                            <td style="width:80%;">2.	¿Está actualmente tomando algún medicamento, en observación o tratamiento médico?</td>
                            <td style="width:10%;"><?php if($answers->medicalHistory2 == 'yes'): ?> X <?php endif; ?></td>
                            <td style="width:10%;"><?php if($answers->medicalHistory2 == 'no'): ?> X <?php endif; ?></td>
                        </tr>
                        <tr>
                            <td style="width:80%;">3.	¿Se ha realizado algún examen, consulta, chequeo u operación en los últimos tres (3) años?</td>
                            <td style="width:10%;"><?php if($answers->medicalHistory3 == 'yes'): ?> X <?php endif; ?></td>
                            <td style="width:10%;"><?php if($answers->medicalHistory3 == 'no'): ?> X <?php endif; ?></td>
                        </tr>
                        <tr>
                            <td style="width:80%;">4.	¿Ha sido hospitalizado o internado en alguna institución o sanatorio en los últimos tres (3) años?</td>
                            <td style="width:10%;"><?php if($answers->medicalHistory4 == 'yes'): ?> X <?php endif; ?></td>
                            <td style="width:10%;"><?php if($answers->medicalHistory4 == 'no'): ?> X <?php endif; ?></td>
                        </tr>
                        <tr>
                            <td style="width:80%;">5.	¿Tiene que ser hospitalizado o internado en alguna institución o sanatorio?</td>
                            <td style="width:10%;"><?php if($answers->medicalHistory5 == 'yes'): ?> X <?php endif; ?></td>
                            <td style="width:10%;"><?php if($answers->medicalHistory5 == 'no'): ?> X <?php endif; ?></td>
                        </tr>
                        <tr>
                            <td style="width:80%;">6.	¿Ha sufrido alguna enfermedad física o mental no mencionada anteriormente?</td>
                            <td style="width:10%;"><?php if($answers->medicalHistory6 == 'yes'): ?> X <?php endif; ?></td>
                            <td style="width:10%;"><?php if($answers->medicalHistory6 == 'no'): ?> X <?php endif; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width:10%;"><?php if($answers->medicalHistory7 == 'yes'): ?> X <?php endif; ?></td>
                            <td style="width:10%;"><?php if($answers->medicalHistory7 == 'no'): ?> X <?php endif; ?></td>
                        </tr>
                        <tr>
                            <td style="width:80%;">8.	Solo para mujeres, ¿Está embarazada? Indique cuantas semanas o meses</td>
                            <td style="width:10%;"><?php if($answers->medicalHistory8 == 'yes'): ?> X <?php endif; ?></td>
                            <td style="width:10%;"><?php if($answers->medicalHistory8 == 'no'): ?> X <?php endif; ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="divData" style="width:100%;">
                <div>
                    <table>
                        ...
                        <?php if($answers->medicalHistory1 == 'yes'): ?>
                            <tr>
                                <td>1</td>
                                <td><?php echo e($answers->diagnosis1); ?></td>
                                <td><?php echo e(date('d-m-Y', strtotime($answers->treatmentDate1))); ?></td>
                                <td><?php echo e($answers->duration1); ?></td>
                                <td><?php echo e($answers->hospital1); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->medicalHistory2 == 'yes'): ?>
                            <tr>
                                <td>2</td>
                                <td><?php echo e($answers->diagnosis2); ?></td>
                                <td><?php echo e(date('d-m-Y', strtotime($answers->treatmentDate2))); ?></td>
                                <td><?php echo e($answers->duration2); ?></td>
                                <td><?php echo e($answers->hospital2); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->medicalHistory3 == 'yes'): ?>
                            <tr>
                                <td>3</td>
                                <td><?php echo e($answers->diagnosis3); ?></td>
                                <td><?php echo e(date('d-m-Y', strtotime($answers->treatmentDate3))); ?></td>
                                <td><?php echo e($answers->duration3); ?></td>
                                <td><?php echo e($answers->hospital3); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->medicalHistory4 == 'yes'): ?>
                            <tr>
                                <td>4</td>
                                <td><?php echo e($answers->diagnosis4); ?></td>
                                <td><?php echo e(date('d-m-Y', strtotime($answers->treatmentDate4))); ?></td>
                                <td><?php echo e($answers->duration4); ?></td>
                                <td><?php echo e($answers->hospital4); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->medicalHistory5 == 'yes'): ?>
                            <tr>
                                <td>5</td>
                                <td><?php echo e($answers->diagnosis5); ?></td>
                                <td><?php echo e(date('d-m-Y', strtotime($answers->treatmentDate5))); ?></td>
                                <td><?php echo e($answers->duration5); ?></td>
                                <td><?php echo e($answers->hospital5); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->medicalHistory6 == 'yes'): ?>
                            <tr>
                                <td>6</td>
                                <td><?php echo e($answers->diagnosis6); ?></td>
                                <td><?php echo e(date('d-m-Y', strtotime($answers->treatmentDate6))); ?></td>
                                <td><?php echo e($answers->duration6); ?></td>
                                <td><?php echo e($answers->hospital6); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->medicalHistory7 == 'yes'): ?>
                            <tr>
                                <td>7</td>
                                <td><?php echo e($answers->diagnosis7); ?></td>
                                <td><?php echo e(date('d-m-Y', strtotime($answers->treatmentDate7))); ?></td>
                                <td><?php echo e($answers->duration7); ?></td>
                                <td><?php echo e($answers->hospital7); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($answers->medicalHistory8 == 'yes'): ?>
                            <tr>
                                <td>8</td>
                                <td><?php echo e($answers->diagnosis8); ?></td>
                                <td><?php echo e(date('d-m-Y', strtotime($answers->treatmentDate8))); ?></td>
                                <td><?php echo e($answers->duration8); ?></td>
                                <td><?php echo e($answers->hospital8); ?></td>
                            </tr>
                        <?php endif; ?>
                    </table>
                </div>
            ...
            <div style="width:100%;">
                ...
                <p>Declaro bajo juramento que toda la información contenida en este formulario es de verídica y absoluta responsabilidad de quien lo suscribe. Autorizo a SEGUROS SUCRE S.A. a verificar la información de este formulario. Declaro bajo juramento que los fondos para el pago de primas, gastos e impuestos en razón o consecuencia de la emisión de pólizas contratadas con SEGUROS SUCRE S.A. tienen origen lícito. Eximo a SEGUROS SUCRE S.A. de toda responsabilidad, inclusive frente a terceros si esta declaración fuese falsa o errónea.</p>
                    <p>Lugar y Fecha: Quito, <?php echo e(date('d-m-Y', strtotime($sale->begin_date))); ?></p>
                </div>
            </div>
            <hr>
            <div style="width:100%;">
...
</html><?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\R2\pdf_insuranceApplication.blade.php ENDPATH**/ ?>