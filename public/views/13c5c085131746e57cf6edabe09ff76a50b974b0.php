                            ...
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
									<td style="padding: 30px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: justify;">
                                        <p style="margin: 0px;">Estimado <span style="font-weight: bold"><?php echo e($customer[0]->user); ?></span></p>
                                        
                                        <p style="margin: 10px 0 0 0;">Seguros Sucre te informa que la inspección del cliente <span style="font-weight: bold"> <?php echo e($customer[0]->Cliente); ?> </span> correspondiente a la cotización número <span style="font-weight: bold"> <?php echo e($saleId); ?> </span> , ha sido realizada satisfactoriamente, ya puedes continuar con el proceso de pago desde la plataforma de ventas. </p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <table border="1" cellpadding="0" cellspacing="0" class="component text-component" i18n="MODULES-TXT_BEGIN_AND_CUSTUMIZE" id="8" style="width:100%">
                            <tbody>
                                ...
                                <?php $__currentLoopData = $car; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <th><?php echo e($c->plate); ?></th>
                                        <th><?php echo e($c->brand); ?></th>
                                        <th><?php echo e($c->model); ?></th>
                                        <th><?php echo e($c->year); ?></th>
...
<?php echo $__env->make('layouts.email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\emails\inspectionAceptedR1User.blade.php ENDPATH**/ ?>