                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="component title-component" i18n="MODULES-TXT_HEAD_TITLE" id="4" style="width:100%">
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 0px 0px 0px 14px; margin:20px 0px 0px 0px; font-size: 1.5em; font-weight: bold; display: inherit; color: rgb(96, 96, 96); text-align: center;background-color: rgb(217, 217, 217)"> <img src=" <?php echo e($message->embed(public_path('images/logo_seguros_sucre.jpg'))); ?>" alt="Logo"> </td>
                            ...
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 5px 10px 80px 14px; display: inherit; color: rgb(96, 96, 96); text-align: left;">
                                        <p style="margin: 0px;">Hola <?php echo e($user); ?>, Tienes un nuevo respuesta sobre el ticket.</p>
                                        <hr>
                                        <p><strong>Ticket:</strong> <?php echo e($ticketId); ?>. </p>
                                        <p><strong>Modulo:</strong> <?php echo e($menu); ?>. </p>
                                        <p><strong>Tipo Ticket:</strong> <?php echo e($tipo); ?>. </p>
                                        <p><strong>Categoria:</strong> <?php echo e($typeDetail); ?>. </p>
                                        <p><strong>Titulo:</strong> <?php echo e($title); ?>. </p>
                                        <p><strong>Comentario:</strong> </p>
                                        <?php echo $description; ?>

                                        <hr>
                                        <p>Ingresa <a href="<?php echo e(asset('')); ?>ticket/detail/<?php echo e($ticketId); ?>">Aqui</a> para ver el ticket</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\emails\ticketComment.blade.php ENDPATH**/ ?>