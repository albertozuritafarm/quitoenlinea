...
<div class="container" style="margin-top:5px;width: 100%">
    <div>
        <div class="row">
            ...
            <div class="col-xs-12 col-md-4 wizard_medio"><div class="wizard_activo registerForm">REPORTE CARTERA</div></div>
            <div class="col-xs-12 col-md-1 wizard_medio"><div class="wizard_inactivo registerForm"></div></div>
        ...
        <div class="col-md-12 border" style="padding: 5px; margin-top: 15px;">
            <div class="col-md-12 border" style="margin-top:10px;margin-left:0;margin-right:15px;">
                <form method="POST" action="<?php echo e(asset('/walletReport')); ?>" onsubmit="return val()">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="ramov" name="ramov">
                                        <option value="" selected="true">--Escoja Una--</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\reports\walletIndex.blade.php ENDPATH**/ ?>