<script src="<?php echo e(assets('js/sales/R2/emit.js')); ?>"></script>
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" name="beginDate" id="beginDate" placeholder="Correo" value="<?php echo e($now); ?>" style="line-height:14px" onchange="removeInputRedFocus('beginDate'), changeEndDate(this.value)" disabled="disabled">
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" name="endDate" id="endDate" placeholder="Correo" value="<?php echo e($next); ?>" style="line-height:14px" onchange="removeInputRedFocus('endDate')" disabled="disabled">
                            </div>
                        </div>
                    </form>
                </div>
...
</div><?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\R2\emit.blade.php ENDPATH**/ ?>