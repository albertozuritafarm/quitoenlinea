...
<script src="<?php echo e(assets('js/benefits/create.js')); ?>"></script>
...
<div class="container" style="margin-top:15px; font-size:14px !important">
    ...
    <div class="col-md-8 col-md-offset-2 border" style="padding: 15px">
        ...
        <?php endif; ?>
        <br>
        <form method="POST" action="<?php echo e(asset('/benefits/store')); ?>">
            ...
            <div class="col-md-10 col-md-offset-1" style="margin-top:5px;padding-top:15px;padding-bottom:15px">
                <div class="col-md-1">
                    <a class="btn btn-default registerForm" align="right" href="<?php echo e(asset('/benefits')); ?>" style="margin-left: -30px;"> Cancelar </a>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\benefits\create.blade.php ENDPATH**/ ?>