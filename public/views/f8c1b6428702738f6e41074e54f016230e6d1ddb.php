                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    --<div class="form-group col-md-6">
                                        ...
                                        <table><tr>
                                        <td id="tipo_empresa">Cédula</td><td id="tipo_empresa"> <input  type="checkbox"   id="cedula" name="cedula" value="cedula" class="form-control move-left" required tabindex="10" placeholder="cedula" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->document); ?>"></td><td></td><td></td>
                                        </tr> 
                                        <tr>
