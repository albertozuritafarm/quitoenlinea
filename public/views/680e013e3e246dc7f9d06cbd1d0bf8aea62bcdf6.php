                    ...
                    <form>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" name="beginDate" id="beginDate" placeholder="Correo" <?php if($newVehicle == 'false'): ?> value='<?php echo e($beginDate); ?>' <?php else: ?> value='' <?php endif; ?> style="line-height:14px" onchange="removeInputRedFocus('beginDate'), changeEndDate(this.value)" <?php echo e($disabled); ?>>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-inline">
                                            <input autocomplete="off" type="text" class="form-control registerForm" name="document" id="document" value="<?php echo e($customer->document); ?>" <?php if($disabled): ?> disabled="disabled" <?php else: ?> <?php endif; ?> placeholder="Cédula" required="required"tabindex="1" style="width:89%" onclick="clearFormEndoso()" onchange="clearFormEndoso()">
...
</div><?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\R1\emit.blade.php ENDPATH**/ ?>