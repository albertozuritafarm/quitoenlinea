                        ...
                        <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="business_name" name="business_name" class="form-control registerForm" required tabindex="1" placeholder="Razón Social"   value="<?php echo e($company->business_name); ?>" maxlength="60" disabled="disabled">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="main_roadCompany" name="main_roadCompany" class="form-control registerForm" required tabindex="5" placeholder="Dirección/Calle Principapl" value="<?php echo e($company->address); ?>" <?php echo e($disable_status); ?> maxlength="30">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="phoneCompany" name="phoneCompany" class="form-control registerForm" required tabindex="13" placeholder="Teléfono"  value="<?php echo e($company->phone); ?>" <?php echo e($disable_status); ?> maxlength="9">
                        ...
                        <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-inline">
                                        <input autocomplete="off" type="text" class="form-control registerForm" name="document" id="document" placeholder="Cédula" style="float:left;width:100%" required tabindex="16" <?php if($legalRepresentative != false): ?> disabled="disabled" value="<?php echo e($legalRepresentative->document); ?>" <?php endif; ?>>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control registerForm" name="address" id="address" placeholder="Dirección/Calle Principal" required tabindex="28" value="<?php echo e($legalRepresentative->address); ?>" maxlength="30" <?php echo e($disable_status); ?> >
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control registerForm" name="phone" id="phone" placeholder="Teléfono" value="<?php echo e($legalRepresentative->phone); ?>"maxlength="9" required tabindex="34" <?php echo e($disable_status); ?> >
                    ...
                    <br>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="spouseDocument" name="spouseDocument" class="form-control registerForm" required tabindex="37"  style="line-height: 15px !important;" value="<?php echo e($spouse_document); ?>"  placeholder="Documento de Identidad Cónyuge"onchange="removeInputRedFocus(this.id)" <?php echo e($disable_status); ?>>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="spouseFirstName" name="spouseFirstName" class="form-control registerForm" required tabindex="39"  style="line-height: 15px !important" value="<?php echo e($spouse_name); ?>" placeholder="Nombre del Cónyuge" onchange="removeInputRedFocus(this.id)" maxlength="60" <?php echo e($disable_status); ?>>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="spouseLastName" name="spouseLastName" class="form-control registerForm" required tabindex="40"  style="line-height: 15px !important" value="<?php echo e($spouse_last_name); ?>" placeholder="Apellido(s) del Cónyuge" onchange="removeInputRedFocus(this.id)" maxlength="30"<?php echo e($disable_status); ?>>
                            ...
                            <div class="">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text2" id="beneficiary_address" name="beneficiary_address" class="form-control registerForm" required tabindex="46"  style="line-height: 15px !important" value="<?php echo e($beneficiary_address); ?>" placeholder="Dirección de Domicilio" onchange="removeInputRedFocus(this.id)" <?php echo e($disable_status); ?> maxlength="100">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text2" id="beneficiary_phone" name="beneficiary_phone" class="form-control registerForm" required tabindex="47"  style="line-height: 15px !important" value="<?php echo e($beneficiary_phone); ?>" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" <?php echo e($disable_status); ?> maxlength="10">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text2" id="beneficiary_relationship" name="beneficiary_relationship" class="form-control registerForm" required tabindex="48"  style="line-height: 15px !important" value="<?php echo e($beneficiary_relationship); ?>" placeholder="Relación" onchange="removeInputRedFocus(this.id)" <?php echo e($disable_status); ?> maxlength="20">
