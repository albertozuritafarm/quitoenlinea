...
<script src="<?php echo e(assets('js/financing/create.js')); ?>"></script>
    ...
    <div class="col-md-8 col-md-offset-2 border">
        ...
        <div id="firstStep">
            ...
            <div class="col-md-12" style="margin-top:5px;padding-top:15px;padding-bottom:15px">
                <a class="btn btn-default registerForm" align="left" href="<?php echo e(asset('/financing')); ?>" style="margin-left:-15px" tabindex="30"> Cancelar </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\financing\create.blade.php ENDPATH**/ ?>