...
<script src="<?php echo e(asset('js/massive/index.js')); ?>"></script>
...
<div class="container" style="width: 100%">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="channel" id="channel" class="form-control" value="">
                                ...
                                <option <?php if($channel->id == session('massiveFirstViewChannel')): ?> <?php else: ?> <?php endif; ?> value="<?php echo e($channel->id); ?>"><?php echo e($channel->name); ?></option>
        ...
        <div class="col-md-12" style="margin-left: -15px">
            ...
            <a type="button" class="border btnTable" href="<?php echo e(asset('/massive/create')); ?>" data-toggle="tooltip" title="Nuevo"><img src="<?php echo e(asset('/images/mas.png')); ?>" width="24" height="24" alt=""></a>
            <a type="button" class="border btnTable" href="<?php echo e(asset('/massive/cancel')); ?>" data-toggle="tooltip" title="Cancelar"><img src="<?php echo e(asset('/images/menos.png')); ?>" width="24" height="24" alt=""></a>
...
</script><?php /**PATH C:\wamp64\www\magnussucre\resources\views\massive\listado.blade.php ENDPATH**/ ?>