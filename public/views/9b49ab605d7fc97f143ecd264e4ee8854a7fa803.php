    ...
    <div>
        ...
        <div class="col-md-12 border" style="padding: 5px; margin-top: 15px;">
            <div class="col-md-12 border" style="margin-top:10px;margin-left:0;margin-right:15px;">
                <form method="POST" action="<?php echo e(asset('/TevehiclesReport')); ?>" onsubmit="return val()">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\reports\TevehiclesIndex.blade.php ENDPATH**/ ?>