...
<script src="<?php echo e(assets('js/account/index.js')); ?>"></script>
...
<div class="container" style="width: 100%">
    <div>
        <div class="col-md-12 hidden border" id="filter" style="margin-top:10px;margin-left:0;margin-right:15px;">
            <form method="POST" action="<?php echo e(asset('/account')); ?>">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="banId" id="banId" placeholder="# Solicitud" value="<?php echo e($data['banId']); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
        ...
        <div class="col-md-12" style="margin-left: -15px">
            ...
            <?php if(session('successAccount')): ?>
            <div class="alert alert-success">
                <center>
                    <?php echo e(session('successAccount')); ?>
            ...
            <a type="button" class="border btnTable" href="<?php echo e(asset('/account/create')); ?>" data-toggle="tooltip" title="Nueva Solicitud"><img src="<?php echo e(asset('/images/mas.png')); ?>" width="24" height="24" alt=""></a>
            <a type="button" class="border btnTable" href="#" data-toggle="tooltip" title="Eliminar Solicitu(es)" id="deleteAccountsBtn"><img src="<?php echo e(asset('/images/menos.png')); ?>" width="24" height="24" alt=""></a>
        </div>
            ...
            <div id="tableDiv" class="col-md-12" >
                <table id="tableUsers" class="table table-striped row-border table-responsive hover stripe" style="margin-left:-14px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td align="center"><input type="checkbox" name="accountId" value="<?php echo e($acc->id); ?>"></td>
                            ...
                            <td align="center"><?php echo e($acc->status); ?></td>
                            <td align="center"><?php echo e($acc->date); ?></td>
                            <td align="center">
                                <?php if($acc->status == 'Pendiente'): ?>
                                <a href="#" onclick="accountApprove(<?php echo e($acc->id); ?>)"><img src="<?php echo e(asset('/images/Aprobar.png')); ?>"></img></a>
                                <a href="#" onclick="accountDeny(<?php echo e($acc->id); ?>)"><img src="<?php echo e(asset('/images/Rechazar.png')); ?>"></img></a>
                                <?php else: ?>
                                <?php endif; ?>
                                <?php if($acc->status == 'Falta Activación'): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\account\index.blade.php ENDPATH**/ ?>