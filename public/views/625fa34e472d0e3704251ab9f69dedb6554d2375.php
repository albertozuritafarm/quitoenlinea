...
<form method="POST" action="<?php echo e(route('remoteVehicles')); ?>">
...
<form method="POST" action="<?php echo e(route('resendCodeVehicles')); ?>">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.app_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\remote\index_vehicles.blade.php ENDPATH**/ ?>