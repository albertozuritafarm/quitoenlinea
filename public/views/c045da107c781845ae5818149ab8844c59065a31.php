...
<form method="POST" action="<?php echo e(route('login')); ?>">
    ...
    <div align="center" style="margin-bottom:60px">
        <img src="<?php echo e(asset('images/logo_seguros_sucre_2.png')); ?>" class="img-responsive" width="70%">
    </div>
    <div class="content">
        <div>
            ...
            <div class="form-group" align="left">
                ...
                <span class="invalid-feedback" role="alert">
                    <strong><?php echo e($errors->first('errorMsg')); ?></strong>
                </span>
                <?php endif; ?>
            </div>
...
<!--            <div class="form-group" align="left">
                ...
                <input id="company" type="company" class="form-control<?php echo e($errors->has('company') ? ' is-invalid' : ''); ?>" name="company" placeholder="Ingrese la empresa" required>
    ...
    <div>
        <div class="legend" style="margin-top:20px">
            ...
            <a href="<?php echo e(asset('/login/recover')); ?>">¿Olvido su Contraseña?</a><br><br>
...
<?php echo $__env->make('layouts.app_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\magnussucre\resources\views/auth/login.blade.php ENDPATH**/ ?>