    ...
    <div class="row justify-content-center">
        <div class="card">
            <div class="col-md-4 col-md-offset-2">
                <form method="POST" action="<?php echo e(asset('/user/update/pass')); ?>">
                    ...
                    <a class="btn btn-danger" href="<?php echo e(asset('/user')); ?>"> Cancelar </a>
                </form>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\user\update_pass.blade.php ENDPATH**/ ?>