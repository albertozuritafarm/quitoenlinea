    ...
    <body>
        ...
        <main>
            ...
            <div class="col-md-4 col-md-offset-4">
                <!-- <img src="<?php echo e(public_path('images/logo_seguros_sucre.jpg')); ?>" alt="" style="width: 25%;height:20%; margin-left: 35%; margin-bottom:0px;margin-top:-20px;"/> -->
                <center>
                ...
                <div>
                    <table>                        
                        <tr>
                            ...
                            <td colspan="3"> C.I:<input type="checkbox" style="margin-top:5px;margin-left:5px;" <?php if($customer->document_id == 1): ?> checked="checked" <?php endif; ?> ></td>                            
                            <td colspan="3"> Pasaporte:<input type="checkbox" style="margin-top:5px;" <?php if($customer->document_id == 2): ?> checked="checked" <?php endif; ?> ></td>
                            <td colspan="3"> Ruc:<input type="checkbox"  style="margin-top:5px;"> </td>
                            <td colspan="1" style="margin-top:5px;margin-left:10px;">Sexo:</td>
                            <td colspan="2" style="margin-top:5px;margin-left:5px;">M:<input type="checkbox" style="margin-top:5px;margin-left:5px;" <?php if($customer->document_id == 1): ?> checked="checked" <?php endif; ?> > </td>
                            <td colspan="2" >F:<input type="checkbox" style="margin-top:5px;" <?php if($customer->document_id == 2): ?> checked="checked" <?php endif; ?> ></td>                            
                        </tr>
                        <tr>
                            <td colspan="2" style="margin-top:5px;margin-left:5px;">Número de Identificación:</td>
                            <td colspan="7" class="underlineCell" style="text-align:left;"><?php echo e($customer->document); ?></td>
                        ...
                        <tr>
                            ...
                            <td colspan="7" style="text-align:left;" class="underlineCell"><?php echo e($customer->last_name); ?> <?php echo e($customer->second_last_name); ?></td>
                            <td colspan="1" style="text-align:right;">Nombres:</td>
                            <td colspan="8" style="text-align:left;" class="underlineCell"> <?php echo e($customer->first_name); ?> <?php echo e($customer->second_name); ?></td>
                        </tr>
                        <tr>
                            <td colspan="2">Estado civil:</td>
                            <td colspan="3">Casado:<input type="checkbox" style="margin-top:5px;"  <?php if($vinculation->civil_state ==2): ?> checked="checked" <?php endif; ?> ></td>
                            <td colspan="3">Soltero:<input type="checkbox" style="margin-top:5px;"  <?php if($vinculation->civil_state == 1): ?> checked="checked" <?php endif; ?> ></td>
                            <td colspan="3">U/Libre  <input type="checkbox" style="margin-top:5px;" <?php if($vinculation->civil_state == 5): ?> checked="checked" <?php endif; ?> ></td>
                            <td colspan="2"> Divorciado: <input type="checkbox" style="margin-top:5px;" <?php if($vinculation->civil_state == 3): ?> checked="checked" <?php endif; ?> ></td>
                            <td colspan="2">Viudo: <input type="checkbox" style="margin-top:5px;" <?php if($vinculation->civil_state == 4): ?> checked="checked" <?php endif; ?> > </td>
                            <td  colspan="7"></td>

                        </tr>
                        <tr>
                            <td colspan="2">Dirección/ Calle Principal:</td>
                            <td colspan="9" class="underlineCell" style="text-align:left;"><?php echo e($vinculation->main_road); ?> </td>
                        ...
                        <tr>
                            ...
                            <td colspan="9" class="underlineCell" style="text-align:left;"> <?php echo e($vinculation->address_number); ?></td>
                        ...
                        <tr>
                            ...
                            <td colspan="7" class="underlineCell" style="text-align:left;"><?php echo e($customer->email); ?></td>
           ...
           <div class="divData" style="width:100%;text-align:justify !important">
            ...
            <div class="divData" style="width:100%;text-align:justify !important">
                <div>
                    ...
                    <br>
                    <span>
                        Nombres Completos: ________________<span class="underline"><?php echo e($broker->ejecutivo); ?></span>__________________________________ Confirmo que he revisado la razonabilidad de la información proporcionada por el cliente o contratante y declaro que he verificado la documentación e información solicitada de acuerdo a lo establecido en la política "Conozca su Cliente" y he analizado la información respecto a la actividad económica e ingresos, los cuales concuerdan con los productos solicitados.
                    </span>
                    <br>
                </div>
            </div>
...
</html><?php /**PATH C:\wamp64\www\magnussucre\resources\views/pnBeneficiaryVinculation/pdf.blade.php ENDPATH**/ ?>