    ...
    <body>
        <div style="margin-left:50px; width:80%">
            <div style="background-color: #FFF; border-style: solid; border-color:#5CB85C; border-width:2px; min-width:400px;min-height:240px; max-width:450px; max-height: 310px;">
                ...
                <br/>
                <div style="padding-left:10px;">
                    Se está realizando un proceso de compra a su nombre por un valor de <?php echo e($value); ?> con el crédito 
                    otorgado por la Institución Financiera "<?php echo e($bank); ?>". Si está de acuerdo, use el siguiente código para 
...
</html><?php /**PATH C:\wamp64\www\magnussucre\resources\views\emails\financingCodeEmail.blade.php ENDPATH**/ ?>