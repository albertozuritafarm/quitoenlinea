                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="component title-component" i18n="MODULES-TXT_HEAD_TITLE" id="4" style="width:100%">
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 5px 0px 5px 14px; margin:60px 0px 0px 0px; font-size: 1.5em; font-weight: bold; display: inherit; color: rgb(96, 96, 96); text-align: center;"> <img src="<?php echo e($message->embed(public_path('images/Email/Mail-Pago.png'))); ?>" width="100%" alt="Listas Informativas"> </td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                            ...
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
									<td style="padding: 30px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: justify;">
                                        ...
                                        <p style="margin: 10px 0 0 0;">Seguros Sucre te informa que el pago del cliente<span style="font-weight: bold"> <?php echo e($customer[0]->Cliente); ?> </span>correspondiente a la cotización número <span style="font-weight: bold"> <?php echo e($saleId); ?></span>, no se pudo procesar.</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\emails\paymentRejectedUser.blade.php ENDPATH**/ ?>