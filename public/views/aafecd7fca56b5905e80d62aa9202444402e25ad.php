    ...
    <body>
        ...
        <main>
            <div class="col-md-8" style="margin-left: 30px;margin-bottom: 80px">
                <span class="bold" style="float:right;margin-top:-5px">COD: <?php echo e($id); ?> - <?php echo e($year); ?></span><br>
                <span class="bold">Estimado/a <?php echo e($customer); ?>,</span><br>
                <hr>
...
<?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\pdf.blade.php ENDPATH**/ ?>