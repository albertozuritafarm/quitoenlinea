            ...
            <form id="firstStepForm" name="firstStepForm" method="POST" action="<?php echo e(asset('/user')); ?>" id="salesForm">
                     ...
                     <div class="">
                            <div class="form-row">
                                    ...
                                    <label class="registerForm" for="spouse_document_id"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff"></span>Fecha de Constitución: </label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                        <input type="text" id="fecha_constitucion" name="fecha_constitucion" class="form-control registerForm" required tabindex="5" placeholder="fecha de constitución" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input  type="text" id="ruc" name="ruc" class="form-control registerForm" required tabindex="6" placeholder="Número de Identificación" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->document); ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                    <label class="registerForm" for="objeto_social"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff"></span>Objeto Social:  </label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                        <input type="text" id="objeto_social" name="objeto_social" class="form-control registerForm" required tabindex="7" placeholder="fecha de constitución" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <label class="registerForm" for="spouse_document_id"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff"></span>Ingresos brutos anuales de la compañía:  </label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                        <input type="text" id="ingresos_brutos" name="ingresos_brutos" class="form-control registerForm" required tabindex="9" placeholder="fecha de constitución" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30">
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input  type="text" id="actividad_economica" name="actividad_economica" class="form-control registerForm" required tabindex="8" placeholder="Número de Identificación" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->document); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <tr>
                                        <td id="tipo_empresa">Pública</td><td id="tipo_empresa"> <input  type="checkbox"   id="publica" name="publica" value="Empresa Pública" class="form-control move-left" required tabindex="13" placeholder="Empresa Pública" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->document); ?>"></td><td id="tipo_empresa"></td><td id="tipo_empresa"></td><td id="tipo_empresa"></td><td id="tipo_empresa"></td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <div class="form-group col-md-6">
                                        ...
                                        <table><tr>
                                        <td id="tipo_empresa">M</td><td id="tipo_empresa"> <input  type="checkbox"   id="masculino" name="masculino" value="masculino" class="form-control move-left" required tabindex="10" placeholder="masculino" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->document); ?>"></td><td></td><td></td>
                                        </tr> 
                                        <tr>
                                        <td id="tipo_empresa">F</td><td id="tipo_empresa"> <input  type="checkbox"   id="femenino" name="femenino" value="femenino" class="form-control move-left" required tabindex="11" placeholder="Compania Limitada" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->document); ?>"></td><td id="tipo_empresa"></td><td id="tipo_empresa"></td>
                                        </tr>
                                      </table>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <table><tr>
                                        <td id="tipo_empresa">SI</td><td id="tipo_empresa"> <input  type="checkbox"   id="SI" name="SI" value="SI" class="form-control move-left" required tabindex="10" placeholder="SI/NO" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->document); ?>"></td><td></td><td></td>
                                        </tr> 
                                        <tr>
                                        <td id="tipo_empresa">NO</td><td id="tipo_empresa"> <input  type="checkbox"   id="NO" name="NO" value="NO" class="form-control move-left" required tabindex="11" placeholder="SI/NO" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->document); ?>"></td><td id="tipo_empresa"></td><td id="tipo_empresa"></td>
                                        </tr>
                                      </table>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="representante_profesion" name="representante_profesion" class="form-control registerForm" required tabindex="8" placeholder="profesión" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->document); ?>">
                                    </div>
                                </div>
                            </div>
                            </div>
                ...
                <div id="beneficiaryFullDiv" class="col-xs-12 col-md-12 border" style="padding-left:0px !important;">
                    ...
                    <div id="beneficiaryDiv" class="col-md-12">
                        ...
                        <tr>
                        <td style="width:33%" colspan="3"><input type="text" id="nombre_compania_seguros_1" name="nombre_compania_seguros_1" class="form-control registerForm" required tabindex="7" placeholder="Nombre Companía de Seguros" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="fecha_indeminizacion_1" name="fecha_indeminizacion_1" class="form-control registerForm" required tabindex="7" placeholder="Fecha de Indemnización" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="descripcion_bien_1" name="descripcion_bien_1" class="form-control registerForm" required tabindex="7" placeholder="Descripción del bien indemnizado" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="valor_indeminizacion_1" name="valor_indeminizacion_1" class="form-control registerForm" required tabindex="7" placeholder="Valor de la indemnización" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                          
                        </tr>
                        <tr>
                        <td style="width:33%" colspan="3"><input type="text" id="nombre_compania_seguros_2" name="nombre_compania_seguros_2" class="form-control registerForm" required tabindex="7" placeholder="Nombre Companía de Seguros" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="fecha_indeminizacion_2" name="fecha_indeminizacion_2" class="form-control registerForm" required tabindex="7" placeholder="Fecha de Indemnización" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="descripcion_bien_2" name="descripcion_bien_2" class="form-control registerForm" required tabindex="7" placeholder="Descripción del bien indemnizado" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="valor_indeminizacion_2" name="valor_indeminizacion_2" class="form-control registerForm" required tabindex="7" placeholder="Valor de la indemnización" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                      
                        </tr>
                        <tr>
                        <td style="width:33%" colspan="3"><input type="text" id="nombre_compania_seguros_3" name="nombre_compania_seguros_3" class="form-control registerForm" required tabindex="7" placeholder="Nombre Companía de Seguros" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="fecha_indeminizacion_3" name="fecha_indeminizacion_3" class="form-control registerForm" required tabindex="7" placeholder="Fecha de Indemnización" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="descripcion_bien_3" name="descripcion_bien_3" class="form-control registerForm" required tabindex="7" placeholder="Descripción del bien indemnizado" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="valor_indeminizacion_3" name="valor_indeminizacion_3" class="form-control registerForm" required tabindex="7" placeholder="Valor de la indemnización" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                          
                        </tr>
                        <tr>
                        <td style="width:33%" colspan="3"><input type="text" id="nombre_compania_seguros_4" name="nombre_compania_seguros_4" class="form-control registerForm" required tabindex="7" placeholder="Nombre Companía de Seguros" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="fecha_indeminizacion_4" name="fecha_indeminizacion_4" class="form-control registerForm" required tabindex="7" placeholder="Fecha de Indemnización" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="descripcion_bien_4" name="descripcion_bien_4" class="form-control registerForm" required tabindex="7" placeholder="Descripción del bien indemnizado" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
                        <td style="width:33%" colspan="3"><input type="text" id="valor_indeminizacion_4" name="valor_indeminizacion_4" class="form-control registerForm" required tabindex="7" placeholder="Valor de la indemnización" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->first_name); ?>" maxlength="30"></td>
...
<?php echo $__env->make('layouts.remote_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\magnussucre\resources\views/massivesVinculation/beneficiaryPerson/create.blade.php ENDPATH**/ ?>