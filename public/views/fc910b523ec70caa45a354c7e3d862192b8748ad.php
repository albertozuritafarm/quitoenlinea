                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="rol_entity" id="rol_entity">
                            ...
                            <?php $__currentLoopData = $rolEntity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="rol_type" id="rol_type">
                            <option value="">-- Escoja Una--</option>
                            <?php $__currentLoopData = $rolType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($rol->id); ?>"><?php echo e($rol->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>                    
                    </div>
                                    ...
                                    <?php if($secondary->parent_id == $main->id): ?>
                                        ...
                                        <?php if($third->parent_id == $secondary->id): ?>
                                            <tr>
                                                ...
                                                <td align="center"><input type="checkbox" id="third_view_<?php echo e($main->id); ?>_<?php echo e($third->id); ?>"  class="chk child_third_view_<?php echo e($secondary->id); ?>" name="third_view_<?php echo e($main->id); ?>[]" value="<?php echo e($third->id); ?>_view" onchange="chkThirdChange('secondary','view',<?php echo e($third->id); ?>,<?php echo e($main->id); ?>,<?php echo e($secondary->id); ?>)"></td>
                                                <td align="center"><input type="checkbox" id="third_edit_<?php echo e($main->id); ?>_<?php echo e($third->id); ?>"  class="chk child_third_edit_<?php echo e($secondary->id); ?>" name="third_edit_<?php echo e($main->id); ?>[]" value="<?php echo e($third->id); ?>_edit" onchange="chkThirdChange('secondary','edit',<?php echo e($third->id); ?>,<?php echo e($main->id); ?>,<?php echo e($secondary->id); ?>)" <?php if((checkPermits($third->id, 'edit')) == false): ?> disabled="disabled" <?php endif; ?>></td>
                                                <td align="center"><input type="checkbox" id="third_cancel_<?php echo e($main->id); ?>_<?php echo e($third->id); ?>"  class="chk child_third_cancel_<?php echo e($secondary->id); ?>" name="third_cancel_<?php echo e($main->id); ?>[]" value="<?php echo e($third->id); ?>_cancel" onchange="chkThirdChange('secondary','cancel',<?php echo e($third->id); ?>,<?php echo e($main->id); ?>,<?php echo e($secondary->id); ?>)"  <?php if((checkPermits($third->id, 'cancel')) == false): ?> disabled="disabled" <?php endif; ?>></td>
                                                <td align="center"><input type="checkbox" id="third_create_<?php echo e($main->id); ?>_<?php echo e($third->id); ?>"  class="chk child_third_create_<?php echo e($secondary->id); ?>" name="third_create_<?php echo e($main->id); ?>[]" value="<?php echo e($third->id); ?>_create" onchange="chkThirdChange('secondary','create',<?php echo e($third->id); ?>,<?php echo e($main->id); ?>,<?php echo e($secondary->id); ?>)" <?php if((checkPermits($third->id, 'create')) == false): ?> disabled="disabled" <?php endif; ?>></td>
                                            </tr>
                                        <?php else: ?>
                                        <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\rols\create.blade.php ENDPATH**/ ?>