<script src="<?php echo e(assets('js/sales/R1/emitVehicleNew.js')); ?>"></script>
...
<div class="col-md-8 col-md-offset-2 border">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-1 wizard_inicial"><div style="margin-left:-10px" class="wizard_inactivo registerForm"></div></div>
        <div class="col-xs-12 col-md-3 wizard_medio"><div  class="wizard_inactivo registerForm">Resumen</div></div>
        <div class="col-xs-12 col-md-4 wizard_medio"><div id="firstStepWizard" class="wizard_activo registerForm">Vehiculo</div></div>
        <div class="col-xs-12 col-md-3 wizard_medio"><div id="secondStepWizard" class="wizard_inactivo registerForm">Emisión</div></div>
        <div class="col-xs-12 col-md-1 wizard_final"><div style="margin-right:-10px" class="wizard_inactivo registerForm"></div></div>
    </div>
        ...
        <div class="col-md-12">
            <div class="col-md-12" style="margin-top:5px;padding-top:15px;">
                ...
                <div class="row" style="float:right">
                    ...
                    <a class="btn btn-info registerForm" align="right"  href="#" onclick="validateFirstStep()"> Siguiente <span class="glyphicon glyphicon-step-forward"></span></a>
                </div>
            </div>
            <div id="vehiFormFullDiv" class="col-xs-12 col-md-12 border" style="padding-left:0px !important;; margin-top:10px;">
                <div class="wizard_activo registerForm titleDivBorderTop" onclick="fadeToggle('vehiFormDiv')">
                    <a href="#" class="titleLink">Datos del Vehiculo</a>
                    <span style="float:right;margin-right:1%;margin-top: 4px;" class="glyphicon glyphicon-chevron-down"></span>
                </div>
                <div id="vehiFormDiv" class="col-md-12" style="padding-top: 25px;padding-bottom: 25px;">
                    <?php echo $vehiForm; ?>
            ...
            <div class="col-md-12" style="padding-bottom:15px">
                ...
                <div class="row" style="float:right">
                    ...
                    <a class="btn btn-info registerForm" href="#" onclick="validateFirstStep()"> Siguiente <span class="glyphicon glyphicon-step-forward"></span></a>
                </div>
            </div>
        </div>
    </div>
    <div id="secondStep" class="col-md-12 hidden">
        <div class="col-md-12">
            <div class="col-md-12" style="margin-top:5px;padding-top:15px;">
                ...
                <div class="row" style="float:right">
                    <a onclick="nextStep('secondStep','firstStep')" class="btn btn-back registerForm" align="right" href="#"><span class="glyphicon glyphicon-step-backward"></span> Anterior </a>
                    ...
                    <form>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" min="<?php echo e($minDate); ?>" max="<?php echo e($maxDate); ?>" name="beginDate" id="beginDate"  onkeydown="return false"  placeholder="Correo" <?php if($newVehicle == 'false'): ?> value='<?php echo e($beginDate); ?>' <?php else: ?> value='' <?php endif; ?> style="line-height:14px" onchange="removeInputRedFocus('beginDate'), changeEndDate(this.value)" <?php echo e($disabled); ?>>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" name="endDate" id="endDate" placeholder="Correo" <?php if($newVehicle == 'false'): ?> value='<?php echo e($endDate); ?>' <?php else: ?> value='' <?php endif; ?> style="line-height:14px" onchange="removeInputRedFocus('endDate')" disabled="disabled">
                            </div>
                        </div>
                    </form>
                </div>
                            ...
                            <div id="endosoDiv">
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-inline">
                                            <input autocomplete="off" type="text" class="form-control registerForm" name="document" id="document" value="" <?php if($disabled): ?> disabled="disabled" <?php else: ?> <?php endif; ?> placeholder="Cédula" required="required"tabindex="1" style="width:89%" onclick="clearFormEndoso()" onchange="clearFormEndoso()">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="endorsementAmount" id="endorsementAmount"value="" style="line-height:14px" onchange="" placeholder="Monto Endoso Beneficiario" maxlength="15">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12" style="padding-bottom:15px">
                ...
                <div class="row" style="float:right">
                    <a onclick="nextStep('secondStep','firstStep')" class="btn btn-back registerForm" href="#"><span class="glyphicon glyphicon-step-backward"></span> Anterior </a>
...
<div id="vehiModalEditModal" class="modal fade" role="dialog">
  ...
  </div><?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\R1\emitVehicleNew.blade.php ENDPATH**/ ?>