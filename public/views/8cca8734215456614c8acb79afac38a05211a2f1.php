...
<script src="<?php echo e(assets('js/vinculation/pn/v4.js')); ?>"></script>
    ...
    <div class="col-xs-12 col-md-10 col-md-offset-1 border" style="padding: 15px;">
            ...
            <form id="firstStepForm" name="firstStepForm" method="POST" action="<?php echo e(asset('/user')); ?>" id="salesForm">
                        ...
                        <div class="">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="first_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Primer Nombre </label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="document_id"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Primer Apellido </label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="first_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Segundo Nombre </label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="document_id"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Segundo Apellido </label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="document_id"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Número de Identificación</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="nationality"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> País de Nacimiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <select id="nationality" name="nationality"  class="form-control registerForm" required onchange="removeInputRedFocus(this.id)" disabled="disabled" tabindex="7">
                                    <?php endif; ?>
                                        <option value="">--Escoja Una--</option>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="birth_city"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Ciudad de Nacimiento </label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="birth_date"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de Nacimiento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="date" id="birth_date" name="birth_date" class="form-control registerForm" style="line-height: 15px !important" onchange="removeInputRedFocus(this.id)" value="<?php echo e($birth_date); ?>" <?php if($birth_date != null): ?> readonly="readonly" <?php endif; ?> tabindex="9">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="civilState"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Estado Civil</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="document_id"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Provincia  </label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="document_id"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Cantón</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="main_road"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Calle Principal</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="sector"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> N°</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="main_road"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Calle Transversal</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="sector"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Sector</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="email"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Correo</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="mobile_phone"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Teléfono Celular</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="phone"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Teléfono</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                    ...
                    <div id="passportDiv" class="col-md-12">
                        <div class="col-md-12" style="margin-bottom: -25px">
                            <div class="col-md-6 form-group" style="margin-left:-15px">
                                <label class="registerForm" for="passportNumber"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Número de Pasaporte</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="registerForm" for="passportBeginDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de Emisión</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="registerForm" for="passportEndDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de Caducidad</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                        ...
                        <div class="col-md-12" style="margin-top: -25px">
                            <div id=""  class="col-md-6 form-group" style="margin-left:-15px">
                                <label class="registerForm" for="migratoryState"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Estado migratorio o Código de VISA:</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                            ...
                            <div class="col-md-6 form-group" style="float:right; margin-right: -15px;width:52%">                                
                                <label class="registerForm" for="passportEntryDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Fecha de Ingreso al país</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                ...
                <div id="spouseFullDiv" class="col-xs-12 col-md-12 border" style="padding-left:0px !important;margin-bottom: 5px">
                    ...
                    <div id="spouseDiv" class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="registerForm" for="passportBeginDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Documento de Identidad Cónyuge</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                <input type="text" id="spouseDocument" name="spouseDocument" class="form-control registerForm" required tabindex="21"  style="line-height: 15px !important;" value="<?php echo e($spouse_document); ?>" placeholder="Documento de Identidad Cónyuge" onchange="removeInputRedFocus(this.id)" <?php echo e($disable_status); ?>>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="registerForm" for="spouse_document_id"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Tipo Documento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                <select id="spouse_document_id" name="spouse_document_id" class="form-control registerForm" required tabindex="22" onchange="removeInputRedFocus(this.id),validateDocumentSpouse()" <?php echo e($disable_status); ?>>
                                    <option selected="true" value="">--Escoja Una---</option>
                                    <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="registerForm" for="passportEndDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombre(s) del Cónyuge</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                <input type="text" id="spouseFirstName" name="spouseFirstName" class="form-control registerForm" required tabindex="23"  style="line-height: 15px !important" value="<?php echo e($spouse_name); ?>" placeholder="Nombre del Cónyuge" onchange="removeInputRedFocus(this.id)" <?php echo e($disable_status); ?> maxlength="60">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="registerForm" for="passportEndDate"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Apellido(s) del Cónyuge </label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                <input type="text" id="spouseLastName" name="spouseLastName" class="form-control registerForm" required tabindex="24"  style="line-height: 15px !important" value="<?php echo e($spouse_last_name); ?>" placeholder="Apellido(s) del Cónyuge" onchange="removeInputRedFocus(this.id)" value="<?php echo e($spouse_last_name); ?>" <?php echo e($disable_status); ?> maxlength="30">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label class="registerForm" for="beneficiaryName"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombres Completos o Razón Social</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label class="registerForm" for="beneficiary_document"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Documento de Identidad</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="registerForm" for="beneficiary_document_id"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Tipo Documento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label class="registerForm" for="beneficiary_nationality"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nacionalidad</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="registerForm" for="beneficiary_address"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Dirección de Domicilio</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                        <input type="text2" id="beneficiary_address" name="beneficiary_address" class="form-control registerForm" required tabindex="33"  style="line-height: 15px !important" value="<?php echo e($beneficiary_address); ?>" placeholder="Dirección de Domicilio" onchange="removeInputRedFocus(this.id)" <?php echo e($disable_status); ?> maxlength="200">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label class="registerForm" for="beneficiary_phone"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Teléfono</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="registerForm" for="beneficiary_relationship"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Relación</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
        ...
        <div id="secondStep" class="col-md-12 hidden" style="margin-top:20px">
            <form id="secondStepForm" name="secondStepForm" method="POST" action="<?php echo e(asset('/user')); ?>" id="salesForm">
                ...
                <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;margin-bottom: 5px">
                    ...
                    <div id="occupationDiv" class="col-md-12">
                        <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="annual_income"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Ingresos Anuales</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="annual_income" name="annual_income" class="form-control registerForm" required tabindex="11" placeholder="Ingresos Anuales" onchange="removeInputRedFocus(this.id)" value="<?php echo e($annual_income); ?>" <?php echo e($disable_status); ?> maxlength="15">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="other_annual_income"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Otros Ingresos Anuales</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="other_annual_income" name="other_annual_income" class="form-control registerForm" required tabindex="12" placeholder="Otros Ingresos Anuales" onchange="removeInputRedFocus(this.id)" value="<?php echo e($other_annual_income); ?>" <?php echo e($disable_status); ?> maxlength="15">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="main_road"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Total Ingresos</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="total_annual_income" name="total_annual_income" class="form-control registerForm" required tabindex="13" placeholder="Total Ingresos" onchange="removeInputRedFocus(this.id)" value="<?php echo e($total_annual_income); ?>" readonly maxlength="15">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="description_other_income"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Descripción de otros Ingresos</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="description_other_income" name="description_other_income" class="form-control registerForm" required tabindex="14" placeholder="Descripción de otros Ingresos" maxlength="60" onchange="removeInputRedFocus(this.id)" value="<?php echo e($description_other_income); ?>" <?php echo e($disable_status); ?>>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="total_assets"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Total de Activos USD</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="total_assets" name="total_assets" class="form-control registerForm" required tabindex="17" placeholder="Total Activos USD" onchange="removeInputRedFocus(this.id)" value="<?php echo e($total_assets); ?>" <?php echo e($disable_status); ?> maxlength="15">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="total_passives"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Total de Pasivos USD</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="total_passives" name="total_passives" class="form-control registerForm" required tabindex="18" placeholder="Total de Pasivos USD" onchange="removeInputRedFocus(this.id)" value="<?php echo e($total_pasives); ?>" <?php echo e($disable_status); ?> maxlength="15">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="total_assets_pasives"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Total Patrimonio (A-P)</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="total_assets_pasives" name="total_assets_pasives" class="form-control registerForm" required tabindex="19" placeholder="Total Patrimonio (A-P)" onchange="removeInputRedFocus(this.id)" value="<?php echo e($total_assets_pasives); ?>" readonly maxlength="15">
                                </div>
                                <div class="form-group col-md-6">
                                </div>
                            </div>
                        ...
                        <div class="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label class="registerForm" for="personal_reference_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombre</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="personal_reference_name" name="personal_reference_name" class="form-control registerForm" required tabindex="20" placeholder="Nombre" onchange="removeInputRedFocus(this.id)" value="<?php echo e($personal_reference_name); ?>" <?php echo e($disable_status); ?>>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="registerForm" for="personal_reference_relationship"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Parentesco</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="personal_reference_relationship" name="personal_reference_relationship" class="form-control registerForm" required tabindex="21" placeholder="Parentesco" onchange="removeInputRedFocus(this.id)" value="<?php echo e($personal_reference_relationship); ?>" <?php echo e($disable_status); ?>>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text2" id="personal_reference_phone" name="personal_reference_phone" class="form-control registerForm" required tabindex="22" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" value="<?php echo e($personal_reference_phone); ?>" <?php echo e($disable_status); ?> maxlength="9">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label class="registerForm" for="commercial_reference_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Entidad</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="commercial_reference_name" name="commercial_reference_name" class="form-control registerForm" required tabindex="23" placeholder="Entidad" onchange="removeInputRedFocus(this.id)" value="<?php echo e($commercial_reference_name); ?>" <?php echo e($disable_status); ?>>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="registerForm" for="commercial_reference_amount"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Monto</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="commercial_reference_amount" name="commercial_reference_amount" class="form-control registerForm" required tabindex="24" placeholder="Monto" onchange="removeInputRedFocus(this.id), currencyFormat(this.id)" value="<?php echo e($commercial_reference_amount); ?>" <?php echo e($disable_status); ?> maxlength="15">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="registerForm" for="commercial_reference_phone"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Teléfono</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="commercial_reference_phone" name="commercial_reference_phone" class="form-control registerForm" required tabindex="25" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" value="<?php echo e($commercial_reference_phone); ?>" <?php echo e($disable_status); ?> maxlength="9">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="commercial_reference_bank_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Institución Financiera</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="commercial_reference_bank_name" name="commercial_reference_bank_name" class="form-control registerForm" required tabindex="26" placeholder="Instirución Financiera" onchange="removeInputRedFocus(this.id)" value="<?php echo e($commercial_reference_bank_name); ?>" <?php echo e($disable_status); ?>>
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="registerForm" for="commercial_reference_product"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Producto</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="commercial_reference_product" name="commercial_reference_product" class="form-control registerForm" required tabindex="27" placeholder="Producto" onchange="removeInputRedFocus(this.id)" value="<?php echo e($commercial_reference_product); ?>" <?php echo e($disable_status); ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;margin-bottom: 5px">
                    <div class="wizard_activo registerForm titleDiv" onclick="fadeToggle('workDataDiv')">
                        <a href="#" class="titleLink">Datos Laborales</a>
                        <span style="float:right;margin-right:1%;margin-top: 4px;" class="glyphicon glyphicon-chevron-down"></span>
                    </div>
                    <div id="workDataDiv" class="col-md-12">
                        <div class="">
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    <label class="registerForm" for="work_name"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Nombre Empresa donde trabaja</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="work_name" name="work_name" class="form-control registerForm" required tabindex="28" placeholder="Nombre Empresa donde trabaja" onchange="removeInputRedFocus(this.id)" value="<?php echo e($work_name); ?>" <?php echo e($disable_status); ?> maxlength="60">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="registerForm" for="work_phone"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Teléfono Trabajo</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="work_phone" name="work_phone" class="form-control registerForm" required tabindex="29" placeholder="Teléfono Trabajo" onchange="removeInputRedFocus(this.id)" value="<?php echo e($work_phone); ?>" <?php echo e($disable_status); ?> maxlength="9">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label class="registerForm" for="work_address"><span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span> Dirección Trabajo</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <input type="text2" id="work_address" name="work_address" class="form-control registerForm" required tabindex="30" placeholder="Dirección Trabajo" onchange="removeInputRedFocus(this.id)" value="<?php echo e($work_address); ?>" <?php echo e($disable_status); ?> maxlength="225">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12" style="margin-top:5px;padding-top:15px;padding-bottom:15px">
                    ...
                    <div class="row" style="float:right">
                        <a id="secondStepBtnBack" class="btn btn-back registerForm" align="right" href="#" tabindex="31"><span class="glyphicon glyphicon-step-backward"></span> Anterior </a>
                        <a id="secondStepBtnNext" class="btn btn-info registerForm" align="right" href="#" tabindex="32"> Siguiente <span class="glyphicon glyphicon-step-forward"></span></a>
                    </div>
                </div>
            </form>
        </div>
        <div id="thirdStep" class="col-md-12 hidden" style="margin-top:30px">
            <form id="thirdStepForm" name="thirdStepForm" method="POST" action="<?php echo e(asset('/user')); ?>" id="salesForm">
                ...
                <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;margin-bottom: 5px;margin-top:30px;">
                    ...
                    <div id="pepDeclarationDiv" class="col-md-12">
                        <div class="" style="margin-top:15px;text-align: justify; font-size: 14px;margin-bottom: 10px;">
                            <div class="col-md-12" style="margin-top:25px;">
                                <div class="form-group">
                                    <h4>Declaración</h4>
                                </div>
        ...
        <div id="fourthStep" class="col-md-12 hidden" style="margin-top:20px">
            ...
            <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;margin-bottom: 5px">
                ...
                <div id="picturesDiv" class="col-md-12" style="margin-top:15px;">
                    <div class="col-md-6" style="margin: 5px 0;">
                        <form class="col-md-12 border" method="post" id="upload_formDocumentApplicant" name="upload_formDocumentApplicant" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formDocumentApplicant'" style="min-height:350px !important">
                            <?php echo e(csrf_field()); ?>    
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="DocumentApplicantDate" name="DocumentApplicantDate" class="form-control" style="line-height:14px;" required="required" value="<?php echo e($document_applicant_date); ?>" <?php echo e($disable_status); ?>>
                            </div>
                            <div class="form-group" style="text-align: center;">
                                <label class="registerForm" style="word-wrap: break-word; padding-bottom: 5%;">Copia del documento de identidad del contratante</label>
                            </div>
                            ...
                            <center>
                                ...
                                <div class="inputWrapper"><span id="uploaded_imageDocumentApplicant"><?php echo $picture_document_applicant; ?></span>
                                    ...
                                    <input class="fileInput" type="file" name="select_fileDocumentApplicant" onchange="fileNameFunction('DocumentApplicant')" id="select_fileDocumentApplicant" <?php if($disable_status != null): ?> style="display:none" <?php endif; ?>>
                                </div>
                            </center>
                            <center>
                    ...
                    <div class="col-md-6" id="formDocumentSpouse" style="margin: 5px 0;">
                            <form class="col-md-12 border" method="post" id="upload_formDocumentSpouse" name="upload_formDocumentSpouse" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formDocumentSpouse'" style="min-height:350px !important">
                                ...
                                <div class="form-group">
                                    <span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span><label class="registerForm">Fecha de Caducidad</label>
                                    <input type="date" id="DocumentSpouseDate" name="DocumentSpouseDate" class="form-control" style="line-height:14px;" value="<?php echo e($document_spouse_date); ?>" <?php echo e($disable_status); ?>>
                                </div>    
                                <div class="form-group" style="text-align: center;">
                                ...
                                <center>
                                    ...
                                    <div class="inputWrapper"><span id="uploaded_imageDocumentSpouse"><?php echo $picture_document_spouse; ?></span>
                                        ...
                                        <input class="fileInput" type="file" name="select_fileDocumentSpouse" onchange="fileNameFunction('DocumentSpouse')" id="select_fileDocumentSpouse" <?php if($disable_status != null): ?> style="display:none" <?php endif; ?>>
                                    </div>
                                </center>
                                <center>
                            ...
                            <form class="col-md-12 border" method="post" id="upload_formService" name="upload_formService" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formService'" style="min-height:350px !important">
                                ...
                                <center>
                                    <div class="inputWrapper"><span id="uploaded_imageService"><?php echo $picture_service; ?></span>
                                        ...
                                        <input class="fileInput" type="file" name="select_fileService" onchange="fileNameFunction('Service')" id="select_fileService" <?php if($disable_status != null): ?> style="display:none" <?php endif; ?>>
                                    </div>
                                </center>
                                <center>
                        ...
                        <div class="col-md-6" style="margin: 5px 0;">
                            <form class="col-md-12 border" method="post" id="upload_formSri" name="upload_formSri" enctype="multipart/form-data" onsubmit="uploadPictureForm('upload_formSri'" style="min-height:350px !important">
                                ...
                                <input type="hidden" id="uploadedFileSri" name="uploadedFileSri" value="<?php echo e($picture_sri); ?>">
                                    <div class="form-group" style="padding-top:85px;text-align: center;">
                                        <label class="registerForm">Confirmación del pago de impuestos a la renta del año inmediato por el Servicio de Rentas Internas SRI</label>
                                    </div>
                                ...
                                <center>
                                    <div class="inputWrapper"><span id="uploaded_imageSri"><?php echo $picture_sri; ?></span>
                                        <center>
                                            <img src="<?php echo e(asset('images/mas.png')); ?>" alt="Girl in a jacket" style="width:20px;height:20px;margin-bottom: -100px;">
                                        </center>
                                ...
                                <center>
                                    ...
                                    <a class="<?php if($picture_sri == null): ?> hidden <?php else: ?> visible <?php endif; ?>" id="deletePictureSri" href="#" onclick="deletePictureForm('Sri','<?php echo e($customer->id); ?>','<?php echo e($sales_id); ?>')">
                                        <?php if($disable_status == null): ?>
                                            <img src="<?php echo e(asset('/images/menos.png')); ?>" style="width:20px;height:20px">
                                        <?php endif; ?>                                        
                                    </a>  
            ...
            <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;margin-bottom: 5px">
                <div class="wizard_activo registerForm titleDiv" onclick="fadeToggle('pepDeclarationDiv')">
                    <a href="#" class="titleLink">Terminos y Condiciones</a>
                    <span style="float:right;margin-right:1%;margin-top: 4px;" class="glyphicon glyphicon-chevron-down"></span>
                </div>
                <div id="pepDeclarationDiv" class="col-md-12">
            ...
            <div class="col-md-12" style="margin-top:5px;padding-top:15px;padding-bottom:15px">
                ...
                <div class="row" style="float:right">
                    <a id="fourthStepBtnBack" class="btn btn-back registerForm" align="right" href="#" tabindex="4"><span class="glyphicon glyphicon-step-backward"></span> Anterior </a>
                    <?php if($disable_status == null): ?>
                        <a id="fourthStepBtnNext" class="btn btn-info registerForm" align="right" href="#" tabindex="5"> Siguiente <span class="glyphicon glyphicon-step-forward"></span></a>
                    <?php endif; ?>
                </div>
            </div>
            <!--</form>-->
...
<?php echo $__env->make('layouts.remote_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views/vinculation/pn/v4.blade.php ENDPATH**/ ?>