...
<script src="<?php echo e(assets('js/insurance/create.js')); ?>"></script>
...
<div class="container-fluid" style="font-size:14px !important;padding-bottom: 15px;">
                ...
                <div id="firstStep" class="col-md-12">
                    <div class="col-md-12" style="margin-top:5px;margin-bottom: 5px;padding-top:15px;">
                        <div class="row" style="float:left">
                            <a class="btn btn-default registerForm" align="right" href="<?php echo e(asset('/insurance')); ?>"> Cancelar </a>
                        </div>
                        <div class="row" style="float:right">
                            <a id="secondStepBtnBackTop" class="btn btn-back registerForm" align="right" <?php if($disabled == null): ?> href="<?php echo e(asset('/insurance')); ?>" <?php else: ?> href="#" disabled="disabled" <?php endif; ?> ><span class="glyphicon glyphicon-step-backward"></span> Anterior </a>
    ...
    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
                    ...
                    <div class="col-md-12" style="padding-bottom:15px">
                        ...
                        <div class="row" style="float:right">
                            <a class="btn btn-back registerForm" align="right" <?php if($disabled == null): ?> href="<?php echo e(asset('/insurance')); ?>" <?php else: ?> href="#" disabled="disabled" <?php endif; ?> ><span class="glyphicon glyphicon-step-backward"></span> Anterior </a>
                    ...
                    <div class="col-xs-12 col-md-12 border" style="padding-left:0px !important;margin-bottom: 5px;">
                        ...
                        <div id="beneficiaryForm" class="col-md-12" style="padding-top: 25px;padding-bottom: 25px;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <span class="glyphicon glyphicon-asterisk" style="color:#0099ff">&ensp;</span><label class="registerForm" for="document_id"> Tipo Documento</label><span name="spanRequired" class="hidden" style="color:red;font-weight:bold"> * Requerido</span>
                                    <select id="document_idBeneficiary" name="document_idBeneficiary" class="form-control registerForm" value="<?php echo e(old('document_id')); ?>" required tabindex="2" disabled="disabled" onchange="documentIdChange(this.value)">
                                        <option selected="true" value="0">--Escoja Una---</option>
                                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\insurance\create.blade.php ENDPATH**/ ?>