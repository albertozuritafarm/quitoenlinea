...
<script src="<?php echo e(assets('js/agencies/create.js')); ?>"></script>
...
<div class="container" style="width: 100%">
    <div>
        <div class="col-md-12" style="margin-left: -15px">
            ...
            <?php endif; ?>
            <a type="button" href="<?php echo e(asset('/channel')); ?>" class="btn btn-default registerForm" >Volver</a> 
            <?php echo $__env->make('pagination.items', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <div id="tableData">
            <?php echo $__env->make('pagination.agencies', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
<form method="post" action="<?php echo e(asset('/agency/create')); ?>">
    ...
    <input type="hidden" id="channelId" name="channelId" value="<?php echo e($channelId); ?>">
    <button type="submit" class="hidden" id="btnFilterForm"></button>
</form>
<form method="post" action="<?php echo e(asset('/agency/edit')); ?>">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\agencies\create.blade.php ENDPATH**/ ?>