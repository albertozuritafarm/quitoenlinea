                            ...
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                ...
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 0px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: center;">
                                        <p style="margin: 10px 0 0 0"><a href="https://tupolizaenlineatest.segurossucre.fin.ec/sales/payments/create?document=<?php echo e($document); ?>&sales=<?php echo e($sale); ?>" target="_blank"><strong>Click Aqui</strong></a></p>
                                    </td>
                                </tr>
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 0px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: center;">
...
<?php echo $__env->make('layouts.email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\emails\paymentSendLinkUser.blade.php ENDPATH**/ ?>