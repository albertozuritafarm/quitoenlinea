    ...
    <!--                        <?php if($sale->status_id == 21 && $sale->hasRenew == null): ?>
                            ...
                            <?php if($sale->customer == null): ?>
                                <td align="center"><?php echo e($sale->rep); ?></td>
                                <td align="center"><?php echo e($sale->documentRep); ?></td>
                            <?php else: ?>
                            ...
                            <td align="center"><?php echo e($sale->updateDate); ?></td>
                            ...
                            <?php endif; ?>
                            <?php if($sale->customer == null): ?>
                                <?php if(in_array($sale->status_id, array(37))||(in_array($sale->status_id, array(34)))): ?>
                                ...
                                <?php else: ?>                                
                                    <a align="center" href="<?php echo e(asset('')); ?>massivesVinculation/legalPerson/form/<?php echo e(Crypt::encrypt($sale->salesId)); ?>')" data-toggle="tooltip" title="Formulario de Vinculación">
...
<?php /**PATH C:\xampp\htdocs\laravel\magnussucre\resources\views/pagination/massivesVinculation.blade.php ENDPATH**/ ?>