                            ...
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 30px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: justify;">
                                        ...
                                        <p style="margin: 10px 0 0 0;"><span style="font-weight: bold;color:rgb(0, 59, 113)">Seguros Sucre</span> te informa que el formulario de vinculación del cliente <span style="font-weight: bold;color:rgb(0, 59, 113)"><?php echo e($name); ?></span> correspondiente a la vinculación número <span style="font-weight: bold;color:rgb(0, 59, 113)"><?php echo e($id); ?></span>ha sido completado, ya puedes revisarlo en la plataforma de vinculación.</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
