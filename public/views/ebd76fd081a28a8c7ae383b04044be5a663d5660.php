        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-4 border" style="margin-top:10px">
                ...
                <div class="col-md-10 col-md-offset-1" style="margin-top:5px;padding-top:15px;padding-bottom:15px">
                    <form action="<?php echo e(route('remoteSendVehiLink')); ?>" method="POST">
                        <?php echo e(csrf_field()); ?>

                        <input type="hidden" id="salId" name="salId" value="<?php echo e($sale); ?>">
                        <input id="cancelBtn" type="submit" style="float:left;width:75px" class="btn btn-default registerForm" align="right" value="No">
                    </form>
                    <form action="<?php echo e(route('remoteVehiPictures')); ?>" method="POST">
                        <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.remote_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\remote\validate.blade.php ENDPATH**/ ?>