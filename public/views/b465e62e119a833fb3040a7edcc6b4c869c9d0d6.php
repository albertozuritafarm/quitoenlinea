                            ...
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                ...
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 0px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: center;">
                                        <p style="margin: 10px 0 0 0"><a href="https://tupolizaenlineatest.segurossucre.fin.ec/vinculation/create?document=<?php echo e($document); ?>&sales=<?php echo e($sale); ?>" target="_blank"><img src=" <?php echo e($message->embed(public_path('images/Email/Mail-Form_Vinculacion.png'))); ?>" width="25%" alt="Click Aqui"></a></p>
                                    </td>
                                </tr>
                                <tr bgcolor="Transparent" style="display: inherit;">
                                    <td style="padding: 0px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: justify;">
                                        <p>Los documentos base que deberás adjuntar son los siguientes: </p>
                                            <ul>
                                                <li>Cédula de identidad o documento de identificación</li>
                                                <li>Cédula de identidad o documento de identificación del cónyuge en caso de aplicar</li>
...
<?php echo $__env->make('layouts.email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\emails\vinculationFormSendLink.blade.php ENDPATH**/ ?>