                ...
                <div class="col-md-10 col-md-offset-1 border" style="margin-top:15px">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="address" id="address" placeholder="Dirección" value="<?php echo e(old('address')); ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="phone" id="phone" placeholder="Teléfono Fijo" value="<?php echo e(old('phone')); ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="mobile_phone" id="mobile_phone" placeholder="Teléfono Celular" value="<?php echo e(old('mobile_phone')); ?>" required>
