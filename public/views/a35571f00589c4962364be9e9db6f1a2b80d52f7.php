...
<script src="<?php echo e(assets('js/sales/R2/create.js')); ?>"></script>
            ...
            <form name="salesForm" method="POST" action="/user" id="salesForm">
                ...
                <div id="firstStep" class="col-md-12">
                            ...
                            <form>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="string" class="form-control registerForm" name="address" id="address" placeholder="Dirección" required tabindex="9" value="<?php echo e($customer->address); ?>" maxlength="200">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" class="form-control registerForm" name="email" id="email" placeholder="Correo" value="<?php echo e($customer->email); ?>" required tabindex="10" maxlength="100">
                    ...
                    <div class="col-md-12" style="padding-bottom:15px">
                        <div class="row" style="float:left">
                            <a class="btn btn-default registerForm" align="right" href="<?php echo e(asset('/sales')); ?>" tabindex="16"> Cancelar </a>
                        </div>
                        <div class="row" style="float:right">
                            <a class="btn btn-back registerForm" align="right" <?php if($disabled == null): ?> href="<?php echo e(asset('/sales/product/select')); ?>" <?php else: ?> href="#" disabled="disabled" <?php endif; ?>  tabindex="15"><span class="glyphicon glyphicon-step-backward"></span> Anterior </a>
                ...
                <div id="secondStep" class="col-md-12 hidden">
                    <div class="col-md-12" style="margin-top:5px;padding-top:15px;">
                        <div class="row" style="float:left">
                            <a class="btn btn-default registerForm" align="right" href="<?php echo e(asset('/sales')); ?>" tabindex="18"> Cancelar </a>
                        </div>
                        <div class="row" style="float:right">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\R2\create.blade.php ENDPATH**/ ?>