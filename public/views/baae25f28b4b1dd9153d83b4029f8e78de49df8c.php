<html>
    ...
    <body>
        ...
        <header>
            ...
            <center><strong class="bold" style="color:#183c6b;font-size: 14px;">N° COT-CASA HABITACIÓN-<?php echo e($year); ?>-<?php echo e($id); ?></strong></center>
        </header>
                ...
                <div style="padding-left: 10px;">
                    <table>
                        ...
                        <tr class='divData'>
                            ...
                            <td style="width:25%"><?php echo e($bienAsegurado[0]->main_street); ?></td>
                            <th style="width:25%">Calle Secundaria</th>
                            <td class='borderRight' style="width:25%"><?php echo e($bienAsegurado[0]->secondary_street); ?></td>
                        </tr>
                        <tr>
                            <th class='borderLeft' style="width:25%">Número</th>
                            <td style="width:25%"><?php echo e($bienAsegurado[0]->number); ?></td>
                            <th style="width:25%">Oficina/Departamento</th>
                            <td class='borderRight' style="width:25%"><?php echo e($bienAsegurado[0]->office_department); ?></td>
                        </tr>
                        <tr class='divData'>
                            <th class='borderLeft borderBottom' style="width:25%">Ciudad</th>
                            <td class='borderBottom' style="width:25%"><?php echo e($bienAsegurado[0]->name); ?></td>
                ...
                <div style="padding-left: 10px;">
                    <table style="border: 1px solid">
                        ...
                        <tr class="divData">
                            ...
                            <td class="borderRight" style="width:25%"><?php echo e($sales->super_bancos); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td class="borderRight" style="width:25%"><?php echo e($sales->derecho_emision); ?></td>
                        </tr>
                        <tr class="divData">
                            <th class="borderLeft borderBottom" style="width:25%">Iva 12%</th>
                            <td class="borderBottom" style="width:25%"><?php echo e($sales->tax); ?></td>
                            <th class="borderBottom" style="width:25%">Prima Total</th>
                            <td class="borderRight borderBottom" style="width:25%"><?php echo e($sales->total); ?></td>
                        </tr>
                    </table>
                    <hr>
                </div>
            ...
            <div>
                <hr>
                    <div style="width:100%;background-color: white;color:#183c6b;font-size:14px;font-weight: bold;line-height: 20px; height:25px;">
                        <span><center><h1><?php echo e($proName); ?></h1></center></span>
                    </div>
                <hr>
            </div>
            <!-- COBERTURAS -->
...
<?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\R4\pdf_quotation.blade.php ENDPATH**/ ?>