...
<script src="<?php echo e(assets('js/vinculation/pj/v5.js')); ?>"></script>
                    ...
                    <div id="personalDiv" class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="documentForm" type="text" id="documentCompany" name="documentCompany" class="form-control registerForm" required tabindex="2" placeholder="Número de Identificación" disabled="disabled" onchange="removeInputRedFocus(this.id)" value="<?php echo e($customer->document); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" style="margin-top:-25px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="main_roadCompany" name="main_roadCompany" class="form-control registerForm" required tabindex="2" placeholder="Calle Principal" onchange="removeInputRedFocus(this.id)" value="<?php echo e($main_road); ?>" <?php echo e($disable_status); ?>>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="numberCompany" name="numberCompany" class="form-control registerForm" required tabindex="2" placeholder="N°" onchange="removeInputRedFocus(this.id)" value="<?php echo e($address_number); ?>" <?php echo e($disable_status); ?>>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="cityCompany" name="cityCompany" class="form-control registerForm" required tabindex="2" onchange="removeInputRedFocus(this.id)" <?php echo e($disable_status); ?>>
                                    <option value="">--Escoja Una---</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="mobile_phoneCompany" name="mobile_phoneCompany" class="form-control registerForm" required tabindex="2" placeholder="Celular" onchange="removeInputRedFocus(this.id)" value="<?php echo e($mobile_phone); ?>" <?php echo e($disable_status); ?>>
                            </div>
                        </div>
                        <div class="col-md-6" style="margin-top:-25px;">
                            <div class="form-group">
                                ...
                                <input type="date" id="constitution_dateCompany" name="constitution_dateCompany" class="form-control registerForm" style="line-height: 15px !important" onchange="removeInputRedFocus(this.id)" value="<?php echo e($birth_date); ?>" <?php if($birth_date != null): ?> readonly="readonly" <?php endif; ?>>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="secondary_roadCompany" name="secondary_roadCompany" class="form-control registerForm" required tabindex="2" placeholder="Calle Transversal" onchange="removeInputRedFocus(this.id)" value="<?php echo e($secondary_road); ?>" <?php echo e($disable_status); ?>>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="sectorCompany" name="sectorCompany" class="form-control registerForm" required tabindex="2" placeholder="Sector" onchange="removeInputRedFocus(this.id)" value="<?php echo e($sector); ?>" <?php echo e($disable_status); ?>>
                            </div>
                            <div class="form-group">
                                ...
                                <select id="provinceCompany" name="provinceCompany" class="form-control registerForm" required tabindex="2" onchange="removeInputRedFocus(this.id)" <?php echo e($disable_status); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="emailCompany" name="emailCompany" class="form-control registerForm" required tabindex="2" placeholder="Correo" onchange="removeInputRedFocus(this.id)" value="<?php echo e($email); ?>" <?php echo e($disable_status); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="phoneCompany" name="phoneCompany" class="form-control registerForm" required tabindex="2" placeholder="Teléfono" onchange="removeInputRedFocus(this.id)" value="<?php echo e($phone); ?>" <?php echo e($disable_status); ?>>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="customerForm">
                            <div class="col-md-6">
                                <div class="form-group form-inline">
                                    ...
                                    <div class="form-inline">
                                        <input autocomplete="off" type="text" class="form-control registerForm" name="document" id="document" placeholder="Cédula" required="required"tabindex="1" style="width:88%" value="<?php echo e(old('document')); ?>" onkeyup="removeErrorMsg('Document')" onchange="removeInputRedFocus(this.id)">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control registerForm" name="first_name" id="first_name" placeholder="Primer Nombre" value="<?php echo e(old('first_name')); ?>" required="required" tabindex="3" onkeyup="removeErrorMsg('FirstName')" onchange="removeInputRedFocus(this.id)">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control registerForm" name="second_name" id="second_name" placeholder="Segundo Nombre" value="<?php echo e(old('second_name')); ?>" required="required" tabindex="3" onkeyup="removeErrorMsg('FirstName')" onchange="removeInputRedFocus(this.id)">
                                    <?php if(session('errorSecondName')): ?> <p id="errorMsgSecondName" style="color:red;font-weight: bold"><?php echo e(session('errorSecondName')); ?></p> <?php endif; ?>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="date" id="birth_date" name="birth_date" class="form-control registerForm" style="line-height: 15px !important" onchange="removeInputRedFocus(this.id)" value="<?php echo e($birth_date); ?>" <?php if($birth_date != null): ?> readonly="readonly" <?php endif; ?> tabindex="8" onchange="removeInputRedFocus(this.id)">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control registerForm" name="mobile_phone" id="mobile_phone" placeholder="Celular" value="<?php echo e(old('mobile_phone')); ?>" required tabindex="5" onkeyup="removeErrorMsg('MobilePhone')" onchange="removeInputRedFocus(this.id)">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control registerForm" name="address" id="address" placeholder="Direccion" required tabindex="7" value="<?php echo e(old('address')); ?>" onkeyup="removeErrorMsg('Address')" onchange="removeInputRedFocus(this.id)">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="document_id" name="document_id" class="form-control registerForm" value="<?php echo e(old('document_id')); ?>" required tabindex="2" onchange="removeInputRedFocus(this.id)">
                                        <option value="">--Escoja Una---</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control registerForm" name="last_name" id="last_name" placeholder="Primer Apellido" value="<?php echo e(old('last_name')); ?>" required tabindex="4" onkeyup="removeErrorMsg('LastName')" onchange="removeInputRedFocus(this.id)">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control registerForm" name="second_last_name" id="second_last_name" placeholder="Segundo Apellido" value="<?php echo e(old('last_name')); ?>" required tabindex="4" onkeyup="removeErrorMsg('LastName')" onchange="removeInputRedFocus(this.id)">
                                    <?php if(session('errorSecondLastName')): ?> <p id="errorMsgSecondlastName" style="color:red;font-weight: bold"><?php echo e(session('errorSecondLastName')); ?></p> <?php endif; ?>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control registerForm" name="phone" id="phone" placeholder="Teléfono" value="<?php echo e(old('phone')); ?>" required tabindex="6" onkeyup="removeErrorMsg('Phone')" onchange="removeInputRedFocus(this.id)">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control registerForm" name="email" id="email" placeholder="Correo" value="<?php echo e(old('email')); ?>" required tabindex="8" onkeyup="removeErrorMsg('Email')" onchange="removeInputRedFocus(this.id)">
                                    <p id="emailError" style="color:red;font-weight: bold"></p>    
                                    <?php if($errors->any()): ?>
                    ...
                    <div id="spouseDiv" class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="spouseFirstName" name="spouseFirstName" class="form-control registerForm" required tabindex="28"  style="line-height: 15px !important" value="<?php echo e($spouse_name); ?>" placeholder="Nombre del Conyuge" onchange="removeInputRedFocus(this.id)" <?php echo e($disable_status); ?>>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="spouseLastName" name="spouseLastName" class="form-control registerForm" required tabindex="28"  style="line-height: 15px !important" value="<?php echo e($spouse_last_name); ?>" placeholder="Apellido(s) del Conyuge" onchange="removeInputRedFocus(this.id)" value="<?php echo e($spouse_last_name); ?>" <?php echo e($disable_status); ?>>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.remote_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\vinculation\pj\v5.blade.php ENDPATH**/ ?>