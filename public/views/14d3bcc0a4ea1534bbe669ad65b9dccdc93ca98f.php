                            ...
                            <tbody style="display: block; border: 0px none rgb(96, 96, 96); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-color: rgba(0, 0, 0, 0);">
                                <tr bgcolor="Transparent" style="display: inherit;">
									<td style="padding: 30px 10px 30px 14px; display: inherit; color: rgb(96, 96, 96); text-align: justify;">
                                        ...
                                        <p style="margin: 10px 0 0 0;">Seguros Sucre te informa que el pago del cliente <span style="font-weight: bold"> <?php echo e($customer[0]->Cliente); ?> </span>ha sido <span style="font-weight: bold">EXITOSO</span>, la solicitud de emisión ha sido enviada.</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magnussucre\resources\views\emails\paymentAceptedUser.blade.php ENDPATH**/ ?>