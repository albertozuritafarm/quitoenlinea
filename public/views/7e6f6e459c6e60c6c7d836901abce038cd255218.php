<script src="<?php echo e(assets('js/sales/products.js')); ?>"></script>
...
<div class="container-fluid" style="font-size:14px !important;padding-bottom: 15px;">
    ...
    <div class="col-md-8 col-md-offset-2 border">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-2 wizard_medio"><div id="secondStepWizard" class="wizard_inactivo registerForm"><?php echo e(session('saleCreateAsset')); ?></div></div>
        ...
        <div class="col-md-12">
            <form name="salesForm" method="POST" action="/user" id="salesForm">
                ...
                <input type="hidden" name="insurance_branch" id="insurance_branch" value="<?php echo e($insurance_branch); ?>">
...
<?php /**PATH C:\wamp64\www\magnussucre\resources\views\sales\products.blade.php ENDPATH**/ ?>